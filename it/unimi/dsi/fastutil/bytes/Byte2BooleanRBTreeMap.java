...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(){
                final Comparator<? super Byte2BooleanMap.Entry> comparator = (x, y) -> Byte2BooleanRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2BooleanRBTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2BooleanRBTreeMap clone() {
        ...
        try {
            c = (Byte2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public boolean put(byte k, boolean v) {
            ...
            boolean oldValue = Byte2BooleanRBTreeMap.this.put(k, v);
        ...
        public boolean remove(byte k) {
            ...
            boolean oldValue = Byte2BooleanRBTreeMap.this.remove(k);
        ...
        public Byte2BooleanSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2BooleanRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2BooleanRBTreeMap.this.locateKey(k);
                if (submap.Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
