...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2CharOpenHashMap clone() {
        ...
        try {
            c = (Float2CharOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n]);
            }
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(HashCommon.float2int(k)) & Float2CharOpenHashMap.this.mask;
            float curr = key[pos];
            if (Float.floatToIntBits(curr) == 0) {
                return false;
            }
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(k) != Float.floatToIntBits(curr));
            return Float2CharOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || Float2CharOpenHashMap.this.value[pos] != v);
            Float2CharOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2CharMap.Entry> consumer) {
            if (Float2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2CharMap.BasicEntry(Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n], Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n]));
            }
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) == 0) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Float2CharOpenHashMap.this.n;
                return this.last;
            }
            float[] key = Float2CharOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                float curr;
                int last = pos;
                pos = last + 1 & Float2CharOpenHashMap.this.mask;
                do {
                    if (Float.floatToIntBits(curr = key[pos]) == 0) {
                        key[last] = 0.0f;
                        return;
    ...
    Map.Entry<Float, Character> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2CharOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
