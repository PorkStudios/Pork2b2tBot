...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>(){
                final Comparator<? super Object2ShortMap.Entry<K>> comparator = (x, y) -> Object2ShortRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2ShortRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Object2ShortRBTreeMap.this.removeShort(f.key);
                    return true;
                }
                ...
                public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> to) {
                    return Object2ShortRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> to) {
                    return Object2ShortRBTreeMap.this.headMap(to.getKey()).object2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from) {
                    return Object2ShortRBTreeMap.this.tailMap(from.getKey()).object2ShortEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public boolean contains(short k) {
                    return Object2ShortRBTreeMap.this.containsValue(k);
                }
    ...
    public Object2ShortRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2ShortRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(K from, boolean bottom, K to, boolean top) {
            if (!bottom && !top && Object2ShortRBTreeMap.this.compare(from, to) > 0) {
        ...
        final boolean in(K k) {
            return !(!this.bottom && Object2ShortRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Object2ShortRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2ShortRBTreeMap.this.containsKey(k);
        }
        ...
        public short getShort(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2ShortRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public short put(K k, short v) {
            ...
            short oldValue = Object2ShortRBTreeMap.this.put(k, v);
            return Object2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public short removeShort(Object k) {
            ...
            short oldValue = Object2ShortRBTreeMap.this.removeShort(k);
            return Object2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
        }
        ...
        public Object2ShortSortedMap<K> headMap(K to) {
            ...
            return Object2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2ShortSortedMap<K> tailMap(K from) {
            ...
            return Object2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2ShortSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<K> firstEntry() {
            ...
            if (this.bottom) {
                e = Object2ShortRBTreeMap.this.firstEntry;
            } else {
                e = Object2ShortRBTreeMap.this.locateKey(this.from);
                if (Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                    e = e.next();
                }
            }
            if (e == null || !this.top && Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<K> lastEntry() {
            ...
            if (this.top) {
                e = Object2ShortRBTreeMap.this.lastEntry;
            } else {
                e = Object2ShortRBTreeMap.this.locateKey(this.to);
                if (Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Object2ShortRBTreeMap<K>
        ...
        extends Object2ShortRBTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2ShortRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2ShortRBTreeMap.this.locateKey(k);
                if (submap.Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(K k) {
            this.next = Object2ShortRBTreeMap.this.locateKey(k);
            if (this.next != null) {
                if (Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
