...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>(){
                final Comparator<? super Char2FloatMap.Entry> comparator = (x, y) -> Char2FloatRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2FloatRBTreeMap clone() {
        ...
        try {
            c = (Char2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public float get(char k) {
            Entry e;
            char kk = k;
            return this.in(kk) && (e = Char2FloatRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Char2FloatSortedMap headMap(char to) {
            ...
            return Char2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Char2FloatSortedMap tailMap(char from) {
            ...
            return Char2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Char2FloatSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Char2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Char2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2FloatRBTreeMap.this.locateKey(k);
                if (submap.Char2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
