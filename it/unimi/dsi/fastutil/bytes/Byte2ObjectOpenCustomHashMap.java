...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2ObjectOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2ObjectOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Byte2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Byte2ObjectOpenCustomHashMap<V>
    ...
    implements Byte2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ObjectOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                ...
                return false;
            } while (!Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, curr));
            return Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ObjectOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) || !Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v));
            Byte2ObjectOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
            if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectOpenCustomHashMap.this.key[Byte2ObjectOpenCustomHashMap.this.n], Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n]));
            }
            int pos = Byte2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ObjectOpenCustomHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectOpenCustomHashMap.this.key[pos], Byte2ObjectOpenCustomHashMap.this.value[pos]));
            }
        }
    ...
    implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
        private final Byte2ObjectOpenCustomHashMap<V> entry;
        ...
        @Override
        public Byte2ObjectOpenCustomHashMap<V> next() {
    ...
    extends Byte2ObjectOpenCustomHashMap<V>
    implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
        private Byte2ObjectOpenCustomHashMap<V> entry;
