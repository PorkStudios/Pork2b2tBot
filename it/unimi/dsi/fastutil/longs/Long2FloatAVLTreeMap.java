...
Cloneable {
    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                final Comparator<? super Long2FloatMap.Entry> comparator = (x, y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
    ...
    public Long2FloatAVLTreeMap clone() {
        ...
        try {
            c = (Long2FloatAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public float get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2FloatAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
