...
public final class Reference2ReferenceSortedMaps {
    ...
    Serializable {
        ...
        public Reference2ReferenceSortedMap<K, V> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Reference2ReferenceSortedMap<K, V> headMap(K to) {
            return new UnmodifiableSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Reference2ReferenceSortedMap<K, V> tailMap(K from) {
            return new UnmodifiableSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Reference2ReferenceSortedMap<K, V> subMap(K from, K to) {
            return new SynchronizedSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Reference2ReferenceSortedMap<K, V> headMap(K to) {
            return new SynchronizedSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Reference2ReferenceSortedMap<K, V> tailMap(K from) {
            return new SynchronizedSortedMap<K, V>((Reference2ReferenceSortedMap<K, V>)this.sortedMap.tailMap((Object)from), this.sync);
        }
