...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2ReferenceAVLTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2ReferenceAVLTreeMap<V> clone() {
        ...
        try {
            c = (Long2ReferenceAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V remove(long k) {
            ...
            Object oldValue = Long2ReferenceAVLTreeMap.this.remove(k);
        ...
        public Long2ReferenceSortedMap<V> subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Long2ReferenceAVLTreeMap<V>
        ...
        extends Long2ReferenceAVLTreeMap<V> {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2ReferenceAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2ReferenceAVLTreeMap.this.locateKey(k);
                if (submap.Long2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
