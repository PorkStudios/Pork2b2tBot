...
Hash {
            ...
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Reference2CharLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Reference2CharLinkedOpenHashMap.this.value[Reference2CharLinkedOpenHashMap.this.n]);
                    }
                    int pos = Reference2CharLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Reference2CharLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Reference2CharLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2CharLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2CharLinkedOpenHashMap<K>
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2CharLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2CharSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(System.identityHashCode(k)) & Reference2CharLinkedOpenHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (k != curr);
            return Reference2CharLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || Reference2CharLinkedOpenHashMap.this.value[pos] != v);
            Reference2CharLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            if (Reference2CharLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.n], Reference2CharLinkedOpenHashMap.this.value[Reference2CharLinkedOpenHashMap.this.n]));
            }
            int pos = Reference2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharLinkedOpenHashMap.this.key[pos], Reference2CharLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            ...
            if (Reference2CharLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.n];
                entry.value = Reference2CharLinkedOpenHashMap.this.value[Reference2CharLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Reference2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Reference2CharLinkedOpenHashMap.this.key[pos];
                entry.value = Reference2CharLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Reference2CharMap.Entry<K>> {
        final Reference2CharLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Reference2CharLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Reference2CharLinkedOpenHashMap<K> previous() {
    ...
    extends Reference2CharLinkedOpenHashMap<K>
    implements ObjectListIterator<Reference2CharMap.Entry<K>> {
        private Reference2CharLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2CharLinkedOpenHashMap.this.mask;
            while (Reference2CharLinkedOpenHashMap.this.key[pos] != null) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Reference2CharLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Reference2CharLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Reference2CharLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Reference2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
