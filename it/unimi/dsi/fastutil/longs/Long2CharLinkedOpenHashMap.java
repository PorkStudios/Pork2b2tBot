...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2CharLinkedOpenHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2CharLinkedOpenHashMap clone() {
        ...
        try {
            c = (Long2CharLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Long2CharSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(k) & Long2CharLinkedOpenHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (k != curr);
            return Long2CharLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Long2CharLinkedOpenHashMap.this.value[pos] != v);
            Long2CharLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2CharMap.Entry> consumer) {
            if (Long2CharLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2CharMap.BasicEntry(Long2CharLinkedOpenHashMap.this.key[Long2CharLinkedOpenHashMap.this.n], Long2CharLinkedOpenHashMap.this.value[Long2CharLinkedOpenHashMap.this.n]));
            }
            int pos = Long2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2CharLinkedOpenHashMap.this.key[pos] == 0L) continue;
                consumer.accept(new AbstractLong2CharMap.BasicEntry(Long2CharLinkedOpenHashMap.this.key[pos], Long2CharLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Long2CharMap.Entry> consumer) {
            ...
            if (Long2CharLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Long2CharLinkedOpenHashMap.this.key[Long2CharLinkedOpenHashMap.this.n];
                entry.value = Long2CharLinkedOpenHashMap.this.value[Long2CharLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Long2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2CharLinkedOpenHashMap.this.key[pos] == 0L) continue;
                entry.key = Long2CharLinkedOpenHashMap.this.key[pos];
                entry.value = Long2CharLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(long from) {
            ...
            int pos = (int)HashCommon.mix(from) & Long2CharLinkedOpenHashMap.this.mask;
            while (Long2CharLinkedOpenHashMap.this.key[pos] != 0L) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Long2CharLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Long2CharLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Long2CharLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Long2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Long2CharLinkedOpenHashMap.this.n) {
                ...
                do {
                    long curr;
                    int last = pos;
                    pos = last + 1 & Long2CharLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0L) {
                            key[last] = 0L;
                            return;
    ...
    Map.Entry<Long, Character> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2CharLinkedOpenHashMap.this.key[this.index] == (Long)e.getKey() && Long2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
