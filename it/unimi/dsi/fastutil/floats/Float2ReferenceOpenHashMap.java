...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ReferenceOpenHashMap<V> clone() {
        Float2ReferenceOpenHashMap c;
        try {
            c = (Float2ReferenceOpenHashMap)Object.super.clone();
        }
    ...
    extends Float2ReferenceOpenHashMap<V>
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2ReferenceOpenHashMap.this.key[Float2ReferenceOpenHashMap.this.n]);
            }
            int pos = Float2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ReferenceOpenHashMap.this.mask;
            float curr = key[pos];
            if (Float.floatToIntBits(curr) == 0) {
                return false;
            }
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(k) != Float.floatToIntBits(curr));
            return Float2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || Float2ReferenceOpenHashMap.this.value[pos] != v);
            Float2ReferenceOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceOpenHashMap.this.key[Float2ReferenceOpenHashMap.this.n], Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n]));
            }
            int pos = Float2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[pos]) == 0) continue;
    ...
    implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
        private final Float2ReferenceOpenHashMap<V> entry;
        ...
        @Override
        public Float2ReferenceOpenHashMap<V> next() {
    ...
    extends Float2ReferenceOpenHashMap<V>
    implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
        private Float2ReferenceOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Float2ReferenceOpenHashMap.this.n;
                return this.last;
            }
            float[] key = Float2ReferenceOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                float curr;
                int last = pos;
                pos = last + 1 & Float2ReferenceOpenHashMap.this.mask;
                do {
                    if (Float.floatToIntBits(curr = key[pos]) == 0) {
                        key[last] = 0.0f;
                    ...
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                    pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
                } while (true);
                if (pos < last) {
    ...
    Map.Entry<Float, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Float2ReferenceOpenHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
        }
