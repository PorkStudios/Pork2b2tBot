...
Cloneable {
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(){
                final Comparator<? super Int2IntMap.Entry> comparator = (x, y) -> Int2IntAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
    ...
    public Int2IntAVLTreeMap clone() {
        Int2IntAVLTreeMap c;
        try {
            c = (Int2IntAVLTreeMap)Object.super.clone();
        }
