...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2ObjectOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2ObjectOpenHashMap<V> clone() {
        Char2ObjectOpenHashMap c;
        try {
            c = (Char2ObjectOpenHashMap)Object.super.clone();
        }
    ...
    extends Char2ObjectOpenHashMap<V>
    ...
    implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2ObjectOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Objects.equals(Char2ObjectOpenHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || !Objects.equals(Char2ObjectOpenHashMap.this.value[pos], v));
            Char2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ObjectMap.BasicEntry(Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n], Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n]));
            }
            int pos = Char2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    implements ObjectIterator<Char2ObjectMap.Entry<V>> {
        private final Char2ObjectOpenHashMap<V> entry;
        ...
        @Override
        public Char2ObjectOpenHashMap<V> next() {
    ...
    extends Char2ObjectOpenHashMap<V>
    implements ObjectIterator<Char2ObjectMap.Entry<V>> {
        private Char2ObjectOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Char2ObjectOpenHashMap.this.n;
                return this.last;
            }
            char[] key = Char2ObjectOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                char curr;
                int last = pos;
                pos = last + 1 & Char2ObjectOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == '\u0000') {
                        key[last] = '\u0000';
    ...
    Map.Entry<Character, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Char2ObjectOpenHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ObjectOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Objects.equals(Char2ObjectOpenHashMap.this.value[this.index], e.getValue());
        }
