...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2ByteOpenHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2ByteOpenHashMap clone() {
        ...
        try {
            c = (Long2ByteOpenHashMap)Object.super.clone();
        }
    ...
    implements Long2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(k) & Long2ByteOpenHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (k != curr);
            return Long2ByteOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Long2ByteOpenHashMap.this.value[pos] != v);
            Long2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
            if (Long2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2ByteMap.BasicEntry(Long2ByteOpenHashMap.this.key[Long2ByteOpenHashMap.this.n], Long2ByteOpenHashMap.this.value[Long2ByteOpenHashMap.this.n]));
            }
            int pos = Long2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ByteOpenHashMap.this.key[pos] == 0L) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Long2ByteOpenHashMap.this.n;
                return this.last;
            }
            long[] key = Long2ByteOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                long curr;
                int last = pos;
                pos = last + 1 & Long2ByteOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0L) {
                        key[last] = 0L;
                        return;
                    ...
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                    pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
                } while (true);
                if (pos < last) {
