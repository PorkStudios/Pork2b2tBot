...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            c = (Double2ReferenceOpenHashMap)Object.super.clone();
        }
    ...
    extends Double2ReferenceOpenHashMap<V>
    ...
    implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ReferenceOpenHashMap.this.mask;
            double curr = key[pos];
            if (Double.doubleToLongBits(curr) == 0L) {
                return false;
            }
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(k) != Double.doubleToLongBits(curr));
            return Double2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
            if (Double2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceOpenHashMap.this.key[Double2ReferenceOpenHashMap.this.n], Double2ReferenceOpenHashMap.this.value[Double2ReferenceOpenHashMap.this.n]));
            }
            int pos = Double2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
        private final Double2ReferenceOpenHashMap<V> entry;
        ...
        @Override
        public Double2ReferenceOpenHashMap<V> next() {
    ...
    extends Double2ReferenceOpenHashMap<V>
    implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
        private Double2ReferenceOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ReferenceOpenHashMap.this.mask;
                while (Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p])) {
                    p = p + 1 & Double2ReferenceOpenHashMap.this.mask;
                }
                return p;
