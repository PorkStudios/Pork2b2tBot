...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ReferenceLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Float2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Float2ReferenceLinkedOpenHashMap<V>
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.n]);
            }
            int pos = Float2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            if (Float2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.n], Float2ReferenceLinkedOpenHashMap.this.value[Float2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Float2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceLinkedOpenHashMap.this.key[pos], Float2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Float2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Float2ReferenceLinkedOpenHashMap.this.value[Float2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Float2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        final Float2ReferenceLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Float2ReferenceLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Float2ReferenceLinkedOpenHashMap<V> previous() {
    ...
    extends Float2ReferenceLinkedOpenHashMap<V>
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        private Float2ReferenceLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
