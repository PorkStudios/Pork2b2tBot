...
Hash {
            ...
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Char2ByteLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2ByteLinkedOpenHashMap.this.value[Char2ByteLinkedOpenHashMap.this.n]);
                    }
                    int pos = Char2ByteLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2ByteLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                        consumer.accept(Char2ByteLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Char2ByteLinkedOpenHashMap clone() {
        ...
        try {
            c = (Char2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Char2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.n]);
            }
            int pos = Char2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = Char2ByteLinkedOpenHashMap.this.key[pos];
                if (k == '\u0000') continue;
                consumer.accept(k);
            }
        }
    ...
    implements Char2ByteSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            if (Char2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.n], Char2ByteLinkedOpenHashMap.this.value[Char2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Char2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ByteLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteLinkedOpenHashMap.this.key[pos], Char2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            ...
            if (Char2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.n];
                entry.value = Char2ByteLinkedOpenHashMap.this.value[Char2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ByteLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Char2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
