...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(){
                final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = (x, y) -> Char2ReferenceRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2ReferenceRBTreeMap<V> clone() {
        ...
        try {
            c = (Char2ReferenceRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        extends Char2ReferenceRBTreeMap<V>
