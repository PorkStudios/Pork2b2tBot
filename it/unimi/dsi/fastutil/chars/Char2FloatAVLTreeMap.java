...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
                    return e.equals(f);
                }
    ...
    public Char2FloatAVLTreeMap clone() {
        ...
        try {
            c = (Char2FloatAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public float put(char k, float v) {
            ...
            float oldValue = Char2FloatAVLTreeMap.this.put(k, v);
        ...
        public float remove(char k) {
            ...
            float oldValue = Char2FloatAVLTreeMap.this.remove(k);
        ...
        public Char2FloatSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2FloatAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2FloatAVLTreeMap.this.locateKey(k);
                if (submap.Char2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            this.next = Char2FloatAVLTreeMap.this.locateKey(k);
            if (this.next != null) {
