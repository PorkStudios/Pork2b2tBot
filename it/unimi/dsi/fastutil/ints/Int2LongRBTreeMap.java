...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2LongRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2LongRBTreeMap clone() {
        Int2LongRBTreeMap c;
        try {
            c = (Int2LongRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public long put(int k, long v) {
            ...
            long oldValue = Int2LongRBTreeMap.this.put(k, v);
        ...
        public long remove(int k) {
            ...
            long oldValue = Int2LongRBTreeMap.this.remove(k);
        ...
        public Int2LongSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2LongRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2LongRBTreeMap.this.locateKey(k);
                if (submap.Int2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
