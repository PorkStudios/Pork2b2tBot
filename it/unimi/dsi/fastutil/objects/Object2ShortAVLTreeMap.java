...
Cloneable {
    ...
    public Object2ShortAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2ShortAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ShortSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2ShortAVLTreeMap<K>
