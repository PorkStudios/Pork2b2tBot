...
Cloneable {
    ...
    public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>(){
                final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = (x, y) -> Byte2ObjectAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
    ...
    public Byte2ObjectAVLTreeMap<V> clone() {
        ...
        try {
            c = (Byte2ObjectAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(byte k) {
            Entry e;
            byte kk = k;
            return (V)(this.in(kk) && (e = Byte2ObjectAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(byte k, V v) {
            ...
            V oldValue = Byte2ObjectAVLTreeMap.this.put(k, v);
            return (V)(Byte2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(byte k) {
            ...
            return (V)(Byte2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        extends Byte2ObjectAVLTreeMap<V>
