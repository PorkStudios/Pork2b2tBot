...
Externalizable {
    ...
    implements TCharCollection {
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Character) {
                    ...
                    if (TObjectCharCustomHashMap.this.containsValue(ele)) continue;
                    return false;
                }
                return false;
            }
        ...
        public boolean containsAll(TCharCollection collection) {
            ...
            while (iter.hasNext()) {
                if (TObjectCharCustomHashMap.this.containsValue(iter.next())) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean containsAll(char[] array) {
            for (char element : array) {
                if (TObjectCharCustomHashMap.this.containsValue(element)) continue;
                return false;
            }
            return true;
        }
    ...
    extends TObjectCharCustomHashMap<K> {
        protected KeyView() {
        }
