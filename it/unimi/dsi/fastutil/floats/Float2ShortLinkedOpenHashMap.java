...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ShortLinkedOpenHashMap clone() {
        ...
        try {
            c = (Float2ShortLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ShortLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.n]);
            }
            int pos = Float2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ShortSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Float2ShortMap.Entry> consumer) {
            if (Float2ShortLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.n], Float2ShortLinkedOpenHashMap.this.value[Float2ShortLinkedOpenHashMap.this.n]));
            }
            int pos = Float2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortLinkedOpenHashMap.this.key[pos], Float2ShortLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2ShortMap.Entry> consumer) {
            ...
            if (Float2ShortLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.n];
                entry.value = Float2ShortLinkedOpenHashMap.this.value[Float2ShortLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2ShortLinkedOpenHashMap.this.key[pos];
                entry.value = Float2ShortLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2ShortLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2ShortLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2ShortLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
