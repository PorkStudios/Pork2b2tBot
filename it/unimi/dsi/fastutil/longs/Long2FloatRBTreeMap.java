...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2FloatRBTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2FloatRBTreeMap clone() {
        ...
        try {
            c = (Long2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Long2FloatSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2FloatRBTreeMap.this.locateKey(k);
                if (submap.Long2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
