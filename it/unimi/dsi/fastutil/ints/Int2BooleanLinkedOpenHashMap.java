...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2BooleanLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2BooleanLinkedOpenHashMap clone() {
        ...
        try {
            c = (Int2BooleanLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Int2BooleanSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            if (Int2BooleanLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanLinkedOpenHashMap.this.key[Int2BooleanLinkedOpenHashMap.this.n], Int2BooleanLinkedOpenHashMap.this.value[Int2BooleanLinkedOpenHashMap.this.n]));
            }
            int pos = Int2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanLinkedOpenHashMap.this.key[pos], Int2BooleanLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            ...
            if (Int2BooleanLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Int2BooleanLinkedOpenHashMap.this.key[Int2BooleanLinkedOpenHashMap.this.n];
                entry.value = Int2BooleanLinkedOpenHashMap.this.value[Int2BooleanLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2BooleanLinkedOpenHashMap.this.key[pos];
                entry.value = Int2BooleanLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Int2BooleanLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Int2BooleanLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Int2BooleanLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Int2BooleanLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
