...
Hash {
    ...
    public LongLinkedOpenHashSet clone() {
        ...
        try {
            c = (LongLinkedOpenHashSet)Object.super.clone();
        }
    ...
    implements LongListIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = LongLinkedOpenHashSet.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (LongLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = LongLinkedOpenHashSet.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (LongLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
