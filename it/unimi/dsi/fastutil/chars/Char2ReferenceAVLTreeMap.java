...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Char2ReferenceAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
                    return e.equals(f);
                }
    ...
    public Char2ReferenceAVLTreeMap<V> clone() {
        Char2ReferenceAVLTreeMap c;
        try {
            c = (Char2ReferenceAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V remove(char k) {
            ...
            Object oldValue = Char2ReferenceAVLTreeMap.this.remove(k);
        ...
        public Char2ReferenceSortedMap<V> subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Char2ReferenceAVLTreeMap<V>
        ...
        extends Char2ReferenceAVLTreeMap<V> {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ReferenceAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ReferenceAVLTreeMap.this.locateKey(k);
                if (submap.Char2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
