...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(){
                final Comparator<? super Double2ShortMap.Entry> comparator = (x, y) -> Double2ShortRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2ShortRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2ShortRBTreeMap clone() {
        ...
        try {
            c = (Double2ShortRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public short get(double k) {
            Entry e;
            double kk = k;
            return this.in(kk) && (e = Double2ShortRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Double2ShortSortedMap headMap(double to) {
            ...
            return Double2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Double2ShortSortedMap tailMap(double from) {
            ...
            return Double2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Double2ShortSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Double2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Double2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2ShortRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2ShortRBTreeMap.this.locateKey(k);
                if (submap.Double2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
