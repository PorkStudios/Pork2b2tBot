...
lbl159: // 1 sources:
    ...
    public Object clone() {
        DoubleRBTreeSet c;
        try {
            c = (DoubleRBTreeSet)Object.super.clone();
        }
    ...
    DoubleSortedSet {
        ...
        public DoubleSortedSet headSet(double to) {
            ...
            return DoubleRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(this.from, this.bottom, to, false) : this;
        }
        ...
        public DoubleSortedSet tailSet(double from) {
            ...
            return DoubleRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(from, false, this.to, this.top) : this;
        }
        ...
        public DoubleSortedSet subSet(double from, double to) {
            ...
            if (!this.top) {
                double d = to = DoubleRBTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = DoubleRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && DoubleRBTreeSet.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && DoubleRBTreeSet.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends SetIterator {
            ...
            SubsetIterator(double k) {
                ...
                if (!subset.bottom && subset.DoubleRBTreeSet.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!subset.top) {
                    this.prev = subset.lastEntry();
                    if (subset.DoubleRBTreeSet.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = subset.DoubleRBTreeSet.this.locateKey(k);
                if (subset.DoubleRBTreeSet.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
