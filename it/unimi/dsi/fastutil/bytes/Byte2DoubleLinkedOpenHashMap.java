...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2DoubleLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2DoubleLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Byte2DoubleSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            if (Byte2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleLinkedOpenHashMap.this.key[Byte2DoubleLinkedOpenHashMap.this.n], Byte2DoubleLinkedOpenHashMap.this.value[Byte2DoubleLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleLinkedOpenHashMap.this.key[pos], Byte2DoubleLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            ...
            if (Byte2DoubleLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2DoubleLinkedOpenHashMap.this.key[Byte2DoubleLinkedOpenHashMap.this.n];
                entry.value = Byte2DoubleLinkedOpenHashMap.this.value[Byte2DoubleLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2DoubleLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2DoubleLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2DoubleLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2DoubleLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
