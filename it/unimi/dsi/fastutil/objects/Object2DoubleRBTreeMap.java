...
lbl161: // 1 sources:
    ...
    public Object2DoubleRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2DoubleRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2DoubleSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2DoubleRBTreeMap<K>
