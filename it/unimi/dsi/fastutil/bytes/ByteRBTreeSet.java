...
lbl159: // 1 sources:
    ...
    public Object clone() {
        ByteRBTreeSet c;
        try {
            c = (ByteRBTreeSet)Object.super.clone();
        }
    ...
    ByteSortedSet {
        ...
        final boolean in(byte k) {
            return !(!this.bottom && ByteRBTreeSet.this.compare(k, this.from) < 0 || !this.top && ByteRBTreeSet.this.compare(k, this.to) >= 0);
        }

        @Override
        public boolean contains(byte k) {
            return this.in(k) && ByteRBTreeSet.this.contains(k);
        }
        ...
        public ByteSortedSet headSet(byte to) {
            ...
            return ByteRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(this.from, this.bottom, to, false) : this;
        }
        ...
        public ByteSortedSet subSet(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = ByteRBTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = ByteRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && ByteRBTreeSet.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = ByteRBTreeSet.this.locateKey(this.to);
                if (ByteRBTreeSet.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && ByteRBTreeSet.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends SetIterator {
            ...
            SubsetIterator(byte k) {
                ...
                if (!subset.bottom && subset.ByteRBTreeSet.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!subset.top) {
                    this.prev = subset.lastEntry();
                    if (subset.ByteRBTreeSet.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = subset.ByteRBTreeSet.this.locateKey(k);
                if (subset.ByteRBTreeSet.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
