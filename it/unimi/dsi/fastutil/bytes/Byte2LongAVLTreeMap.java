...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2LongAVLTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2LongAVLTreeMap clone() {
        ...
        try {
            c = (Byte2LongAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Byte2LongSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2LongAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2LongAVLTreeMap.this.locateKey(k);
                if (submap.Byte2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
