...
Hash {
            ...
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Short2ObjectLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n]);
                    }
                    int pos = Short2ObjectLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Short2ObjectLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Short2ObjectLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Short2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Short2ObjectLinkedOpenHashMap<V>
    ...
    extends AbstractShortSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Short2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.n]);
            }
            int pos = Short2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = Short2ObjectLinkedOpenHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Short2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            Object v = e.getValue();
            if (k == 0) {
                return Short2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n], v);
            }
            ...
            if (k == curr) {
                return Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[pos], v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            Object v = e.getValue();
            if (k == 0) {
                if (Short2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n], v)) {
            ...
            if (curr == k) {
                if (Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[pos], v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || !Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[pos], v));
            Short2ObjectLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
            if (Short2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2ObjectMap.BasicEntry(Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.n], Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Short2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractShort2ObjectMap.BasicEntry(Short2ObjectLinkedOpenHashMap.this.key[pos], Short2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
            ...
            if (Short2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.n];
                entry.value = Short2ObjectLinkedOpenHashMap.this.value[Short2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Short2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Short2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Short2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Short2ObjectMap.Entry<V>> {
        final Short2ObjectLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Short2ObjectLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Short2ObjectLinkedOpenHashMap<V> previous() {
    ...
    extends Short2ObjectLinkedOpenHashMap<V>
    implements ObjectListIterator<Short2ObjectMap.Entry<V>> {
        private Short2ObjectLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Short2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Short2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Short2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Short, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2ObjectLinkedOpenHashMap.this.key[this.index] == (Short)e.getKey() && Objects.equals(Short2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue());
        }
