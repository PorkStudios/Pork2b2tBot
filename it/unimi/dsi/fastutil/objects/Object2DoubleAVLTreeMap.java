...
Cloneable {
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>(){
                final Comparator<? super Object2DoubleMap.Entry<K>> comparator = (x, y) -> Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2DoubleAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
                    return Object2DoubleAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
                    return Object2DoubleAVLTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
                    return Object2DoubleAVLTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2DoubleAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2DoubleAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2DoubleAVLTreeMap.this.containsKey(k);
        }
        ...
        public double getDouble(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2DoubleAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Object2DoubleSortedMap<K> headMap(K to) {
            ...
            return Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2DoubleSortedMap<K> tailMap(K from) {
            ...
            return Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2DoubleSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<K> firstEntry() {
            ...
            if (e == null || !this.top && Object2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<K> lastEntry() {
            ...
            if (e == null || !this.bottom && Object2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Object2DoubleAVLTreeMap<K>
        ...
        extends Object2DoubleAVLTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2DoubleAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2DoubleAVLTreeMap.this.locateKey(k);
                if (submap.Object2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
