...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2DoubleLinkedOpenHashMap.this.key[pos] == null) continue;
    ...
    public Object2DoubleLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Object2DoubleLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2DoubleLinkedOpenHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2DoubleLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2DoubleSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            if (Object2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.n], Object2DoubleLinkedOpenHashMap.this.value[Object2DoubleLinkedOpenHashMap.this.n]));
            }
            int pos = Object2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2DoubleLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleLinkedOpenHashMap.this.key[pos], Object2DoubleLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            ...
            if (Object2DoubleLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.n];
                entry.value = Object2DoubleLinkedOpenHashMap.this.value[Object2DoubleLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2DoubleLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Object2DoubleLinkedOpenHashMap.this.key[pos];
                entry.value = Object2DoubleLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        final Object2DoubleLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Object2DoubleLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2DoubleLinkedOpenHashMap<K> previous() {
    ...
    extends Object2DoubleLinkedOpenHashMap<K>
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        private Object2DoubleLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2DoubleLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2DoubleLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
