...
Cloneable {
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(){
                final Comparator<? super Long2CharMap.Entry> comparator = (x, y) -> Long2CharAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2CharAVLTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2CharAVLTreeMap clone() {
        ...
        try {
            c = (Long2CharAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public char get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2CharAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Long2CharSortedMap headMap(long to) {
            ...
            return Long2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Long2CharSortedMap tailMap(long from) {
            ...
            return Long2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Long2CharSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Long2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Long2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2CharAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2CharAVLTreeMap.this.locateKey(k);
                if (submap.Long2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractLong2CharSortedMap.KeySet {
            private KeySet() {
            }
