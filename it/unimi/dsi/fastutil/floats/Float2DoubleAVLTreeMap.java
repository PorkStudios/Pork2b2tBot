...
Cloneable {
    ...
    public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(){
                final Comparator<? super Float2DoubleMap.Entry> comparator = (x, y) -> Float2DoubleAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
    ...
    public Float2DoubleAVLTreeMap clone() {
        ...
        try {
            c = (Float2DoubleAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public double get(float k) {
            Entry e;
            float kk = k;
            return this.in(kk) && (e = Float2DoubleAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Float2DoubleSortedMap headMap(float to) {
            ...
            return Float2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Float2DoubleSortedMap tailMap(float from) {
            ...
            return Float2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Float2DoubleSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Float2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Float2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2DoubleAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2DoubleAVLTreeMap.this.locateKey(k);
                if (submap.Float2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
