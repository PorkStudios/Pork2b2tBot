...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2IntLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2IntLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2IntLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Byte2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2IntLinkedOpenHashMap.this.key[Byte2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Byte2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = Byte2IntLinkedOpenHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Byte2IntSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Byte2IntLinkedOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2IntLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Byte2IntLinkedOpenHashMap.this.value[pos] != v);
            Byte2IntLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntLinkedOpenHashMap.this.key[Byte2IntLinkedOpenHashMap.this.n], Byte2IntLinkedOpenHashMap.this.value[Byte2IntLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2IntLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntLinkedOpenHashMap.this.key[pos], Byte2IntLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2IntLinkedOpenHashMap.this.key[Byte2IntLinkedOpenHashMap.this.n];
                entry.value = Byte2IntLinkedOpenHashMap.this.value[Byte2IntLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2IntLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2IntLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2IntLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2IntLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2IntLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2IntLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
