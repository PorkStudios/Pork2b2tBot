...
lbl160: // 1 sources:
    ...
    public Char2CharRBTreeMap clone() {
        ...
        try {
            c = (Char2CharRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Char2CharSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2CharRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2CharRBTreeMap.this.locateKey(k);
                if (submap.Char2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
