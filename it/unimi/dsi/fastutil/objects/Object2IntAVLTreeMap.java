...
Cloneable {
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(){
                final Comparator<? super Object2IntMap.Entry<K>> comparator = (x, y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2IntAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> from, Object2IntMap.Entry<K> to) {
                    return Object2IntAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> to) {
                    return Object2IntAVLTreeMap.this.headMap(to.getKey()).object2IntEntrySet();
                }
    ...
    public Object2IntAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2IntAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2IntAVLTreeMap.this.containsKey(k);
        }
        ...
        public int getInt(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2IntAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Object2IntSortedMap<K> headMap(K to) {
            ...
            return Object2IntAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2IntSortedMap<K> tailMap(K from) {
            ...
            return Object2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2IntSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2IntAVLTreeMap<K>
        ...
        extends Object2IntAVLTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2IntAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2IntAVLTreeMap.this.locateKey(k);
                if (submap.Object2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
