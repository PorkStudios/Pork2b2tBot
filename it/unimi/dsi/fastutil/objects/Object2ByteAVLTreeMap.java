...
Cloneable {
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(){
                final Comparator<? super Object2ByteMap.Entry<K>> comparator = (x, y) -> Object2ByteAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
    ...
    public Object2ByteAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2ByteAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ByteSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2ByteAVLTreeMap<K>
