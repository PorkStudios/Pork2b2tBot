...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2ShortAVLTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2ShortAVLTreeMap clone() {
        ...
        try {
            c = (Short2ShortAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Short2ShortSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2ShortAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2ShortAVLTreeMap.this.locateKey(k);
                if (submap.Short2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
