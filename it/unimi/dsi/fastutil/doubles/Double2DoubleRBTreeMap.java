...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>(){
                final Comparator<? super Double2DoubleMap.Entry> comparator = (x, y) -> Double2DoubleRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2DoubleRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2DoubleRBTreeMap clone() {
        ...
        try {
            c = (Double2DoubleRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public double get(double k) {
            Entry e;
            double kk = k;
            return this.in(kk) && (e = Double2DoubleRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Double2DoubleSortedMap headMap(double to) {
            ...
            return Double2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Double2DoubleSortedMap tailMap(double from) {
            ...
            return Double2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Double2DoubleSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Double2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Double2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2DoubleRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2DoubleRBTreeMap.this.locateKey(k);
                if (submap.Double2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
