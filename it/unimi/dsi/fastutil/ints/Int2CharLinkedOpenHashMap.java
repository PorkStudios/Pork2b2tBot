...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2CharLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2CharLinkedOpenHashMap clone() {
        ...
        try {
            c = (Int2CharLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Int2CharSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2CharLinkedOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Int2CharLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2CharLinkedOpenHashMap.this.value[pos] != v);
            Int2CharLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2CharMap.BasicEntry(Int2CharLinkedOpenHashMap.this.key[Int2CharLinkedOpenHashMap.this.n], Int2CharLinkedOpenHashMap.this.value[Int2CharLinkedOpenHashMap.this.n]));
            }
            int pos = Int2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2CharMap.BasicEntry(Int2CharLinkedOpenHashMap.this.key[pos], Int2CharLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2CharMap.Entry> consumer) {
            ...
            if (Int2CharLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Int2CharLinkedOpenHashMap.this.key[Int2CharLinkedOpenHashMap.this.n];
                entry.value = Int2CharLinkedOpenHashMap.this.value[Int2CharLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2CharLinkedOpenHashMap.this.key[pos];
                entry.value = Int2CharLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(int from) {
            ...
            if (Int2CharLinkedOpenHashMap.this.key[Int2CharLinkedOpenHashMap.this.last] == from) {
                this.prev = Int2CharLinkedOpenHashMap.this.last;
                this.index = Int2CharLinkedOpenHashMap.this.size;
                return;
            }
            int pos = HashCommon.mix(from) & Int2CharLinkedOpenHashMap.this.mask;
            while (Int2CharLinkedOpenHashMap.this.key[pos] != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Int2CharLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Int2CharLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Int2CharLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Int2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Int2CharLinkedOpenHashMap.this.n) {
                ...
                do {
                    int curr;
                    int last = pos;
                    pos = last + 1 & Int2CharLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0) {
                            key[last] = 0;
                            return;
    ...
    Map.Entry<Integer, Character> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2CharLinkedOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Int2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
