...
Cloneable {
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(){
                final Comparator<? super Object2BooleanMap.Entry<K>> comparator = (x, y) -> Object2BooleanAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2BooleanAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
    ...
    public Object2BooleanAVLTreeMap<K> clone() {
        Object2BooleanAVLTreeMap c;
        try {
            c = (Object2BooleanAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2BooleanSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2BooleanAVLTreeMap<K>
        ...
        extends Object2BooleanAVLTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2BooleanAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2BooleanAVLTreeMap.this.locateKey(k);
                if (submap.Object2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
