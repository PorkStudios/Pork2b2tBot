...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>(){
                ...
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
                    return Object2ObjectAVLTreeMap.this.headMap((Object)to.getKey()).object2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
                    return Object2ObjectAVLTreeMap.this.tailMap((Object)from.getKey()).object2ObjectEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2ObjectAVLTreeMap<K, V> clone() {
        ...
        try {
            c = (Object2ObjectAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2ObjectAVLTreeMap<K, V>
