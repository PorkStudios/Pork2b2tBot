...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2BooleanOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2BooleanOpenHashMap clone() {
        ...
        try {
            c = (Int2BooleanOpenHashMap)Object.super.clone();
        }
    ...
    implements Int2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2BooleanOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2BooleanOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Int2BooleanOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2BooleanOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2BooleanOpenHashMap.this.value[pos] != v);
            Int2BooleanOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n], Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n]));
            }
            int pos = Int2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanOpenHashMap.this.key[pos], Int2BooleanOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            ...
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n];
                entry.value = Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2BooleanOpenHashMap.this.key[pos];
                entry.value = Int2BooleanOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Int2BooleanOpenHashMap.this.n;
                return this.last;
            }
            int[] key = Int2BooleanOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                int curr;
                int last = pos;
                pos = last + 1 & Int2BooleanOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
                        return;
    ...
    Map.Entry<Integer, Boolean> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2BooleanOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Int2BooleanOpenHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
