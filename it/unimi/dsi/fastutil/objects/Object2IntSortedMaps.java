...
public final class Object2IntSortedMaps {
    ...
    public static <K> ObjectBidirectionalIterable<Object2IntMap.Entry<K>> fastIterable(Object2IntSortedMap<K> map) {
        ObjectSet entries = map.object2IntEntrySet();
        return entries instanceof Object2IntSortedMap.FastSortedEntrySet ? ((Object2IntSortedMap.FastSortedEntrySet)entries)::fastIterator : entries;
    }
    ...
    Serializable {
        ...
        public Object2IntSortedMap<K> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Object2IntSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Object2IntSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Object2IntSortedMap<K> subMap(K from, K to) {
            return new SynchronizedSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Object2IntSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Object2IntSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap<K>((Object2IntSortedMap<K>)this.sortedMap.tailMap((Object)from), this.sync);
        }
