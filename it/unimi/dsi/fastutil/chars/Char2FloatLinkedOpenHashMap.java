...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Char2FloatLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2FloatLinkedOpenHashMap.this.value[Char2FloatLinkedOpenHashMap.this.n]);
                    }
                    int pos = Char2FloatLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2FloatLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                        consumer.accept(Char2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Char2FloatLinkedOpenHashMap clone() {
        ...
        try {
            c = (Char2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Char2FloatSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2FloatLinkedOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Char2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Char2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Char2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            if (Char2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatLinkedOpenHashMap.this.key[Char2FloatLinkedOpenHashMap.this.n], Char2FloatLinkedOpenHashMap.this.value[Char2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Char2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2FloatLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatLinkedOpenHashMap.this.key[pos], Char2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            ...
            if (Char2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2FloatLinkedOpenHashMap.this.key[Char2FloatLinkedOpenHashMap.this.n];
                entry.value = Char2FloatLinkedOpenHashMap.this.value[Char2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2FloatLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Char2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(char from) {
            ...
            int pos = HashCommon.mix(from) & Char2FloatLinkedOpenHashMap.this.mask;
            while (Char2FloatLinkedOpenHashMap.this.key[pos] != '\u0000') {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Character, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Float.floatToIntBits(Char2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
