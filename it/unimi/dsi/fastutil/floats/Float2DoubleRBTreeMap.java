...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(){
                final Comparator<? super Float2DoubleMap.Entry> comparator = (x, y) -> Float2DoubleRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    return e.equals(f);
                }
    ...
    public Float2DoubleRBTreeMap clone() {
        ...
        try {
            c = (Float2DoubleRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Float2DoubleSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2DoubleRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2DoubleRBTreeMap.this.locateKey(k);
                if (submap.Float2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
