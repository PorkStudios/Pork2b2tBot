...
Cloneable {
    ...
    public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>(){
                final Comparator<? super Float2ByteMap.Entry> comparator = (x, y) -> Float2ByteAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
    ...
    public Float2ByteAVLTreeMap clone() {
        ...
        try {
            c = (Float2ByteAVLTreeMap)Object.super.clone();
        }
