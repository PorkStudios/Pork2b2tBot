...
Cloneable {
    ...
    public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>(){
                final Comparator<? super Char2DoubleMap.Entry> comparator = (x, y) -> Char2DoubleAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2DoubleAVLTreeMap clone() {
        ...
        try {
            c = (Char2DoubleAVLTreeMap)Object.super.clone();
        }
