...
Cloneable {
    ...
    public Object2CharAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2CharAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2CharSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2CharAVLTreeMap<K>
