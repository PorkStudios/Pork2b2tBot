...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2ReferenceLinkedOpenHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2ReferenceLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Long2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Long2ReferenceLinkedOpenHashMap<V>
    ...
    implements Long2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(k) & Long2ReferenceLinkedOpenHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (k != curr);
            return Long2ReferenceLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Long2ReferenceLinkedOpenHashMap.this.value[pos] != v);
            Long2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2ReferenceMap.Entry<V>> consumer) {
            if (Long2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceLinkedOpenHashMap.this.key[Long2ReferenceLinkedOpenHashMap.this.n], Long2ReferenceLinkedOpenHashMap.this.value[Long2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Long2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ReferenceLinkedOpenHashMap.this.key[pos] == 0L) continue;
                consumer.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceLinkedOpenHashMap.this.key[pos], Long2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Long2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Long2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Long2ReferenceLinkedOpenHashMap.this.key[Long2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Long2ReferenceLinkedOpenHashMap.this.value[Long2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Long2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ReferenceLinkedOpenHashMap.this.key[pos] == 0L) continue;
                entry.key = Long2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Long2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
        final Long2ReferenceLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Long2ReferenceLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Long2ReferenceLinkedOpenHashMap<V> previous() {
    ...
    extends Long2ReferenceLinkedOpenHashMap<V>
    implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
        private Long2ReferenceLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(long from) {
            ...
            int pos = (int)HashCommon.mix(from) & Long2ReferenceLinkedOpenHashMap.this.mask;
            while (Long2ReferenceLinkedOpenHashMap.this.key[pos] != 0L) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Long2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Long2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Long2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Long2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Long2ReferenceLinkedOpenHashMap.this.n) {
                ...
                do {
                    long curr;
                    int last = pos;
                    pos = last + 1 & Long2ReferenceLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0L) {
                            key[last] = 0L;
    ...
    Map.Entry<Long, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Long2ReferenceLinkedOpenHashMap.this.value[this.index];
