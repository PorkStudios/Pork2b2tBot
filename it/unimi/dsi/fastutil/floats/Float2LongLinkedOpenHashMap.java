...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2LongLinkedOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2LongLinkedOpenHashMap clone() {
        ...
        try {
            c = (Float2LongLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.n]);
            }
            int pos = Float2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2LongSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
            if (Float2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2LongMap.BasicEntry(Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.n], Float2LongLinkedOpenHashMap.this.value[Float2LongLinkedOpenHashMap.this.n]));
            }
            int pos = Float2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2LongLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2LongMap.BasicEntry(Float2LongLinkedOpenHashMap.this.key[pos], Float2LongLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2LongMap.Entry> consumer) {
            ...
            if (Float2LongLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.n];
                entry.value = Float2LongLinkedOpenHashMap.this.value[Float2LongLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2LongLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2LongLinkedOpenHashMap.this.key[pos];
                entry.value = Float2LongLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2LongLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2LongLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2LongLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
