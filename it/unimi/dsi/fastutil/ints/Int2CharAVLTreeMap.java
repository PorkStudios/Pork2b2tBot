...
Cloneable {
    ...
    public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>(){
                final Comparator<? super Int2CharMap.Entry> comparator = (x, y) -> Int2CharAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2CharAVLTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2CharAVLTreeMap clone() {
        ...
        try {
            c = (Int2CharAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public char get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2CharAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Int2CharSortedMap headMap(int to) {
            ...
            return Int2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2CharSortedMap tailMap(int from) {
            ...
            return Int2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Int2CharSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Int2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Int2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2CharAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2CharAVLTreeMap.this.locateKey(k);
                if (submap.Int2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
