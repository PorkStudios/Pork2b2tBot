...
Externalizable {
    ...
    implements TShortCollection {
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Short) {
                    ...
                    if (TFloatShortHashMap.this.containsValue(ele)) continue;
                    return false;
                }
                return false;
            }
        ...
        public boolean containsAll(TShortCollection collection) {
            ...
            while (iter.hasNext()) {
                if (TFloatShortHashMap.this.containsValue(iter.next())) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean containsAll(short[] array) {
            for (short element : array) {
                if (TFloatShortHashMap.this.containsValue(element)) continue;
                return false;
            }
            return true;
        }
    ...
    implements TFloatSet {
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Float) {
                    ...
                    if (TFloatShortHashMap.this.containsKey(ele)) continue;
                    return false;
                }
                return false;
            }
        ...
        public boolean containsAll(TFloatCollection collection) {
            ...
            while (iter.hasNext()) {
                if (TFloatShortHashMap.this.containsKey(iter.next())) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean containsAll(float[] array) {
            for (float element : array) {
                if (TFloatShortHashMap.this.contains(element)) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean equals(Object other) {
            ...
            while (i-- > 0) {
                if (TFloatShortHashMap.this._states[i] != 1 || that.contains(TFloatShortHashMap.this._set[i])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i = TFloatShortHashMap.this._states.length;
            while (i-- > 0) {
                if (TFloatShortHashMap.this._states[i] != 1) continue;
