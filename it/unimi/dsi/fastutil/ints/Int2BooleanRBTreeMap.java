...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(){
                final Comparator<? super Int2BooleanMap.Entry> comparator = (x, y) -> Int2BooleanRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2BooleanRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2BooleanRBTreeMap clone() {
        ...
        try {
            c = (Int2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        final boolean in(int k) {
            return !(!this.bottom && Int2BooleanRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Int2BooleanRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(int k) {
            return this.in(k) && Int2BooleanRBTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2BooleanRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public boolean put(int k, boolean v) {
            ...
            boolean oldValue = Int2BooleanRBTreeMap.this.put(k, v);
        ...
        public boolean remove(int k) {
            ...
            boolean oldValue = Int2BooleanRBTreeMap.this.remove(k);
        ...
        public Int2BooleanSortedMap headMap(int to) {
            ...
            return Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2BooleanSortedMap tailMap(int from) {
            ...
            return Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Int2BooleanSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2BooleanRBTreeMap.this.locateKey(this.to);
                if (Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Int2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2BooleanRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2BooleanRBTreeMap.this.locateKey(k);
                if (submap.Int2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
