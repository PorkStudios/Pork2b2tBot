...
lbl160: // 1 sources:
    ...
    public Char2BooleanRBTreeMap clone() {
        ...
        try {
            c = (Char2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public boolean put(char k, boolean v) {
            ...
            boolean oldValue = Char2BooleanRBTreeMap.this.put(k, v);
        ...
        public boolean remove(char k) {
            ...
            boolean oldValue = Char2BooleanRBTreeMap.this.remove(k);
        ...
        public Char2BooleanSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2BooleanRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2BooleanRBTreeMap.this.locateKey(k);
                if (submap.Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
