...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>(){
                final Comparator<? super Float2FloatMap.Entry> comparator = (x, y) -> Float2FloatRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
    ...
    public Float2FloatRBTreeMap clone() {
        ...
        try {
            c = (Float2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public float get(float k) {
            Entry e;
            float kk = k;
            return this.in(kk) && (e = Float2FloatRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Float2FloatSortedMap headMap(float to) {
            ...
            return Float2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Float2FloatSortedMap tailMap(float from) {
            ...
            return Float2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Float2FloatSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Float2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Float2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2FloatRBTreeMap.this.locateKey(k);
                if (submap.Float2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
