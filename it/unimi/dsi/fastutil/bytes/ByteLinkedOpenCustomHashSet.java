...
Hash {
    ...
    public ByteLinkedOpenCustomHashSet clone() {
        ...
        try {
            c = (ByteLinkedOpenCustomHashSet)Object.super.clone();
        }
    ...
    implements ByteListIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = ByteLinkedOpenCustomHashSet.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (ByteLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = ByteLinkedOpenCustomHashSet.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (ByteLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
