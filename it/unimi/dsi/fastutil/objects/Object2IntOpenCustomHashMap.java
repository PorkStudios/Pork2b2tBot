...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2IntOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2IntOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2IntOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2IntOpenCustomHashMap<K>
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2IntOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2IntMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
            if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n], Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n]));
            }
            int pos = Object2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2IntOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenCustomHashMap.this.key[pos], Object2IntOpenCustomHashMap.this.value[pos]));
            }
        }
    ...
    implements ObjectIterator<Object2IntMap.Entry<K>> {
        private final Object2IntOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2IntOpenCustomHashMap<K> next() {
    ...
    extends Object2IntOpenCustomHashMap<K>
    implements ObjectIterator<Object2IntMap.Entry<K>> {
        private Object2IntOpenCustomHashMap<K> entry;
