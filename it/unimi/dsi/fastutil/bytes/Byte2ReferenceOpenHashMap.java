...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2ReferenceOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            c = (Byte2ReferenceOpenHashMap)Object.super.clone();
        }
    ...
    extends Byte2ReferenceOpenHashMap<V>
    ...
    implements Byte2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Byte2ReferenceOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Byte2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Byte2ReferenceOpenHashMap.this.value[pos] != v);
            Byte2ReferenceOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
            if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n], Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n]));
            }
            int pos = Byte2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ReferenceOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
                entry.key = Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n];
                entry.value = Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n];
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        private final Byte2ReferenceOpenHashMap<V> entry;
        ...
        @Override
        public Byte2ReferenceOpenHashMap<V> next() {
    ...
    extends Byte2ReferenceOpenHashMap<V>
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        private Byte2ReferenceOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Byte2ReferenceOpenHashMap.this.n;
                return this.last;
            }
            byte[] key = Byte2ReferenceOpenHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(k) & Byte2ReferenceOpenHashMap.this.mask;
                while (k != key[p]) {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                byte curr;
                int last = pos;
                pos = last + 1 & Byte2ReferenceOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
                    ...
                    int slot = HashCommon.mix(curr) & Byte2ReferenceOpenHashMap.this.mask;
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
    ...
    Map.Entry<Byte, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Byte2ReferenceOpenHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2ReferenceOpenHashMap.this.key[this.index] == (Byte)e.getKey() && Byte2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
        }
