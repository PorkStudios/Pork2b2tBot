...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Reference2IntOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Reference2IntOpenCustomHashMap<K> clone() {
        Reference2IntOpenCustomHashMap c;
        try {
            c = (Reference2IntOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2IntOpenCustomHashMap<K>
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2IntOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2IntMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2IntOpenCustomHashMap.this.strategy.equals(k, curr));
            return Reference2IntOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2IntOpenCustomHashMap.this.strategy.equals(curr, k) || Reference2IntOpenCustomHashMap.this.value[pos] != v);
            Reference2IntOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntOpenCustomHashMap.this.key[Reference2IntOpenCustomHashMap.this.n], Reference2IntOpenCustomHashMap.this.value[Reference2IntOpenCustomHashMap.this.n]));
            }
            int pos = Reference2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2IntOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    implements ObjectIterator<Reference2IntMap.Entry<K>> {
        private final Reference2IntOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2IntOpenCustomHashMap<K> next() {
    ...
    extends Reference2IntOpenCustomHashMap<K>
    implements ObjectIterator<Reference2IntMap.Entry<K>> {
        private Reference2IntOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Reference2IntOpenCustomHashMap.this.n;
                return this.last;
            }
            K[] key = Reference2IntOpenCustomHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask;
                while (!Reference2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                    p = p + 1 & Reference2IntOpenCustomHashMap.this.mask;
                }
                return p;
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                Object curr;
                int last = pos;
                pos = last + 1 & Reference2IntOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == null) {
                        key[last] = null;
                        return;
    ...
    Map.Entry<K, Integer> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2IntOpenCustomHashMap.this.value[this.index] == (Integer)e.getValue();
        }
