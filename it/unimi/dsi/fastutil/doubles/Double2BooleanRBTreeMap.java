...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>(){
                final Comparator<? super Double2BooleanMap.Entry> comparator = (x, y) -> Double2BooleanRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2BooleanRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2BooleanRBTreeMap clone() {
        ...
        try {
            c = (Double2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public boolean put(double k, boolean v) {
            ...
            boolean oldValue = Double2BooleanRBTreeMap.this.put(k, v);
        ...
        public boolean remove(double k) {
            ...
            boolean oldValue = Double2BooleanRBTreeMap.this.remove(k);
        ...
        public Double2BooleanSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2BooleanRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2BooleanRBTreeMap.this.locateKey(k);
                if (submap.Double2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            this.next = Double2BooleanRBTreeMap.this.locateKey(k);
            if (this.next != null) {
