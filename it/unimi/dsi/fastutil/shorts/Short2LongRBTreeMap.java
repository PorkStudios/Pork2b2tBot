...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(){
                final Comparator<? super Short2LongMap.Entry> comparator = (x, y) -> Short2LongRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2LongRBTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Short2LongRBTreeMap.this.remove(f.key);
                    return true;
                }
                ...
                public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
                    return Short2LongRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
                    return Short2LongRBTreeMap.this.headMap(to.getShortKey()).short2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
                    return Short2LongRBTreeMap.this.tailMap(from.getShortKey()).short2LongEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public boolean contains(long k) {
                    return Short2LongRBTreeMap.this.containsValue(k);
                }
    ...
    public Short2LongRBTreeMap clone() {
        ...
        try {
            c = (Short2LongRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(short from, boolean bottom, short to, boolean top) {
            if (!bottom && !top && Short2LongRBTreeMap.this.compare(from, to) > 0) {
        ...
        final boolean in(short k) {
            return !(!this.bottom && Short2LongRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Short2LongRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(short k) {
            return this.in(k) && Short2LongRBTreeMap.this.containsKey(k);
        }
        ...
        public long get(short k) {
            Entry e;
            short kk = k;
            return this.in(kk) && (e = Short2LongRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public long put(short k, long v) {
            ...
            long oldValue = Short2LongRBTreeMap.this.put(k, v);
        ...
        public long remove(short k) {
            ...
            long oldValue = Short2LongRBTreeMap.this.remove(k);
        ...
        public Short2LongSortedMap headMap(short to) {
            ...
            return Short2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Short2LongSortedMap tailMap(short from) {
            ...
            return Short2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Short2LongSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e = Short2LongRBTreeMap.this.firstEntry;
            } else {
                e = Short2LongRBTreeMap.this.locateKey(this.from);
                if (Short2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
                    e = e.next();
                }
            }
            if (e == null || !this.top && Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e = Short2LongRBTreeMap.this.lastEntry;
            } else {
                e = Short2LongRBTreeMap.this.locateKey(this.to);
                if (Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Short2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2LongRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2LongRBTreeMap.this.locateKey(k);
                if (submap.Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            this.next = Short2LongRBTreeMap.this.locateKey(k);
            if (this.next != null) {
                if (Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
