...
Hash {
    ...
    public Object2ObjectOpenCustomHashMap<K, V> clone() {
        ...
        try {
            c = (Object2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
        private final Object2ObjectOpenCustomHashMap<K, V> entry;
        ...
        @Override
        public Object2ObjectOpenCustomHashMap<K, V> next() {
    ...
    extends Object2ObjectOpenCustomHashMap<K, V>
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
        private Object2ObjectOpenCustomHashMap<K, V> entry;
