...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2ReferenceOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    public Int2ReferenceOpenCustomHashMap<V> clone() {
        Int2ReferenceOpenCustomHashMap c;
        try {
            c = (Int2ReferenceOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Int2ReferenceOpenCustomHashMap<V>
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Int2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) || Int2ReferenceOpenCustomHashMap.this.value[pos] != v);
            Int2ReferenceOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n], Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n]));
            }
            int pos = Int2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            AbstractInt2ReferenceMap.BasicEntry entry = new AbstractInt2ReferenceMap.BasicEntry();
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        private final Int2ReferenceOpenCustomHashMap<V> entry;
        ...
        @Override
        public Int2ReferenceOpenCustomHashMap<V> next() {
    ...
    extends Int2ReferenceOpenCustomHashMap<V>
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        private Int2ReferenceOpenCustomHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Int2ReferenceOpenCustomHashMap.this.n;
                return this.last;
            }
            int[] key = Int2ReferenceOpenCustomHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                int curr;
                int last = pos;
                pos = last + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
    ...
    Map.Entry<Integer, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Int2ReferenceOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], (Integer)e.getKey()) && Int2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
