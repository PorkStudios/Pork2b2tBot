...
Hash {
    ...
    public Short2ReferenceOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Short2ReferenceOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Short2ReferenceOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
        private final Short2ReferenceOpenCustomHashMap<V> entry;
        ...
        @Override
        public Short2ReferenceOpenCustomHashMap<V> next() {
    ...
    extends Short2ReferenceOpenCustomHashMap<V>
    implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
        private Short2ReferenceOpenCustomHashMap<V> entry;
