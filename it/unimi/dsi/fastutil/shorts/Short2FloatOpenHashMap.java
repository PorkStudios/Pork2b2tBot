...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Short2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]);
                    }
                    int pos = Short2FloatOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2FloatOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Short2FloatOpenHashMap clone() {
        ...
        try {
            c = (Short2FloatOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n]);
            }
            int pos = Short2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v);
            }
            short[] key = Short2FloatOpenHashMap.this.key;
            int pos = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask;
            short curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Short2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n], Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]));
            }
            int pos = Short2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2FloatOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                entry.key = Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n];
                entry.value = Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n];
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Short2FloatOpenHashMap.this.n;
                return this.last;
            }
            short[] key = Short2FloatOpenHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask;
                while (k != key[p]) {
                    p = p + 1 & Short2FloatOpenHashMap.this.mask;
                }
                return p;
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                ...
                do {
                    ...
                    int slot = HashCommon.mix(curr) & Short2FloatOpenHashMap.this.mask;
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
    ...
    Map.Entry<Short, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2FloatOpenHashMap.this.key[this.index] == (Short)e.getKey() && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
