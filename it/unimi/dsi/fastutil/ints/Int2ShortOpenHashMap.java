...
Hash {
            ...
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Int2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n]);
                    }
                    int pos = Int2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2ShortOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2ShortOpenHashMap clone() {
        ...
        try {
            c = (Int2ShortOpenHashMap)Object.super.clone();
        }
    ...
    implements Int2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2ShortOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ShortOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Int2ShortOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ShortOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2ShortOpenHashMap.this.value[pos] != v);
            Int2ShortOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2ShortMap.Entry> consumer) {
            if (Int2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortOpenHashMap.this.key[Int2ShortOpenHashMap.this.n], Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n]));
            }
            int pos = Int2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ShortOpenHashMap.this.key[pos] == 0) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Int2ShortOpenHashMap.this.n;
                return this.last;
            }
            int[] key = Int2ShortOpenHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(k) & Int2ShortOpenHashMap.this.mask;
                while (k != key[p]) {
                    p = p + 1 & Int2ShortOpenHashMap.this.mask;
                }
                return p;
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                int curr;
                int last = pos;
                pos = last + 1 & Int2ShortOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
                        return;
    ...
    Map.Entry<Integer, Short> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2ShortOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Int2ShortOpenHashMap.this.value[this.index] == (Short)e.getValue();
        }
