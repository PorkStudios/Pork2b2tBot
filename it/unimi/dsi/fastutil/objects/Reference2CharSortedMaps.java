...
public final class Reference2CharSortedMaps {
    ...
    Serializable {
        ...
        public Reference2CharSortedMap<K> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Reference2CharSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Reference2CharSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Reference2CharSortedMap<K> subMap(K from, K to) {
            return new SynchronizedSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Reference2CharSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Reference2CharSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap<K>((Reference2CharSortedMap<K>)this.sortedMap.tailMap((Object)from), this.sync);
        }
