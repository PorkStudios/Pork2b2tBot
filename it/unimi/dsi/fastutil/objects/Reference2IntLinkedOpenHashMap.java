...
Hash {
            ...
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Reference2IntLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Reference2IntLinkedOpenHashMap.this.value[Reference2IntLinkedOpenHashMap.this.n]);
                    }
                    int pos = Reference2IntLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2IntLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Reference2IntLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Reference2IntLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2IntLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2IntLinkedOpenHashMap<K>
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Reference2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2IntLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
        ...
        public boolean remove(Object k) {
            ...
            Reference2IntLinkedOpenHashMap.this.removeInt(k);
    ...
    implements Reference2IntSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            if (Reference2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.n], Reference2IntLinkedOpenHashMap.this.value[Reference2IntLinkedOpenHashMap.this.n]));
            }
            int pos = Reference2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2IntLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntLinkedOpenHashMap.this.key[pos], Reference2IntLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            ...
            if (Reference2IntLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.n];
                entry.value = Reference2IntLinkedOpenHashMap.this.value[Reference2IntLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Reference2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2IntLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Reference2IntLinkedOpenHashMap.this.key[pos];
                entry.value = Reference2IntLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Reference2IntMap.Entry<K>> {
        final Reference2IntLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Reference2IntLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Reference2IntLinkedOpenHashMap<K> previous() {
    ...
    extends Reference2IntLinkedOpenHashMap<K>
    implements ObjectListIterator<Reference2IntMap.Entry<K>> {
        private Reference2IntLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Reference2IntLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Reference2IntLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Reference2IntLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Reference2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
