...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2ShortRBTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2ShortRBTreeMap clone() {
        ...
        try {
            c = (Short2ShortRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public short put(short k, short v) {
            ...
            short oldValue = Short2ShortRBTreeMap.this.put(k, v);
        ...
        public short remove(short k) {
            ...
            short oldValue = Short2ShortRBTreeMap.this.remove(k);
        ...
        public Short2ShortSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2ShortRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2ShortRBTreeMap.this.locateKey(k);
                if (submap.Short2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractShort2ShortSortedMap.KeySet {
            private KeySet() {
            }
    ...
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            this.next = Short2ShortRBTreeMap.this.locateKey(k);
            if (this.next != null) {
