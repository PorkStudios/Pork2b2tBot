...
Cloneable {
    ...
    public Int2ReferenceArrayMap<V> clone() {
        Int2ReferenceArrayMap c;
        try {
            c = (Int2ReferenceArrayMap)Object.super.clone();
        }
        ...
        public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Int2ReferenceMap.Entry<V>>(){
                ...
                public Int2ReferenceMap.Entry<V> next() {
                    ...
                    this.curr = this.next;
                    return new AbstractInt2ReferenceMap.BasicEntry<Object>(Int2ReferenceArrayMap.this.key[this.curr], Int2ReferenceArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    Int2ReferenceArrayMap.access$200((Int2ReferenceArrayMap)Int2ReferenceArrayMap.this)[Int2ReferenceArrayMap.access$000((Int2ReferenceArrayMap)Int2ReferenceArrayMap.this)] = null;
                }
            };
        }
        ...
        public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
            return new ObjectIterator<Int2ReferenceMap.Entry<V>>(){
                ...
                public Int2ReferenceMap.Entry<V> next() {
                    ...
                    this.curr = this.next;
                    this.entry.key = Int2ReferenceArrayMap.this.key[this.curr];
