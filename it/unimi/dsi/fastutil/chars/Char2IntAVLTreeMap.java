...
Cloneable {
    ...
    public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>(){
                final Comparator<? super Char2IntMap.Entry> comparator = (x, y) -> Char2IntAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2IntAVLTreeMap clone() {
        ...
        try {
            c = (Char2IntAVLTreeMap)Object.super.clone();
        }
