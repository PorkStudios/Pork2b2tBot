...
Cloneable {
    ...
    public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>(){
                final Comparator<? super Float2ReferenceMap.Entry<V>> comparator = (x, y) -> Float2ReferenceAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
    ...
    public Float2ReferenceAVLTreeMap<V> clone() {
        ...
        try {
            c = (Float2ReferenceAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(float k) {
            Entry e;
            float kk = k;
            return (V)(this.in(kk) && (e = Float2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(float k, V v) {
            ...
            V oldValue = Float2ReferenceAVLTreeMap.this.put(k, v);
            return (V)(Float2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(float k) {
            ...
            return (V)(Float2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        extends Float2ReferenceAVLTreeMap<V>
