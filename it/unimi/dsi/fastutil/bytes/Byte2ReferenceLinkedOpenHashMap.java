...
Hash {
            ...
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n]);
                    }
                    int pos = Byte2ReferenceLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Byte2ReferenceLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Byte2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Byte2ReferenceLinkedOpenHashMap<V>
    ...
    extends AbstractByteSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.n]);
            }
            int pos = Byte2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Byte2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
            if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.n], Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceLinkedOpenHashMap.this.key[pos], Byte2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
        final Byte2ReferenceLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Byte2ReferenceLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Byte2ReferenceLinkedOpenHashMap<V> previous() {
    ...
    extends Byte2ReferenceLinkedOpenHashMap<V>
    implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
        private Byte2ReferenceLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
