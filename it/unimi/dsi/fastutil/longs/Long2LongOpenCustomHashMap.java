...
Hash {
    ...
    public long computeIfPresent(long k, BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        ...
        Long newValue = remappingFunction.apply((Long)k, (Long)this.value[pos]);
        if (newValue == null) {
            if (this.strategy.equals(k, 0L)) {
                this.removeNullEntry();
            } else {
    ...
    public long compute(long k, BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        Long newValue = remappingFunction.apply((Long)k, pos >= 0 ? Long.valueOf(this.value[pos]) : null);
        if (newValue == null) {
            if (pos >= 0) {
                if (this.strategy.equals(k, 0L)) {
                    this.removeNullEntry();
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2LongOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2LongOpenCustomHashMap clone() {
        ...
        try {
            c = (Long2LongOpenCustomHashMap)Object.super.clone();
        }
    ...
    implements Long2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Long2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Long2LongOpenCustomHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2LongOpenCustomHashMap.this.strategy.equals(k, curr));
            return Long2LongOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2LongOpenCustomHashMap.this.strategy.equals(curr, k) || Long2LongOpenCustomHashMap.this.value[pos] != v);
            Long2LongOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
            if (Long2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2LongMap.BasicEntry(Long2LongOpenCustomHashMap.this.key[Long2LongOpenCustomHashMap.this.n], Long2LongOpenCustomHashMap.this.value[Long2LongOpenCustomHashMap.this.n]));
            }
            int pos = Long2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2LongOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Long2LongOpenCustomHashMap.this.n;
                return this.last;
            }
            long[] key = Long2LongOpenCustomHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                long curr;
                int last = pos;
                pos = last + 1 & Long2LongOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0L) {
                        key[last] = 0L;
                        return;
