...
Hash {
    ...
    public Byte2ReferenceOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Byte2ReferenceOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Byte2ReferenceOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        private final Byte2ReferenceOpenCustomHashMap<V> entry;
        ...
        @Override
        public Byte2ReferenceOpenCustomHashMap<V> next() {
    ...
    extends Byte2ReferenceOpenCustomHashMap<V>
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        private Byte2ReferenceOpenCustomHashMap<V> entry;
