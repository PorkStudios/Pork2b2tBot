...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
                    return e.equals(f);
                }
    ...
    public Char2ByteAVLTreeMap clone() {
        ...
        try {
            c = (Char2ByteAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Char2ByteSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ByteAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ByteAVLTreeMap.this.locateKey(k);
                if (submap.Char2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
