...
Cloneable {
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(){
                final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = (x, y) -> Byte2ReferenceAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2ReferenceAVLTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2ReferenceAVLTreeMap<V> clone() {
        Byte2ReferenceAVLTreeMap c;
        try {
            c = (Byte2ReferenceAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(byte k) {
            Entry e;
            byte kk = k;
            return (V)(this.in(kk) && (e = Byte2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(byte k, V v) {
            ...
            return (V)(Byte2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(byte k) {
            ...
            Object oldValue = Byte2ReferenceAVLTreeMap.this.remove(k);
            return (V)(Byte2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        public Byte2ReferenceSortedMap<V> headMap(byte to) {
            ...
            return Byte2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2ReferenceSortedMap<V> tailMap(byte from) {
            ...
            return Byte2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (e == null || !this.top && Byte2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (e == null || !this.bottom && Byte2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Byte2ReferenceAVLTreeMap<V>
        ...
        extends Byte2ReferenceAVLTreeMap<V> {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2ReferenceAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2ReferenceAVLTreeMap.this.locateKey(k);
                if (submap.Byte2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
