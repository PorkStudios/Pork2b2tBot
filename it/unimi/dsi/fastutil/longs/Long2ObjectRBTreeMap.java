...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(){
                final Comparator<? super Long2ObjectMap.Entry<V>> comparator = (x, y) -> Long2ObjectRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
    ...
    public Long2ObjectRBTreeMap<V> clone() {
        ...
        try {
            c = (Long2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(long k) {
            Entry e;
            long kk = k;
            return (V)(this.in(kk) && (e = Long2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(long k, V v) {
            ...
            return (V)(Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(long k) {
            ...
            return (V)(Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        extends Long2ObjectRBTreeMap<V>
