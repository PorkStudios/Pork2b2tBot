...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2LongOpenHashMap.this.key[pos] == null) continue;
    ...
    public Object2LongOpenHashMap<K> clone() {
        ...
        try {
            c = (Object2LongOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2LongOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2LongMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            if (Object2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n], Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n]));
            }
            int pos = Object2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenHashMap.this.key[pos], Object2LongOpenHashMap.this.value[pos]));
            }
        }
    ...
    implements ObjectIterator<Object2LongMap.Entry<K>> {
        private final Object2LongOpenHashMap<K> entry;
        ...
        @Override
        public Object2LongOpenHashMap<K> next() {
    ...
    extends Object2LongOpenHashMap<K>
    implements ObjectIterator<Object2LongMap.Entry<K>> {
        private Object2LongOpenHashMap<K> entry;
