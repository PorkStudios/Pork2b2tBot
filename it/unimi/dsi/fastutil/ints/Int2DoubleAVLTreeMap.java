...
Cloneable {
    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(){
                final Comparator<? super Int2DoubleMap.Entry> comparator = (x, y) -> Int2DoubleAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2DoubleAVLTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2DoubleAVLTreeMap clone() {
        ...
        try {
            c = (Int2DoubleAVLTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        ...
        if (n == 2) {
            Entry top = new Entry(s.readInt(), s.readDouble());
            top.right(new Entry(s.readInt(), s.readDouble()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public double get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2DoubleAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Int2DoubleSortedMap headMap(int to) {
            ...
            return Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2DoubleSortedMap tailMap(int from) {
            ...
            return Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Int2DoubleSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2DoubleAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2DoubleAVLTreeMap.this.locateKey(k);
                if (submap.Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractInt2DoubleSortedMap.KeySet {
            private KeySet() {
            }
