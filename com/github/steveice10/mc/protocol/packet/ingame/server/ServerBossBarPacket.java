...
extends MinecraftPacket {
    ...
    public void write(NetOutput out) throws IOException {
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            out.writeVarInt(MagicValues.value(Integer.class, (Object)this.color));
            out.writeVarInt(MagicValues.value(Integer.class, (Object)this.division));
        }
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_FLAGS) {
            int flags = 0;
            if (this.darkenSky) {
