...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2BooleanLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2BooleanLinkedOpenHashMap clone() {
        ...
        try {
            c = (Char2BooleanLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Char2BooleanSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2BooleanLinkedOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2BooleanLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Char2BooleanLinkedOpenHashMap.this.value[pos] != v);
            Char2BooleanLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
            if (Char2BooleanLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2BooleanMap.BasicEntry(Char2BooleanLinkedOpenHashMap.this.key[Char2BooleanLinkedOpenHashMap.this.n], Char2BooleanLinkedOpenHashMap.this.value[Char2BooleanLinkedOpenHashMap.this.n]));
            }
            int pos = Char2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2BooleanLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2BooleanMap.BasicEntry(Char2BooleanLinkedOpenHashMap.this.key[pos], Char2BooleanLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
            ...
            if (Char2BooleanLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2BooleanLinkedOpenHashMap.this.key[Char2BooleanLinkedOpenHashMap.this.n];
                entry.value = Char2BooleanLinkedOpenHashMap.this.value[Char2BooleanLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2BooleanLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2BooleanLinkedOpenHashMap.this.key[pos];
                entry.value = Char2BooleanLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2BooleanLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2BooleanLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2BooleanLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2BooleanLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Character, Boolean> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2BooleanLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2BooleanLinkedOpenHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
