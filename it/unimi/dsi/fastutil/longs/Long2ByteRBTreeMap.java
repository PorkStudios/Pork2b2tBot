...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(){
                final Comparator<? super Long2ByteMap.Entry> comparator = (x, y) -> Long2ByteRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2ByteRBTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2ByteRBTreeMap clone() {
        ...
        try {
            c = (Long2ByteRBTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry top = new Entry(s.readLong(), s.readByte());
            top.pred(pred);
            top.succ(succ);
            top.black(true);
            return top;
    ...
    implements Serializable {
        ...
        public byte get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2ByteRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Long2ByteSortedMap headMap(long to) {
            ...
            return Long2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Long2ByteSortedMap tailMap(long from) {
            ...
            return Long2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Long2ByteSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Long2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Long2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2ByteRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2ByteRBTreeMap.this.locateKey(k);
                if (submap.Long2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
