...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2LongLinkedOpenHashMap clone() {
        ...
        try {
            c = (Double2LongLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Double2LongSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2LongLinkedOpenHashMap.this.mask;
            double curr = key[pos];
            if (Double.doubleToLongBits(curr) == 0L) {
                return false;
            }
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(k) != Double.doubleToLongBits(curr));
            return Double2LongLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || Double2LongLinkedOpenHashMap.this.value[pos] != v);
            Double2LongLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.n], Double2LongLinkedOpenHashMap.this.value[Double2LongLinkedOpenHashMap.this.n]));
            }
            int pos = Double2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                consumer.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongLinkedOpenHashMap.this.key[pos], Double2LongLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
            ...
            if (Double2LongLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.n];
                entry.value = Double2LongLinkedOpenHashMap.this.value[Double2LongLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Double2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                entry.key = Double2LongLinkedOpenHashMap.this.key[pos];
                entry.value = Double2LongLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(double from) {
            ...
            if (Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.last]) == Double.doubleToLongBits(from)) {
                this.prev = Double2LongLinkedOpenHashMap.this.last;
                this.index = Double2LongLinkedOpenHashMap.this.size;
                return;
            }
            int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(from)) & Double2LongLinkedOpenHashMap.this.mask;
            while (Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[pos]) != 0L) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Double2LongLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Double2LongLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Double2LongLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Double2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Double, Long> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2LongLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && Double2LongLinkedOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
