...
Cloneable {
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>(){
                final Comparator<? super Char2ObjectMap.Entry<V>> comparator = (x, y) -> Char2ObjectAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2ObjectAVLTreeMap<V> clone() {
        ...
        try {
            c = (Char2ObjectAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V put(char k, V v) {
            ...
            V oldValue = Char2ObjectAVLTreeMap.this.put(k, v);
        ...
        extends Char2ObjectAVLTreeMap<V>
