...
extends MinecraftPacket {
    ...
    public ClientNotificationValue value;
    ...
    public void write(NetOutput out) throws IOException {
        out.writeByte(MagicValues.value(Integer.class, (Object)this.notification));
        float value = 0.0f;
        if (this.value instanceof Enum) {
            value = MagicValues.value(Integer.class, this.value).intValue();
