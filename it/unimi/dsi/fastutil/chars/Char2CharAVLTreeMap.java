...
Cloneable {
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(){
                final Comparator<? super Char2CharMap.Entry> comparator = (x, y) -> Char2CharAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2CharAVLTreeMap clone() {
        ...
        try {
            c = (Char2CharAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Char2CharSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2CharAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2CharAVLTreeMap.this.locateKey(k);
                if (submap.Char2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
