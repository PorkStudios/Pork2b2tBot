...
Hash {
    ...
    public Object2ObjectOpenHashMap<K, V> clone() {
        ...
        try {
            c = (Object2ObjectOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2ObjectOpenHashMap<K, V>
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
        private final Object2ObjectOpenHashMap<K, V> entry;
        ...
        @Override
        public Object2ObjectOpenHashMap<K, V> next() {
    ...
    extends Object2ObjectOpenHashMap<K, V>
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
        private Object2ObjectOpenHashMap<K, V> entry;
