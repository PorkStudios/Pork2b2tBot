...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Float2IntAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    return e.equals(f);
                }
    ...
    public Float2IntAVLTreeMap clone() {
        ...
        try {
            c = (Float2IntAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public int put(float k, int v) {
            ...
            int oldValue = Float2IntAVLTreeMap.this.put(k, v);
        ...
        public int remove(float k) {
            ...
            int oldValue = Float2IntAVLTreeMap.this.remove(k);
        ...
        public Float2IntSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2IntAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2IntAVLTreeMap.this.locateKey(k);
                if (submap.Float2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            this.next = Float2IntAVLTreeMap.this.locateKey(k);
            if (this.next != null) {
