...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>(){
                final Comparator<? super Long2LongMap.Entry> comparator = (x, y) -> Long2LongRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2LongRBTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2LongRBTreeMap clone() {
        ...
        try {
            c = (Long2LongRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public long get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2LongRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Long2LongSortedMap headMap(long to) {
            ...
            return Long2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Long2LongSortedMap tailMap(long from) {
            ...
            return Long2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Long2LongSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Long2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Long2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2LongRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2LongRBTreeMap.this.locateKey(k);
                if (submap.Long2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
