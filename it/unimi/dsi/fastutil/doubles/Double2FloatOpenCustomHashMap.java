...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]);
                    }
                    int pos = Double2FloatOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2FloatOpenCustomHashMap clone() {
        ...
        try {
            c = (Double2FloatOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                return Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                if (Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Double2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Double2FloatMap.Entry> consumer) {
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2FloatMap.BasicEntry(Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n], Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2FloatMap.Entry> consumer) {
            ...
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n];
                entry.value = Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n];
    ...
    Map.Entry<Double, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], (Double)e.getKey()) && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
