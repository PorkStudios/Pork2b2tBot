...
Hash {
    ...
    public Int2ObjectOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Int2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Int2ObjectOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        private final Int2ObjectOpenCustomHashMap<V> entry;
        ...
        @Override
        public Int2ObjectOpenCustomHashMap<V> next() {
    ...
    extends Int2ObjectOpenCustomHashMap<V>
    implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        private Int2ObjectOpenCustomHashMap<V> entry;
