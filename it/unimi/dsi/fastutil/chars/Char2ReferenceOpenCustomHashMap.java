...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2ReferenceOpenCustomHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2ReferenceOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Char2ReferenceOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Char2ReferenceOpenCustomHashMap<V>
    ...
    implements Char2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceOpenCustomHashMap.this.key[Char2ReferenceOpenCustomHashMap.this.n], Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n]));
            }
            int pos = Char2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ReferenceOpenCustomHashMap.this.key[pos] == '\u0000') continue;
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        private final Char2ReferenceOpenCustomHashMap<V> entry;
        ...
        @Override
        public Char2ReferenceOpenCustomHashMap<V> next() {
    ...
    extends Char2ReferenceOpenCustomHashMap<V>
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        private Char2ReferenceOpenCustomHashMap<V> entry;
