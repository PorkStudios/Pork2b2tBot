...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2LongLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2LongLinkedOpenHashMap clone() {
        ...
        try {
            c = (Char2LongLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Char2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.n]);
            }
            int pos = Char2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = Char2LongLinkedOpenHashMap.this.key[pos];
                if (k == '\u0000') continue;
                consumer.accept(k);
            }
        }
    ...
    implements Char2LongSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2LongLinkedOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Char2LongLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Char2LongLinkedOpenHashMap.this.value[pos] != v);
            Char2LongLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.n], Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n]));
            }
            int pos = Char2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2LongLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongLinkedOpenHashMap.this.key[pos], Char2LongLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
            ...
            if (Char2LongLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.n];
                entry.value = Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2LongLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2LongLinkedOpenHashMap.this.key[pos];
                entry.value = Char2LongLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(char from) {
            ...
            int pos = HashCommon.mix(from) & Char2LongLinkedOpenHashMap.this.mask;
            while (Char2LongLinkedOpenHashMap.this.key[pos] != '\u0000') {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2LongLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2LongLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2LongLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Char2LongLinkedOpenHashMap.this.n) {
                ...
                do {
                    char curr;
                    int last = pos;
                    pos = last + 1 & Char2LongLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == '\u0000') {
                            key[last] = '\u0000';
                            return;
                        }
                        int slot = HashCommon.mix(curr) & Char2LongLinkedOpenHashMap.this.mask;
                        if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                        pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
                    } while (true);
                    key[last] = curr;
    ...
    Map.Entry<Character, Long> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2LongLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2LongLinkedOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
