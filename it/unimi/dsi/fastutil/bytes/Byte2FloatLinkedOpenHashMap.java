...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Byte2FloatLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2FloatLinkedOpenHashMap.this.value[Byte2FloatLinkedOpenHashMap.this.n]);
                    }
                    int pos = Byte2FloatLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Byte2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Byte2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Byte2FloatLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Byte2FloatSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatLinkedOpenHashMap.this.value[Byte2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v);
            }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Byte2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatLinkedOpenHashMap.this.value[Byte2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Byte2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Byte2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
            if (Byte2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatLinkedOpenHashMap.this.key[Byte2FloatLinkedOpenHashMap.this.n], Byte2FloatLinkedOpenHashMap.this.value[Byte2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatLinkedOpenHashMap.this.key[pos], Byte2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
            ...
            if (Byte2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2FloatLinkedOpenHashMap.this.key[Byte2FloatLinkedOpenHashMap.this.n];
                entry.value = Byte2FloatLinkedOpenHashMap.this.value[Byte2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Byte, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2FloatLinkedOpenHashMap.this.key[this.index] == (Byte)e.getKey() && Float.floatToIntBits(Byte2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
