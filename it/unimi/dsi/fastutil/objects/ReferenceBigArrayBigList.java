...
Serializable {
    ...
    public static <K> ReferenceBigArrayBigList<K> wrap(K[][] a) {
        return ReferenceBigArrayBigList.wrap(a, ObjectBigArrays.length(a));
    }
    ...
    public long indexOf(Object k) {
        for (long i = 0L; i < this.size; ++i) {
            if (k != ObjectBigArrays.get(this.a, i)) continue;
            return i;
        }
        return -1L;
    }
    ...
    public ObjectBigListIterator<K> listIterator(final long index) {
        ...
        return new ObjectBigListIterator<K>(){
            ...
            public K next() {
                ...
                this.last = this.pos++;
                return ObjectBigArrays.get(ReferenceBigArrayBigList.this.a, this.last);
            }
            ...
            public K previous() {
                ...
                this.last = --this.pos;
                return ObjectBigArrays.get(ReferenceBigArrayBigList.this.a, this.pos);
            }
    ...
    public ReferenceBigArrayBigList<K> clone() {
        ReferenceBigArrayBigList<K> c = new ReferenceBigArrayBigList<K>(this.size);
    ...
    public boolean equals(ReferenceBigArrayBigList<K> l) {
        ...
        K[][] a2 = l.a;
        while (s-- != 0L) {
            if (ObjectBigArrays.get(a1, s) == ObjectBigArrays.get(a2, s)) continue;
            return false;
        }
        return true;
    }
