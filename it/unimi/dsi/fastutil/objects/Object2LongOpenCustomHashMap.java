...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2LongOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2LongOpenCustomHashMap<K> clone() {
        Object2LongOpenCustomHashMap c;
        try {
            c = (Object2LongOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2LongOpenCustomHashMap<K>
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2LongOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2LongMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2LongOpenCustomHashMap.this.strategy.equals(k, curr));
            return Object2LongOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2LongOpenCustomHashMap.this.strategy.equals(curr, k) || Object2LongOpenCustomHashMap.this.value[pos] != v);
            Object2LongOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            if (Object2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n], Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n]));
            }
            int pos = Object2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    implements ObjectIterator<Object2LongMap.Entry<K>> {
        private final Object2LongOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2LongOpenCustomHashMap<K> next() {
    ...
    extends Object2LongOpenCustomHashMap<K>
    implements ObjectIterator<Object2LongMap.Entry<K>> {
        private Object2LongOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Object2LongOpenCustomHashMap.this.n;
                return this.last;
            }
            K[] key = Object2LongOpenCustomHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                Object curr;
                int last = pos;
                pos = last + 1 & Object2LongOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == null) {
                        key[last] = null;
                        return;
    ...
    Map.Entry<K, Long> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2LongOpenCustomHashMap.this.value[this.index] == (Long)e.getValue();
        }
