...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2CharOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2CharOpenHashMap clone() {
        ...
        try {
            c = (Int2CharOpenHashMap)Object.super.clone();
        }
    ...
    implements Int2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2CharOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Int2CharOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2CharOpenHashMap.this.value[pos] != v);
            Int2CharOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenHashMap.this.key[Int2CharOpenHashMap.this.n], Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n]));
            }
            int pos = Int2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharOpenHashMap.this.key[pos] == 0) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Int2CharOpenHashMap.this.n;
                return this.last;
            }
            int[] key = Int2CharOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                int curr;
                int last = pos;
                pos = last + 1 & Int2CharOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
                        return;
    ...
    Map.Entry<Integer, Character> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2CharOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Int2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
