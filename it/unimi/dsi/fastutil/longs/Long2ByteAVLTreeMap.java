...
Cloneable {
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(){
                final Comparator<? super Long2ByteMap.Entry> comparator = (x, y) -> Long2ByteAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2ByteAVLTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2ByteAVLTreeMap clone() {
        ...
        try {
            c = (Long2ByteAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public byte put(long k, byte v) {
            ...
            byte oldValue = Long2ByteAVLTreeMap.this.put(k, v);
        ...
        public byte remove(long k) {
            ...
            byte oldValue = Long2ByteAVLTreeMap.this.remove(k);
        ...
        public Long2ByteSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2ByteAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2ByteAVLTreeMap.this.locateKey(k);
                if (submap.Long2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            this.next = Long2ByteAVLTreeMap.this.locateKey(k);
            if (this.next != null) {
