...
Cloneable {
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(){
                final Comparator<? super Byte2BooleanMap.Entry> comparator = (x, y) -> Byte2BooleanAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2BooleanAVLTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Byte2BooleanAVLTreeMap.this.remove(f.key);
                    return true;
                }
                ...
                public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
                    return Byte2BooleanAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
                    return Byte2BooleanAVLTreeMap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
                    return Byte2BooleanAVLTreeMap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public boolean contains(boolean k) {
                    return Byte2BooleanAVLTreeMap.this.containsValue(k);
                }
    ...
    public Byte2BooleanAVLTreeMap clone() {
        ...
        try {
            c = (Byte2BooleanAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        final boolean in(byte k) {
            return !(!this.bottom && Byte2BooleanAVLTreeMap.this.compare(k, this.from) < 0 || !this.top && Byte2BooleanAVLTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k) {
            return this.in(k) && Byte2BooleanAVLTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2BooleanAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public boolean put(byte k, boolean v) {
            ...
            boolean oldValue = Byte2BooleanAVLTreeMap.this.put(k, v);
        ...
        public boolean remove(byte k) {
            ...
            boolean oldValue = Byte2BooleanAVLTreeMap.this.remove(k);
        ...
        public Byte2BooleanSortedMap headMap(byte to) {
            ...
            return Byte2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2BooleanSortedMap tailMap(byte from) {
            ...
            return Byte2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2BooleanSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e = Byte2BooleanAVLTreeMap.this.firstEntry;
            } else {
                e = Byte2BooleanAVLTreeMap.this.locateKey(this.from);
                if (Byte2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
                    e = e.next();
                }
            }
            if (e == null || !this.top && Byte2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2BooleanAVLTreeMap.this.locateKey(this.to);
                if (Byte2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Byte2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2BooleanAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2BooleanAVLTreeMap.this.locateKey(k);
                if (submap.Byte2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            this.next = Byte2BooleanAVLTreeMap.this.locateKey(k);
            if (this.next != null) {
                if (Byte2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
