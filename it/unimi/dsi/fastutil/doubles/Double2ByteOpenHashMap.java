...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2ByteOpenHashMap clone() {
        ...
        try {
            c = (Double2ByteOpenHashMap)Object.super.clone();
        }
    ...
    implements Double2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ByteOpenHashMap.this.mask;
            double curr = key[pos];
            if (Double.doubleToLongBits(curr) == 0L) {
                return false;
            }
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(k) != Double.doubleToLongBits(curr));
            return Double2ByteOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || Double2ByteOpenHashMap.this.value[pos] != v);
            Double2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]));
            }
            int pos = Double2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            ...
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                entry.key = Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n];
                entry.value = Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n];
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Double2ByteOpenHashMap.this.n;
                return this.last;
            }
            double[] key = Double2ByteOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                double curr;
                int last = pos;
                pos = last + 1 & Double2ByteOpenHashMap.this.mask;
                do {
                    if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
                        key[last] = 0.0;
                        return;
    ...
    Map.Entry<Double, Byte> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && Double2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
        }
