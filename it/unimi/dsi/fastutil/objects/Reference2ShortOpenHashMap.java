...
Hash {
            ...
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Reference2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n]);
                    }
                    int pos = Reference2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2ShortOpenHashMap.this.key[pos] == null) continue;
    ...
    public Reference2ShortOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2ShortOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2ShortOpenHashMap<K>
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(Reference2ShortOpenHashMap.this.key[Reference2ShortOpenHashMap.this.n]);
            }
            int pos = Reference2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2ShortOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2ShortMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
            if (Reference2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2ShortMap.BasicEntry(Reference2ShortOpenHashMap.this.key[Reference2ShortOpenHashMap.this.n], Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n]));
            }
            int pos = Reference2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ShortOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
            ...
            if (Reference2ShortOpenHashMap.this.containsNullKey) {
                entry.key = Reference2ShortOpenHashMap.this.key[Reference2ShortOpenHashMap.this.n];
                entry.value = Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n];
    ...
    implements ObjectIterator<Reference2ShortMap.Entry<K>> {
        private final Reference2ShortOpenHashMap<K> entry;
        ...
        @Override
        public Reference2ShortOpenHashMap<K> next() {
    ...
    extends Reference2ShortOpenHashMap<K>
    implements ObjectIterator<Reference2ShortMap.Entry<K>> {
        private Reference2ShortOpenHashMap<K> entry;
