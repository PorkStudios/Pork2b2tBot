...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                final Comparator<? super Char2ByteMap.Entry> comparator = (x, y) -> Char2ByteRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2ByteRBTreeMap clone() {
        ...
        try {
            c = (Char2ByteRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public byte put(char k, byte v) {
            ...
            byte oldValue = Char2ByteRBTreeMap.this.put(k, v);
        ...
        public byte remove(char k) {
            ...
            byte oldValue = Char2ByteRBTreeMap.this.remove(k);
        ...
        public Char2ByteSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ByteRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ByteRBTreeMap.this.locateKey(k);
                if (submap.Char2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
