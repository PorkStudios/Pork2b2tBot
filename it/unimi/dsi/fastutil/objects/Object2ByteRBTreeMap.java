...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(){
                final Comparator<? super Object2ByteMap.Entry<K>> comparator = (x, y) -> Object2ByteRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2ByteRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> to) {
                    return Object2ByteRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
                    return Object2ByteRBTreeMap.this.headMap(to.getKey()).object2ByteEntrySet();
                }
    ...
    public Object2ByteRBTreeMap<K> clone() {
        Object2ByteRBTreeMap c;
        try {
            c = (Object2ByteRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2ByteRBTreeMap.this.containsKey(k);
        }
        ...
        public byte getByte(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2ByteRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Object2ByteSortedMap<K> headMap(K to) {
            ...
            return Object2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2ByteSortedMap<K> tailMap(K from) {
            ...
            return Object2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2ByteSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<K> firstEntry() {
            ...
            if (e == null || !this.top && Object2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<K> lastEntry() {
            ...
            if (e == null || !this.bottom && Object2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Object2ByteRBTreeMap<K>
        ...
        extends Object2ByteRBTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2ByteRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2ByteRBTreeMap.this.locateKey(k);
                if (submap.Object2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
