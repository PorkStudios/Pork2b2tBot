...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>(){
                final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = (x, y) -> Object2ObjectRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2ObjectRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
                    return Object2ObjectRBTreeMap.this.headMap((Object)to.getKey()).object2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
                    return Object2ObjectRBTreeMap.this.tailMap((Object)from.getKey()).object2ObjectEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2ObjectRBTreeMap<K, V> clone() {
        Object2ObjectRBTreeMap c;
        try {
            c = (Object2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>(){
                    ...
                    @Override
                    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
                        return Submap.this.headMap((Object)to.getKey()).object2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
                        return Submap.this.tailMap((Object)from.getKey()).object2ObjectEntrySet();
                    }
                };
            }
            return this.entries;
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2ObjectRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(Object k) {
            Entry e;
            Object kk = k;
            return (V)(this.in(kk) && (e = Object2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(K k, V v) {
            ...
            return (V)(Object2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(Object k) {
            ...
            Object oldValue = Object2ObjectRBTreeMap.this.remove(k);
            return (V)(Object2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        public Object2ObjectSortedMap<K, V> headMap(K to) {
            ...
            return Object2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2ObjectSortedMap<K, V> tailMap(K from) {
            ...
            return Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<K, V> firstEntry() {
            ...
            if (e == null || !this.top && Object2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<K, V> lastEntry() {
            ...
            if (e == null || !this.bottom && Object2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Object2ObjectRBTreeMap<K, V>
        ...
        extends Object2ObjectRBTreeMap<K, V> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Object2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
