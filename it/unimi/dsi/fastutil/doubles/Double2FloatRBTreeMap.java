...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(){
                final Comparator<? super Double2FloatMap.Entry> comparator = (x, y) -> Double2FloatRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2FloatRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2FloatRBTreeMap clone() {
        ...
        try {
            c = (Double2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Double2FloatSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2FloatRBTreeMap.this.locateKey(k);
                if (submap.Double2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
