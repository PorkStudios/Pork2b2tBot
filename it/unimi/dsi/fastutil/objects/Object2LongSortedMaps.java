...
public final class Object2LongSortedMaps {
    ...
    public static <K> ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongSortedMap<K> map) {
        ObjectSet entries = map.object2LongEntrySet();
    ...
    public static <K> ObjectBidirectionalIterable<Object2LongMap.Entry<K>> fastIterable(Object2LongSortedMap<K> map) {
        ObjectSet entries = map.object2LongEntrySet();
        return entries instanceof Object2LongSortedMap.FastSortedEntrySet ? ((Object2LongSortedMap.FastSortedEntrySet)entries)::fastIterator : entries;
    }
    ...
    Serializable {
        ...
        public Object2LongSortedMap<K> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Object2LongSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Object2LongSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Object2LongSortedMap<K> subMap(K from, K to) {
            return new SynchronizedSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Object2LongSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Object2LongSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap<K>((Object2LongSortedMap<K>)this.sortedMap.tailMap((Object)from), this.sync);
        }
