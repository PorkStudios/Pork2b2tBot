...
Cloneable {
    ...
    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(){
                final Comparator<? super Byte2CharMap.Entry> comparator = (x, y) -> Byte2CharAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2CharAVLTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2CharAVLTreeMap clone() {
        ...
        try {
            c = (Byte2CharAVLTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        ...
        if (n == 2) {
            Entry top = new Entry(s.readByte(), s.readChar());
            top.right(new Entry(s.readByte(), s.readChar()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public char get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2CharAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Byte2CharSortedMap headMap(byte to) {
            ...
            return Byte2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2CharSortedMap tailMap(byte from) {
            ...
            return Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2CharSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Byte2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Byte2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2CharAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2CharAVLTreeMap.this.locateKey(k);
                if (submap.Byte2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
