...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                final Comparator<? super Byte2IntMap.Entry> comparator = (x, y) -> Byte2IntRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2IntRBTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2IntRBTreeMap clone() {
        Byte2IntRBTreeMap c;
        try {
            c = (Byte2IntRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        final boolean in(byte k) {
            return !(!this.bottom && Byte2IntRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Byte2IntRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k) {
            return this.in(k) && Byte2IntRBTreeMap.this.containsKey(k);
        }
        ...
        public int get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2IntRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public int put(byte k, int v) {
            ...
            int oldValue = Byte2IntRBTreeMap.this.put(k, v);
            return Byte2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public int remove(byte k) {
            ...
            int oldValue = Byte2IntRBTreeMap.this.remove(k);
            return Byte2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
        }
        ...
        public Byte2IntSortedMap headMap(byte to) {
            ...
            return Byte2IntRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2IntSortedMap tailMap(byte from) {
            ...
            return Byte2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2IntSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2IntRBTreeMap.this.locateKey(this.to);
                if (Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Byte2IntRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2IntRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2IntRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2IntRBTreeMap.this.locateKey(k);
                if (submap.Byte2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
