...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Int2FloatLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Int2FloatLinkedOpenHashMap.this.value[Int2FloatLinkedOpenHashMap.this.n]);
                    }
                    int pos = Int2FloatLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Int2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Int2FloatLinkedOpenHashMap clone() {
        ...
        try {
            c = (Int2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractObjectSortedSet<Int2FloatMap.Entry>
    implements Int2FloatSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2FloatLinkedOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Int2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            if (Int2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatLinkedOpenHashMap.this.key[Int2FloatLinkedOpenHashMap.this.n], Int2FloatLinkedOpenHashMap.this.value[Int2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Int2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatLinkedOpenHashMap.this.key[pos], Int2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            ...
            if (Int2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Int2FloatLinkedOpenHashMap.this.key[Int2FloatLinkedOpenHashMap.this.n];
                entry.value = Int2FloatLinkedOpenHashMap.this.value[Int2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Int2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(int from) {
            ...
            int pos = HashCommon.mix(from) & Int2FloatLinkedOpenHashMap.this.mask;
            while (Int2FloatLinkedOpenHashMap.this.key[pos] != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Int2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Int2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Int2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Int2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Int2FloatLinkedOpenHashMap.this.n) {
                ...
                do {
                    int curr;
                    int last = pos;
                    pos = last + 1 & Int2FloatLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0) {
                            key[last] = 0;
                            return;
    ...
    Map.Entry<Integer, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2FloatLinkedOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
