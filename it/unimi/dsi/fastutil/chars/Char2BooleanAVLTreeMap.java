...
Cloneable {
    ...
    public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(){
                final Comparator<? super Char2BooleanMap.Entry> comparator = (x, y) -> Char2BooleanAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
    ...
    public Char2BooleanAVLTreeMap clone() {
        ...
        try {
            c = (Char2BooleanAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public boolean get(char k) {
            Entry e;
            char kk = k;
            return this.in(kk) && (e = Char2BooleanAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Char2BooleanSortedMap headMap(char to) {
            ...
            return Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Char2BooleanSortedMap tailMap(char from) {
            ...
            return Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Char2BooleanSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Char2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Char2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2BooleanAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2BooleanAVLTreeMap.this.locateKey(k);
                if (submap.Char2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
