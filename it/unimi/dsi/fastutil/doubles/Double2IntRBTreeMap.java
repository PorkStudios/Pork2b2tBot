...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2IntRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2IntRBTreeMap clone() {
        ...
        try {
            c = (Double2IntRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public int put(double k, int v) {
            ...
            int oldValue = Double2IntRBTreeMap.this.put(k, v);
        ...
        public int remove(double k) {
            ...
            int oldValue = Double2IntRBTreeMap.this.remove(k);
        ...
        public Double2IntSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2IntRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2IntRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2IntRBTreeMap.this.locateKey(k);
                if (submap.Double2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            this.next = Double2IntRBTreeMap.this.locateKey(k);
            if (this.next != null) {
