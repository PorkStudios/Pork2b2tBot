...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2IntLinkedOpenHashMap clone() {
        ...
        try {
            c = (Float2IntLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Float2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2IntSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask;
            float curr = key[pos];
            if (Float.floatToIntBits(curr) == 0) {
                return false;
            }
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(k) != Float.floatToIntBits(curr));
            return Float2IntLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || Float2IntLinkedOpenHashMap.this.value[pos] != v);
            Float2IntLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
            if (Float2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.n], Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n]));
            }
            int pos = Float2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntLinkedOpenHashMap.this.key[pos], Float2IntLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2IntMap.Entry> consumer) {
            ...
            if (Float2IntLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.n];
                entry.value = Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2IntLinkedOpenHashMap.this.key[pos];
                entry.value = Float2IntLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(float from) {
            ...
            int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2IntLinkedOpenHashMap.this.mask;
            while (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2IntLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2IntLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2IntLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Float2IntLinkedOpenHashMap.this.n) {
                ...
                do {
                    float curr;
                    int last = pos;
                    pos = last + 1 & Float2IntLinkedOpenHashMap.this.mask;
                    do {
                        if (Float.floatToIntBits(curr = key[pos]) == 0) {
                            key[last] = 0.0f;
                            return;
    ...
    Map.Entry<Float, Integer> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2IntLinkedOpenHashMap.this.value[this.index] == (Integer)e.getValue();
        }
