...
Hash {
            ...
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Double2ObjectLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2ObjectLinkedOpenHashMap.this.value[Double2ObjectLinkedOpenHashMap.this.n]);
                    }
                    int pos = Double2ObjectLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                        consumer.accept(Double2ObjectLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Double2ObjectLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Double2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Double2ObjectLinkedOpenHashMap<V>
    ...
    extends AbstractDoubleSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.n]);
            }
            int pos = Double2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = Double2ObjectLinkedOpenHashMap.this.key[pos];
    ...
    implements Double2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            Object v = e.getValue();
            if (Double.doubleToLongBits(k) == 0L) {
                return Double2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[Double2ObjectLinkedOpenHashMap.this.n], v);
            }
            ...
            if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) {
                return Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[pos], v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            Object v = e.getValue();
            if (Double.doubleToLongBits(k) == 0L) {
                if (Double2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[Double2ObjectLinkedOpenHashMap.this.n], v)) {
            ...
            if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
                if (Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[pos], v)) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || !Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[pos], v));
            Double2ObjectLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Double2ObjectMap.Entry<V>> consumer) {
            if (Double2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ObjectMap.BasicEntry(Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.n], Double2ObjectLinkedOpenHashMap.this.value[Double2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Double2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                consumer.accept(new AbstractDouble2ObjectMap.BasicEntry(Double2ObjectLinkedOpenHashMap.this.key[pos], Double2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Double2ObjectMap.Entry<V>> consumer) {
            ...
            if (Double2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.n];
                entry.value = Double2ObjectLinkedOpenHashMap.this.value[Double2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Double2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                entry.key = Double2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Double2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
        final Double2ObjectLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Double2ObjectLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Double2ObjectLinkedOpenHashMap<V> previous() {
    ...
    extends Double2ObjectLinkedOpenHashMap<V>
    implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
        private Double2ObjectLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Double2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Double2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Double2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Double2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<Double, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2ObjectLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && Objects.equals(Double2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue());
        }
