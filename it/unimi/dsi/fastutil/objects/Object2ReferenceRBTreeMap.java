...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>(){
                final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = (x, y) -> Object2ReferenceRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> to) {
                    return Object2ReferenceRBTreeMap.this.headMap((Object)to.getKey()).object2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> from) {
                    return Object2ReferenceRBTreeMap.this.tailMap((Object)from.getKey()).object2ReferenceEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2ReferenceRBTreeMap<K, V> clone() {
        ...
        try {
            c = (Object2ReferenceRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ReferenceSortedMap<K, V> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2ReferenceRBTreeMap<K, V>
