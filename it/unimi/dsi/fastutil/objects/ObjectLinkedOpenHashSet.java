...
Hash {
    ...
    public ObjectLinkedOpenHashSet<K> clone() {
        ...
        try {
            c = (ObjectLinkedOpenHashSet)Object.super.clone();
        }
    ...
    implements ObjectListIterator<K> {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = ObjectLinkedOpenHashSet.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (ObjectLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = ObjectLinkedOpenHashSet.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (ObjectLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
