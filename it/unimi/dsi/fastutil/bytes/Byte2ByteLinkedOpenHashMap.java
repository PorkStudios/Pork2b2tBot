...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2ByteLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Byte2ByteSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Byte2ByteLinkedOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Byte2ByteLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Byte2ByteLinkedOpenHashMap.this.value[pos] != v);
            Byte2ByteLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            if (Byte2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteLinkedOpenHashMap.this.key[Byte2ByteLinkedOpenHashMap.this.n], Byte2ByteLinkedOpenHashMap.this.value[Byte2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteLinkedOpenHashMap.this.key[pos], Byte2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            ...
            if (Byte2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2ByteLinkedOpenHashMap.this.key[Byte2ByteLinkedOpenHashMap.this.n];
                entry.value = Byte2ByteLinkedOpenHashMap.this.value[Byte2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(byte from) {
            ...
            int pos = HashCommon.mix(from) & Byte2ByteLinkedOpenHashMap.this.mask;
            while (Byte2ByteLinkedOpenHashMap.this.key[pos] != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
