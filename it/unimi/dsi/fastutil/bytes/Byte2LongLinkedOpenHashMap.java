...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2LongLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2LongLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2LongLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Byte2LongSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            if (Byte2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongLinkedOpenHashMap.this.key[Byte2LongLinkedOpenHashMap.this.n], Byte2LongLinkedOpenHashMap.this.value[Byte2LongLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2LongLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongLinkedOpenHashMap.this.key[pos], Byte2LongLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            ...
            if (Byte2LongLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2LongLinkedOpenHashMap.this.key[Byte2LongLinkedOpenHashMap.this.n];
                entry.value = Byte2LongLinkedOpenHashMap.this.value[Byte2LongLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2LongLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2LongLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2LongLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2LongLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2LongLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2LongLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
