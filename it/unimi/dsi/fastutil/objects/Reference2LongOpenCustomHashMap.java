...
Hash {
    ...
    public Reference2LongOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2LongOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2LongOpenCustomHashMap<K>
    ...
    implements ObjectIterator<Reference2LongMap.Entry<K>> {
        private final Reference2LongOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2LongOpenCustomHashMap<K> next() {
    ...
    extends Reference2LongOpenCustomHashMap<K>
    implements ObjectIterator<Reference2LongMap.Entry<K>> {
        private Reference2LongOpenCustomHashMap<K> entry;
