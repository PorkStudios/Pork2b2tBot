...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>(){
                final Comparator<? super Long2ShortMap.Entry> comparator = (x, y) -> Long2ShortRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2ShortRBTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Long2ShortRBTreeMap.this.remove(f.key);
                    return true;
                }
                ...
                public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry from, Long2ShortMap.Entry to) {
                    return Long2ShortRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry to) {
                    return Long2ShortRBTreeMap.this.headMap(to.getLongKey()).long2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry from) {
                    return Long2ShortRBTreeMap.this.tailMap(from.getLongKey()).long2ShortEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public boolean contains(short k) {
                    return Long2ShortRBTreeMap.this.containsValue(k);
                }
    ...
    public Long2ShortRBTreeMap clone() {
        ...
        try {
            c = (Long2ShortRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(long from, boolean bottom, long to, boolean top) {
            if (!bottom && !top && Long2ShortRBTreeMap.this.compare(from, to) > 0) {
        ...
        final boolean in(long k) {
            return !(!this.bottom && Long2ShortRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Long2ShortRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(long k) {
            return this.in(k) && Long2ShortRBTreeMap.this.containsKey(k);
        }
        ...
        public short get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2ShortRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public short put(long k, short v) {
            ...
            short oldValue = Long2ShortRBTreeMap.this.put(k, v);
        ...
        public short remove(long k) {
            ...
            short oldValue = Long2ShortRBTreeMap.this.remove(k);
        ...
        public Long2ShortSortedMap headMap(long to) {
            ...
            return Long2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Long2ShortSortedMap tailMap(long from) {
            ...
            return Long2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Long2ShortSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e = Long2ShortRBTreeMap.this.firstEntry;
            } else {
                e = Long2ShortRBTreeMap.this.locateKey(this.from);
                if (Long2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                    e = e.next();
                }
            }
            if (e == null || !this.top && Long2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e = Long2ShortRBTreeMap.this.lastEntry;
            } else {
                e = Long2ShortRBTreeMap.this.locateKey(this.to);
                if (Long2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Long2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2ShortRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2ShortRBTreeMap.this.locateKey(k);
                if (submap.Long2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            this.next = Long2ShortRBTreeMap.this.locateKey(k);
            if (this.next != null) {
                if (Long2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
