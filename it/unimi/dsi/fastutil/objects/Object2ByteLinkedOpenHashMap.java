...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2ByteLinkedOpenHashMap.this.key[pos] == null) continue;
    ...
    public Object2ByteLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Object2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2ByteLinkedOpenHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2ByteLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2ByteSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            if (Object2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteLinkedOpenHashMap.this.key[Object2ByteLinkedOpenHashMap.this.n], Object2ByteLinkedOpenHashMap.this.value[Object2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Object2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ByteLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteLinkedOpenHashMap.this.key[pos], Object2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            ...
            if (Object2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Object2ByteLinkedOpenHashMap.this.key[Object2ByteLinkedOpenHashMap.this.n];
                entry.value = Object2ByteLinkedOpenHashMap.this.value[Object2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ByteLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Object2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Object2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2ByteMap.Entry<K>> {
        final Object2ByteLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Object2ByteLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2ByteLinkedOpenHashMap<K> previous() {
    ...
    extends Object2ByteLinkedOpenHashMap<K>
    implements ObjectListIterator<Object2ByteMap.Entry<K>> {
        private Object2ByteLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
