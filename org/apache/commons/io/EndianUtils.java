...
public class EndianUtils {
    ...
    public static long readSwappedUnsignedInteger(byte[] data, int offset) {
        long low = ((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << 16);
        long high = data[offset + 3] & 255;
        return (high << 24) + (0xFFFFFFFFL & low);
    }

    public static void writeSwappedLong(byte[] data, int offset, long value) {
        data[offset + 0] = (byte)(value >> 0 & 255L);
        data[offset + 1] = (byte)(value >> 8 & 255L);
        data[offset + 2] = (byte)(value >> 16 & 255L);
        data[offset + 3] = (byte)(value >> 24 & 255L);
        data[offset + 4] = (byte)(value >> 32 & 255L);
        data[offset + 5] = (byte)(value >> 40 & 255L);
        data[offset + 6] = (byte)(value >> 48 & 255L);
        data[offset + 7] = (byte)(value >> 56 & 255L);
    }
    ...
    public static short readSwappedShort(InputStream input) throws IOException {
        return (short)(((EndianUtils.read(input) & 255) << 0) + ((EndianUtils.read(input) & 255) << 8));
    }
    ...
    public static void writeSwappedLong(OutputStream output, long value) throws IOException {
        output.write((byte)(value >> 0 & 255L));
        output.write((byte)(value >> 8 & 255L));
        output.write((byte)(value >> 16 & 255L));
        output.write((byte)(value >> 24 & 255L));
        output.write((byte)(value >> 32 & 255L));
        output.write((byte)(value >> 40 & 255L));
        output.write((byte)(value >> 48 & 255L));
        output.write((byte)(value >> 56 & 255L));
    }
