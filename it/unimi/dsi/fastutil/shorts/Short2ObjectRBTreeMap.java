...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(){
                final Comparator<? super Short2ObjectMap.Entry<V>> comparator = (x, y) -> Short2ObjectRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2ObjectRBTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2ObjectRBTreeMap<V> clone() {
        ...
        try {
            c = (Short2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V put(short k, V v) {
            ...
            V oldValue = Short2ObjectRBTreeMap.this.put(k, v);
        ...
        public V remove(short k) {
            ...
            Object oldValue = Short2ObjectRBTreeMap.this.remove(k);
        ...
        public Short2ObjectSortedMap<V> subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Short2ObjectRBTreeMap<V>
        ...
        extends Short2ObjectRBTreeMap<V> {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Short2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
