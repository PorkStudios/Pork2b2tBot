...
Hash {
    ...
    public Double2ReferenceOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Double2ReferenceOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Double2ReferenceOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
        private final Double2ReferenceOpenCustomHashMap<V> entry;
        ...
        @Override
        public Double2ReferenceOpenCustomHashMap<V> next() {
    ...
    extends Double2ReferenceOpenCustomHashMap<V>
    implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
        private Double2ReferenceOpenCustomHashMap<V> entry;
