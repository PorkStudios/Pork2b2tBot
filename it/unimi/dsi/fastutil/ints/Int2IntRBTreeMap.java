...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(){
                final Comparator<? super Int2IntMap.Entry> comparator = (x, y) -> Int2IntRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
    ...
    public Int2IntRBTreeMap clone() {
        Int2IntRBTreeMap c;
        try {
            c = (Int2IntRBTreeMap)Object.super.clone();
        }
