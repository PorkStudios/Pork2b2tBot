...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ByteLinkedOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2ByteLinkedOpenHashMap clone() {
        ...
        try {
            c = (Double2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Double2ByteSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteLinkedOpenHashMap.this.key[Double2ByteLinkedOpenHashMap.this.n], Double2ByteLinkedOpenHashMap.this.value[Double2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Double2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteLinkedOpenHashMap.this.key[pos], Double2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            ...
            if (Double2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Double2ByteLinkedOpenHashMap.this.key[Double2ByteLinkedOpenHashMap.this.n];
                entry.value = Double2ByteLinkedOpenHashMap.this.value[Double2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Double2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                entry.key = Double2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Double2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Double2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Double2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Double2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Double2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
