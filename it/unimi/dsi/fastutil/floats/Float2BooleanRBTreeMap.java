...
lbl160: // 1 sources:
    ...
    public Float2BooleanRBTreeMap clone() {
        ...
        try {
            c = (Float2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Float2BooleanSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2BooleanRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2BooleanRBTreeMap.this.locateKey(k);
                if (submap.Float2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
