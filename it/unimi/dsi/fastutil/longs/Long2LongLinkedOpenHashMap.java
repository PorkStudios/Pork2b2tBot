...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2LongLinkedOpenHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2LongLinkedOpenHashMap clone() {
        ...
        try {
            c = (Long2LongLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Long2LongSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(k) & Long2LongLinkedOpenHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (k != curr);
            return Long2LongLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Long2LongLinkedOpenHashMap.this.value[pos] != v);
            Long2LongLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
            if (Long2LongLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2LongMap.BasicEntry(Long2LongLinkedOpenHashMap.this.key[Long2LongLinkedOpenHashMap.this.n], Long2LongLinkedOpenHashMap.this.value[Long2LongLinkedOpenHashMap.this.n]));
            }
            int pos = Long2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2LongLinkedOpenHashMap.this.key[pos] == 0L) continue;
                consumer.accept(new AbstractLong2LongMap.BasicEntry(Long2LongLinkedOpenHashMap.this.key[pos], Long2LongLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Long2LongMap.Entry> consumer) {
            ...
            if (Long2LongLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Long2LongLinkedOpenHashMap.this.key[Long2LongLinkedOpenHashMap.this.n];
                entry.value = Long2LongLinkedOpenHashMap.this.value[Long2LongLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Long2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2LongLinkedOpenHashMap.this.key[pos] == 0L) continue;
                entry.key = Long2LongLinkedOpenHashMap.this.key[pos];
                entry.value = Long2LongLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(long from) {
            ...
            int pos = (int)HashCommon.mix(from) & Long2LongLinkedOpenHashMap.this.mask;
            while (Long2LongLinkedOpenHashMap.this.key[pos] != 0L) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Long2LongLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Long2LongLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Long2LongLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Long2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Long2LongLinkedOpenHashMap.this.n) {
                ...
                do {
                    long curr;
                    int last = pos;
                    pos = last + 1 & Long2LongLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0L) {
                            key[last] = 0L;
                            return;
