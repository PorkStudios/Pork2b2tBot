...
Hash {
            ...
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n]);
                    }
                    int pos = Char2ReferenceLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                        consumer.accept(Char2ReferenceLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Char2ReferenceLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Char2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Char2ReferenceLinkedOpenHashMap<V>
    ...
    extends AbstractCharSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.n]);
            }
            int pos = Char2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = Char2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k == '\u0000') continue;
                consumer.accept(k);
            }
        }
    ...
    implements Char2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.n], Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Char2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceLinkedOpenHashMap.this.key[pos], Char2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Char2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        final Char2ReferenceLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Char2ReferenceLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Char2ReferenceLinkedOpenHashMap<V> previous() {
    ...
    extends Char2ReferenceLinkedOpenHashMap<V>
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        private Char2ReferenceLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
