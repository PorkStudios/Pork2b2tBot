...
Cloneable {
    ...
    public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(){
                final Comparator<? super Int2ByteMap.Entry> comparator = (x, y) -> Int2ByteAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2ByteAVLTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2ByteAVLTreeMap clone() {
        ...
        try {
            c = (Int2ByteAVLTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry top = new Entry(s.readInt(), s.readByte());
            top.pred(pred);
            top.succ(succ);
            return top;
        }
    ...
    implements Serializable {
        ...
        public byte get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2ByteAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Int2ByteSortedMap headMap(int to) {
            ...
            return Int2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2ByteSortedMap tailMap(int from) {
            ...
            return Int2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Int2ByteSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2ByteAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2ByteAVLTreeMap.this.locateKey(k);
                if (submap.Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
