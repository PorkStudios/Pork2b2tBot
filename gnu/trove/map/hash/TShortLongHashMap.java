...
Externalizable {
    ...
    implements TLongCollection {
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Long) {
                    ...
                    if (TShortLongHashMap.this.containsValue(ele)) continue;
                    return false;
                }
                return false;
            }
        ...
        public boolean containsAll(TLongCollection collection) {
            ...
            while (iter.hasNext()) {
                if (TShortLongHashMap.this.containsValue(iter.next())) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean containsAll(long[] array) {
            for (long element : array) {
                if (TShortLongHashMap.this.containsValue(element)) continue;
                return false;
            }
            return true;
        }
    ...
    implements TShortSet {
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Short) {
                    ...
                    if (TShortLongHashMap.this.containsKey(ele)) continue;
                    return false;
                }
                return false;
            }
        ...
        public boolean containsAll(TShortCollection collection) {
            ...
            while (iter.hasNext()) {
                if (TShortLongHashMap.this.containsKey(iter.next())) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean containsAll(short[] array) {
            for (short element : array) {
                if (TShortLongHashMap.this.contains(element)) continue;
                return false;
            }
            return true;
        }
        ...
        public boolean equals(Object other) {
            ...
            while (i-- > 0) {
                if (TShortLongHashMap.this._states[i] != 1 || that.contains(TShortLongHashMap.this._set[i])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i = TShortLongHashMap.this._states.length;
            while (i-- > 0) {
                if (TShortLongHashMap.this._states[i] != 1) continue;
