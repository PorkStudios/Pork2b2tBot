...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2ReferenceOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            c = (Int2ReferenceOpenHashMap)Object.super.clone();
        }
    ...
    extends Int2ReferenceOpenHashMap<V>
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            ...
            int pos = Int2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                int k = Int2ReferenceOpenHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceOpenHashMap.this.key[Int2ReferenceOpenHashMap.this.n], Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n]));
            }
            int pos = Int2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceOpenHashMap.this.key[pos], Int2ReferenceOpenHashMap.this.value[pos]));
            }
        }
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        private final Int2ReferenceOpenHashMap<V> entry;
        ...
        @Override
        public Int2ReferenceOpenHashMap<V> next() {
    ...
    extends Int2ReferenceOpenHashMap<V>
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        private Int2ReferenceOpenHashMap<V> entry;
