...
Hash {
            ...
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Double2IntLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2IntLinkedOpenHashMap.this.value[Double2IntLinkedOpenHashMap.this.n]);
                    }
                    int pos = Double2IntLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2IntLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                        consumer.accept(Double2IntLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Double2IntLinkedOpenHashMap clone() {
        ...
        try {
            c = (Double2IntLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2IntLinkedOpenHashMap.this.key[Double2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Double2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = Double2IntLinkedOpenHashMap.this.key[pos];
    ...
    implements Double2IntSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Double2IntMap.Entry> consumer) {
            if (Double2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntLinkedOpenHashMap.this.key[Double2IntLinkedOpenHashMap.this.n], Double2IntLinkedOpenHashMap.this.value[Double2IntLinkedOpenHashMap.this.n]));
            }
            int pos = Double2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2IntLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                consumer.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntLinkedOpenHashMap.this.key[pos], Double2IntLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Double2IntMap.Entry> consumer) {
            ...
            if (Double2IntLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Double2IntLinkedOpenHashMap.this.key[Double2IntLinkedOpenHashMap.this.n];
                entry.value = Double2IntLinkedOpenHashMap.this.value[Double2IntLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Double2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2IntLinkedOpenHashMap.this.key[pos]) == 0L) continue;
                entry.key = Double2IntLinkedOpenHashMap.this.key[pos];
                entry.value = Double2IntLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Double2IntLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Double2IntLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Double2IntLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Double2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
