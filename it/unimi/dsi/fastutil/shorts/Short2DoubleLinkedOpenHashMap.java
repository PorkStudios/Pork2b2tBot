...
Hash {
            ...
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n]);
                    }
                    int pos = Short2DoubleLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Short2DoubleLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Short2DoubleLinkedOpenHashMap clone() {
        ...
        try {
            c = (Short2DoubleLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractShortSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.n]);
            }
            int pos = Short2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = Short2DoubleLinkedOpenHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Short2DoubleSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.n], Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n]));
            }
            int pos = Short2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleLinkedOpenHashMap.this.key[pos], Short2DoubleLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            ...
            if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.n];
                entry.value = Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Short2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Short2DoubleLinkedOpenHashMap.this.key[pos];
                entry.value = Short2DoubleLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Short2DoubleLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Short2DoubleLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
