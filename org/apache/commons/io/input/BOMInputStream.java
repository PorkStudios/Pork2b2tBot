...
extends ProxyInputStream {
    ...
    public /* varargs */ BOMInputStream(InputStream delegate, ByteOrderMark ... boms) {
        this(delegate, false, boms);
    }

    public /* varargs */ BOMInputStream(InputStream delegate, boolean include, ByteOrderMark ... boms) {
        super(delegate);
    ...
    private int readFirstBytes() throws IOException {
        this.getBOM();
        int n = this.fbIndex < this.fbLength ? this.firstBytes[this.fbIndex++] : -1;
        return n;
    }
