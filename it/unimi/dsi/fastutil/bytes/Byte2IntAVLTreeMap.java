...
Cloneable {
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                final Comparator<? super Byte2IntMap.Entry> comparator = (x, y) -> Byte2IntAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
    ...
    public Byte2IntAVLTreeMap clone() {
        ...
        try {
            c = (Byte2IntAVLTreeMap)Object.super.clone();
        }
