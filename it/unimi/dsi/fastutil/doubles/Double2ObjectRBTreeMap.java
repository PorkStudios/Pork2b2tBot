...
lbl161: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2ObjectRBTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2ObjectRBTreeMap<V> clone() {
        Double2ObjectRBTreeMap c;
        try {
            c = (Double2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V remove(double k) {
            ...
            Object oldValue = Double2ObjectRBTreeMap.this.remove(k);
        ...
        public Double2ObjectSortedMap<V> subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Double2ObjectRBTreeMap<V>
        ...
        extends Double2ObjectRBTreeMap<V> {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Double2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
