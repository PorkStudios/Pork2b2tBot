...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>(){
                final Comparator<? super Char2ObjectMap.Entry<V>> comparator = (x, y) -> Char2ObjectRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
                    return e.equals(f);
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Char2ObjectRBTreeMap.this.remove(f.key);
                    return true;
                }
                ...
                public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
                    return Char2ObjectRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
                    return Char2ObjectRBTreeMap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
                    return Char2ObjectRBTreeMap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public boolean contains(Object k) {
                    return Char2ObjectRBTreeMap.this.containsValue(k);
                }
    ...
    public Char2ObjectRBTreeMap<V> clone() {
        ...
        try {
            c = (Char2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(char from, boolean bottom, char to, boolean top) {
            if (!bottom && !top && Char2ObjectRBTreeMap.this.compare(from, to) > 0) {
        ...
        final boolean in(char k) {
            return !(!this.bottom && Char2ObjectRBTreeMap.this.compare(k, this.from) < 0 || !this.top && Char2ObjectRBTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(char k) {
            return this.in(k) && Char2ObjectRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(char k) {
            Entry e;
            char kk = k;
            return (V)(this.in(kk) && (e = Char2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(char k, V v) {
            ...
            V oldValue = Char2ObjectRBTreeMap.this.put(k, v);
            return (V)(Char2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(char k) {
            ...
            Object oldValue = Char2ObjectRBTreeMap.this.remove(k);
            return (V)(Char2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        public Char2ObjectSortedMap<V> headMap(char to) {
            ...
            return Char2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Char2ObjectSortedMap<V> tailMap(char from) {
            ...
            return Char2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Char2ObjectSortedMap<V> subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.bottom) {
                e = Char2ObjectRBTreeMap.this.firstEntry;
            } else {
                e = Char2ObjectRBTreeMap.this.locateKey(this.from);
                if (Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
                    e = e.next();
                }
            }
            if (e == null || !this.top && Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                e = Char2ObjectRBTreeMap.this.lastEntry;
            } else {
                e = Char2ObjectRBTreeMap.this.locateKey(this.to);
                if (Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Char2ObjectRBTreeMap<V>
        ...
        extends Char2ObjectRBTreeMap<V> {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            this.next = Char2ObjectRBTreeMap.this.locateKey(k);
            if (this.next != null) {
                if (Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
