...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2FloatLinkedOpenHashMap.this.key[pos] == 0L) continue;
                        consumer.accept(Long2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Long2FloatLinkedOpenHashMap clone() {
        ...
        try {
            c = (Long2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractLongSortedSet {
        ...
        public void forEach(LongConsumer consumer) {
            ...
            int pos = Long2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                long k = Long2FloatLinkedOpenHashMap.this.key[pos];
                if (k == 0L) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Long2FloatSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = (int)HashCommon.mix(k) & Long2FloatLinkedOpenHashMap.this.mask;
            long curr = key[pos];
            if (curr == 0L) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Long2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (Long2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatLinkedOpenHashMap.this.key[Long2FloatLinkedOpenHashMap.this.n], Long2FloatLinkedOpenHashMap.this.value[Long2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Long2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2FloatLinkedOpenHashMap.this.key[pos] == 0L) continue;
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatLinkedOpenHashMap.this.key[pos], Long2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            ...
            if (Long2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Long2FloatLinkedOpenHashMap.this.key[Long2FloatLinkedOpenHashMap.this.n];
                entry.value = Long2FloatLinkedOpenHashMap.this.value[Long2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Long2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2FloatLinkedOpenHashMap.this.key[pos] == 0L) continue;
                entry.key = Long2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Long2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(long from) {
            ...
            int pos = (int)HashCommon.mix(from) & Long2FloatLinkedOpenHashMap.this.mask;
            while (Long2FloatLinkedOpenHashMap.this.key[pos] != 0L) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Long2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Long2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Long2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Long2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Long2FloatLinkedOpenHashMap.this.n) {
                ...
                do {
                    long curr;
                    int last = pos;
                    pos = last + 1 & Long2FloatLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0L) {
                            key[last] = 0L;
                            return;
