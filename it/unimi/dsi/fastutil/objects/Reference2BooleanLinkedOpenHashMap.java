...
Hash {
            ...
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Reference2BooleanLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Reference2BooleanLinkedOpenHashMap.this.value[Reference2BooleanLinkedOpenHashMap.this.n]);
                    }
                    int pos = Reference2BooleanLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2BooleanLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Reference2BooleanLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Reference2BooleanLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2BooleanLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2BooleanLinkedOpenHashMap<K>
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2BooleanLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Reference2BooleanLinkedOpenHashMap.this.key[Reference2BooleanLinkedOpenHashMap.this.n]);
            }
            int pos = Reference2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2BooleanLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2BooleanSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanLinkedOpenHashMap.this.key[Reference2BooleanLinkedOpenHashMap.this.n], Reference2BooleanLinkedOpenHashMap.this.value[Reference2BooleanLinkedOpenHashMap.this.n]));
            }
            int pos = Reference2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanLinkedOpenHashMap.this.key[pos], Reference2BooleanLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            if (Reference2BooleanLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Reference2BooleanLinkedOpenHashMap.this.key[Reference2BooleanLinkedOpenHashMap.this.n];
                entry.value = Reference2BooleanLinkedOpenHashMap.this.value[Reference2BooleanLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Reference2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Reference2BooleanLinkedOpenHashMap.this.key[pos];
                entry.value = Reference2BooleanLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Reference2BooleanMap.Entry<K>> {
        final Reference2BooleanLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Reference2BooleanLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Reference2BooleanLinkedOpenHashMap<K> previous() {
    ...
    extends Reference2BooleanLinkedOpenHashMap<K>
    implements ObjectListIterator<Reference2BooleanMap.Entry<K>> {
        private Reference2BooleanLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Reference2BooleanLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Reference2BooleanLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Reference2BooleanLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Reference2BooleanLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
