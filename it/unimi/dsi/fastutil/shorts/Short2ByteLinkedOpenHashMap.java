...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Short2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Short2ByteLinkedOpenHashMap clone() {
        ...
        try {
            c = (Short2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Short2ByteSortedMap.FastSortedEntrySet {
        ...
        public Short2ByteMap.Entry first() {
            ...
            return new MapEntry(Short2ByteLinkedOpenHashMap.this.first);
        }
        ...
        public Short2ByteMap.Entry last() {
            ...
            return new MapEntry(Short2ByteLinkedOpenHashMap.this.last);
        }
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Short2ByteLinkedOpenHashMap.this.mask;
            short curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Short2ByteLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Short2ByteLinkedOpenHashMap.this.value[pos] != v);
            Short2ByteLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            if (Short2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2ByteMap.BasicEntry(Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.n], Short2ByteLinkedOpenHashMap.this.value[Short2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Short2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractShort2ByteMap.BasicEntry(Short2ByteLinkedOpenHashMap.this.key[pos], Short2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            ...
            if (Short2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.n];
                entry.value = Short2ByteLinkedOpenHashMap.this.value[Short2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Short2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ByteLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Short2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Short2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        private MapIterator(short from) {
            ...
            int pos = HashCommon.mix(from) & Short2ByteLinkedOpenHashMap.this.mask;
            while (Short2ByteLinkedOpenHashMap.this.key[pos] != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Short2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Short2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Short2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Short2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Short2ByteLinkedOpenHashMap.this.n) {
                ...
                do {
                    short curr;
                    int last = pos;
                    pos = last + 1 & Short2ByteLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0) {
                            key[last] = 0;
                            return;
