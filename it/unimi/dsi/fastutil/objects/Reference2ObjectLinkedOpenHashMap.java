...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null) continue;
    ...
    public Reference2ObjectLinkedOpenHashMap<K, V> clone() {
        ...
        try {
            c = (Reference2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2ObjectLinkedOpenHashMap<K, V>
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2ObjectLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V> {
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || !Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[pos], v));
            Reference2ObjectLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            if (Reference2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.n], Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Reference2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectLinkedOpenHashMap.this.key[pos], Reference2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            ...
            if (Reference2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.n];
                entry.value = Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Reference2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Reference2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Reference2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
        final Reference2ObjectLinkedOpenHashMap<K, V> entry;
        ...
        @Override
        public Reference2ObjectLinkedOpenHashMap<K, V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Reference2ObjectLinkedOpenHashMap<K, V> previous() {
    ...
    extends Reference2ObjectLinkedOpenHashMap<K, V>
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
        private Reference2ObjectLinkedOpenHashMap<K, V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Reference2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Reference2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
