...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>(){
                final Comparator<? super Char2ShortMap.Entry> comparator = (x, y) -> Char2ShortRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Char2ShortRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
                    return e.equals(f);
                }
    ...
    public Char2ShortRBTreeMap clone() {
        ...
        try {
            c = (Char2ShortRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public short get(char k) {
            Entry e;
            char kk = k;
            return this.in(kk) && (e = Char2ShortRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Char2ShortSortedMap headMap(char to) {
            ...
            return Char2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Char2ShortSortedMap tailMap(char from) {
            ...
            return Char2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Char2ShortSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                char c = to = Char2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                char c = from = Char2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Char2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Char2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k) {
                ...
                if (!submap.bottom && submap.Char2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ShortRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ShortRBTreeMap.this.locateKey(k);
                if (submap.Char2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
