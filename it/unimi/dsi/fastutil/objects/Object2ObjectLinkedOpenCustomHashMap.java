...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2ObjectLinkedOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2ObjectLinkedOpenCustomHashMap<K, V> clone() {
        ...
        try {
            c = (Object2ObjectLinkedOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2ObjectLinkedOpenCustomHashMap<K, V>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2ObjectLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2ObjectLinkedOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2ObjectSortedMap.FastSortedEntrySet<K, V> {
        ...
        public boolean contains(Object o) {
            ...
            K[] key = Object2ObjectLinkedOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectLinkedOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, curr));
            return Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(curr, k) || !Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v));
            Object2ObjectLinkedOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
            if (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2ObjectMap.BasicEntry(Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.n], Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n]));
            }
            int pos = Object2ObjectLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ObjectLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2ObjectMap.BasicEntry(Object2ObjectLinkedOpenCustomHashMap.this.key[pos], Object2ObjectLinkedOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
            ...
            if (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.n];
                entry.value = Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2ObjectLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ObjectLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                entry.key = Object2ObjectLinkedOpenCustomHashMap.this.key[pos];
                entry.value = Object2ObjectLinkedOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2ObjectMap.Entry<K, V>> {
        final Object2ObjectLinkedOpenCustomHashMap<K, V> entry;
        ...
        @Override
        public Object2ObjectLinkedOpenCustomHashMap<K, V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2ObjectLinkedOpenCustomHashMap<K, V> previous() {
    ...
    extends Object2ObjectLinkedOpenCustomHashMap<K, V>
    implements ObjectListIterator<Object2ObjectMap.Entry<K, V>> {
        private Object2ObjectLinkedOpenCustomHashMap<K, V> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            int pos = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ObjectLinkedOpenCustomHashMap.this.mask;
            while (Object2ObjectLinkedOpenCustomHashMap.this.key[pos] != null) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2ObjectLinkedOpenCustomHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2ObjectLinkedOpenCustomHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2ObjectLinkedOpenCustomHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2ObjectLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Object2ObjectLinkedOpenCustomHashMap.this.n) {
                ...
                do {
                    Object curr;
                    int last = pos;
                    pos = last + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == null) {
                            key[last] = null;
                        ...
                        int slot = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ObjectLinkedOpenCustomHashMap.this.mask;
                        if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                        pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask;
                    } while (true);
                    key[last] = curr;
    ...
    Map.Entry<K, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Object2ObjectLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(Object2ObjectLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[this.index], e.getValue());
        }
