...
lbl161: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2CharRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from, Object2CharMap.Entry<K> to) {
                    return Object2CharRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) {
                    return Object2CharRBTreeMap.this.headMap(to.getKey()).object2CharEntrySet();
                }
    ...
    public Object2CharRBTreeMap<K> clone() {
        Object2CharRBTreeMap c;
        try {
            c = (Object2CharRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public char put(K k, char v) {
            ...
            char oldValue = Object2CharRBTreeMap.this.put(k, v);
        ...
        public char removeChar(Object k) {
            ...
            char oldValue = Object2CharRBTreeMap.this.removeChar(k);
        ...
        public Object2CharSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2CharRBTreeMap<K>
        ...
        extends Object2CharRBTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2CharRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2CharRBTreeMap.this.locateKey(k);
                if (submap.Object2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
