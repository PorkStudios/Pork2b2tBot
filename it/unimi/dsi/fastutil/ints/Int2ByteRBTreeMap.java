...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(){
                final Comparator<? super Int2ByteMap.Entry> comparator = (x, y) -> Int2ByteRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2ByteRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2ByteRBTreeMap clone() {
        Int2ByteRBTreeMap c;
        try {
            c = (Int2ByteRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Int2ByteSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2ByteRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2ByteRBTreeMap.this.locateKey(k);
                if (submap.Int2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
