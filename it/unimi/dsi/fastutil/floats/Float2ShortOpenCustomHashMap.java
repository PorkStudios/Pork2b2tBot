...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ShortOpenCustomHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ShortOpenCustomHashMap clone() {
        ...
        try {
            c = (Float2ShortOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Float2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
            float curr = key[pos];
            if (Float.floatToIntBits(curr) == 0) {
                return false;
            }
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2ShortOpenCustomHashMap.this.strategy.equals(k, curr));
            return Float2ShortOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2ShortOpenCustomHashMap.this.strategy.equals(curr, k) || Float2ShortOpenCustomHashMap.this.value[pos] != v);
            Float2ShortOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2ShortMap.Entry> consumer) {
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.n], Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Float2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ShortOpenCustomHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenCustomHashMap.this.key[pos], Float2ShortOpenCustomHashMap.this.value[pos]));
            }
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Float2ShortOpenCustomHashMap.this.n;
                return this.last;
            }
            float[] key = Float2ShortOpenCustomHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                float curr;
                int last = pos;
                pos = last + 1 & Float2ShortOpenCustomHashMap.this.mask;
                do {
                    if (Float.floatToIntBits(curr = key[pos]) == 0) {
                        key[last] = 0.0f;
                        return;
    ...
    Map.Entry<Float, Short> {
        ...
        @Override
        public Float getKey() {
            return Float.valueOf(Float2ShortOpenCustomHashMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float2ShortOpenCustomHashMap.this.value[this.index] == (Short)e.getValue();
        }
