...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Reference2ReferenceOpenHashMap.this.key[pos] == null) continue;
    ...
    public Reference2ReferenceOpenHashMap<K, V> clone() {
        ...
        try {
            c = (Reference2ReferenceOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2ReferenceOpenHashMap<K, V>
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2ReferenceOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ReferenceOpenHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (k != curr);
            return Reference2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || Reference2ReferenceOpenHashMap.this.value[pos] != v);
            Reference2ReferenceOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceOpenHashMap.this.key[Reference2ReferenceOpenHashMap.this.n], Reference2ReferenceOpenHashMap.this.value[Reference2ReferenceOpenHashMap.this.n]));
            }
            int pos = Reference2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ReferenceOpenHashMap.this.key[pos] == null) continue;
    ...
    implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
        private final Reference2ReferenceOpenHashMap<K, V> entry;
        ...
        @Override
        public Reference2ReferenceOpenHashMap<K, V> next() {
    ...
    extends Reference2ReferenceOpenHashMap<K, V>
    implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
        private Reference2ReferenceOpenHashMap<K, V> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Reference2ReferenceOpenHashMap.this.n;
                return this.last;
            }
            K[] key = Reference2ReferenceOpenHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(System.identityHashCode(k)) & Reference2ReferenceOpenHashMap.this.mask;
                while (k != key[p]) {
                    p = p + 1 & Reference2ReferenceOpenHashMap.this.mask;
                }
                return p;
