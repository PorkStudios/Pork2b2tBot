...
Hash {
    ...
    public Reference2FloatOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2FloatOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2FloatOpenCustomHashMap<K>
    ...
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        private final Reference2FloatOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2FloatOpenCustomHashMap<K> next() {
    ...
    extends Reference2FloatOpenCustomHashMap<K>
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        private Reference2FloatOpenCustomHashMap<K> entry;
