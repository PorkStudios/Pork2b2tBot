...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ObjectOpenCustomHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ObjectOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Float2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Float2ObjectOpenCustomHashMap<V>
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2ObjectOpenCustomHashMap.this.key[Float2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Float2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) || !Objects.equals(Float2ObjectOpenCustomHashMap.this.value[pos], v));
            Float2ObjectOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectOpenCustomHashMap.this.key[Float2ObjectOpenCustomHashMap.this.n], Float2ObjectOpenCustomHashMap.this.value[Float2ObjectOpenCustomHashMap.this.n]));
            }
            int pos = Float2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ObjectOpenCustomHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectOpenCustomHashMap.this.key[pos], Float2ObjectOpenCustomHashMap.this.value[pos]));
            }
        }
    ...
    implements ObjectIterator<Float2ObjectMap.Entry<V>> {
        private final Float2ObjectOpenCustomHashMap<V> entry;
        ...
        @Override
        public Float2ObjectOpenCustomHashMap<V> next() {
    ...
    extends Float2ObjectOpenCustomHashMap<V>
    implements ObjectIterator<Float2ObjectMap.Entry<V>> {
        private Float2ObjectOpenCustomHashMap<V> entry;
    ...
    Map.Entry<Float, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Objects.equals(Float2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
        }
