...
Hash {
    ...
    public Reference2DoubleOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2DoubleOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2DoubleOpenCustomHashMap<K>
    ...
    implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
        private final Reference2DoubleOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2DoubleOpenCustomHashMap<K> next() {
    ...
    extends Reference2DoubleOpenCustomHashMap<K>
    implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
        private Reference2DoubleOpenCustomHashMap<K> entry;
