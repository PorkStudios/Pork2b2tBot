...
Hash {
    ...
    public Double2ObjectOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Double2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Double2ObjectOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Double2ObjectMap.Entry<V>> {
        private final Double2ObjectOpenCustomHashMap<V> entry;
        ...
        @Override
        public Double2ObjectOpenCustomHashMap<V> next() {
    ...
    extends Double2ObjectOpenCustomHashMap<V>
    implements ObjectIterator<Double2ObjectMap.Entry<V>> {
        private Double2ObjectOpenCustomHashMap<V> entry;
