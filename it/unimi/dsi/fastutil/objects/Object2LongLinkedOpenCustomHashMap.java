...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2LongLinkedOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2LongLinkedOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2LongLinkedOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2LongLinkedOpenCustomHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2LongLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2LongLinkedOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2LongSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Object2LongLinkedOpenCustomHashMap.this.containsNullKey && Object2LongLinkedOpenCustomHashMap.this.value[Object2LongLinkedOpenCustomHashMap.this.n] == v;
            }
            K[] key = Object2LongLinkedOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongLinkedOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2LongLinkedOpenCustomHashMap.this.strategy.equals(k, curr));
            return Object2LongLinkedOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            long v = (Long)e.getValue();
            if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Object2LongLinkedOpenCustomHashMap.this.containsNullKey && Object2LongLinkedOpenCustomHashMap.this.value[Object2LongLinkedOpenCustomHashMap.this.n] == v) {
            ...
            if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2LongLinkedOpenCustomHashMap.this.strategy.equals(curr, k) || Object2LongLinkedOpenCustomHashMap.this.value[pos] != v);
            Object2LongLinkedOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            if (Object2LongLinkedOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2LongMap.BasicEntry(Object2LongLinkedOpenCustomHashMap.this.key[Object2LongLinkedOpenCustomHashMap.this.n], Object2LongLinkedOpenCustomHashMap.this.value[Object2LongLinkedOpenCustomHashMap.this.n]));
            }
            int pos = Object2LongLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2LongMap.BasicEntry(Object2LongLinkedOpenCustomHashMap.this.key[pos], Object2LongLinkedOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            ...
            if (Object2LongLinkedOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2LongLinkedOpenCustomHashMap.this.key[Object2LongLinkedOpenCustomHashMap.this.n];
                entry.value = Object2LongLinkedOpenCustomHashMap.this.value[Object2LongLinkedOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2LongLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                entry.key = Object2LongLinkedOpenCustomHashMap.this.key[pos];
                entry.value = Object2LongLinkedOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>> {
        final Object2LongLinkedOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2LongLinkedOpenCustomHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2LongLinkedOpenCustomHashMap<K> previous() {
    ...
    extends Object2LongLinkedOpenCustomHashMap<K>
    implements ObjectListIterator<Object2LongMap.Entry<K>> {
        private Object2LongLinkedOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            int pos = HashCommon.mix(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2LongLinkedOpenCustomHashMap.this.mask;
            while (Object2LongLinkedOpenCustomHashMap.this.key[pos] != null) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2LongLinkedOpenCustomHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2LongLinkedOpenCustomHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2LongLinkedOpenCustomHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2LongLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Object2LongLinkedOpenCustomHashMap.this.n) {
                ...
                do {
                    Object curr;
                    int last = pos;
                    pos = last + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == null) {
                            key[last] = null;
                            return;
