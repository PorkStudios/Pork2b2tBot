...
Cloneable {
    ...
    public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                final Comparator<? super Short2FloatMap.Entry> comparator = (x, y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2FloatAVLTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2FloatAVLTreeMap clone() {
        ...
        try {
            c = (Short2FloatAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public float get(short k) {
            Entry e;
            short kk = k;
            return this.in(kk) && (e = Short2FloatAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Short2FloatSortedMap headMap(short to) {
            ...
            return Short2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Short2FloatSortedMap tailMap(short from) {
            ...
            return Short2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Short2FloatSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Short2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Short2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2FloatAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2FloatAVLTreeMap.this.locateKey(k);
                if (submap.Short2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
