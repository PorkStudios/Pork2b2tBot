...
Externalizable {
    ...
    extends TDoubleObjectHashMap<V> {
        protected ValueView() {
        }
    ...
    implements TDoubleSet {
        ...
        public boolean equals(Object other) {
            ...
            while (i-- > 0) {
                if (TDoubleObjectHashMap.this._states[i] != 1 || that.contains(TDoubleObjectHashMap.this._set[i])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i = TDoubleObjectHashMap.this._states.length;
            while (i-- > 0) {
                if (TDoubleObjectHashMap.this._states[i] != 1) continue;
