...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>(){
                final Comparator<? super Int2ObjectMap.Entry<V>> comparator = (x, y) -> Int2ObjectRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2ObjectRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2ObjectRBTreeMap<V> clone() {
        Int2ObjectRBTreeMap c;
        try {
            c = (Int2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V put(int k, V v) {
            ...
            V oldValue = Int2ObjectRBTreeMap.this.put(k, v);
        ...
        public V remove(int k) {
            ...
            Object oldValue = Int2ObjectRBTreeMap.this.remove(k);
        ...
        public Int2ObjectSortedMap<V> subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Int2ObjectRBTreeMap<V> {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Int2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
