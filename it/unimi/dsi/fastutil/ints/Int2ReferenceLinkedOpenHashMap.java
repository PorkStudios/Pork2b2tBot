...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2ReferenceLinkedOpenHashMap<V> clone() {
        Int2ReferenceLinkedOpenHashMap c;
        try {
            c = (Int2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Int2ReferenceLinkedOpenHashMap<V>
    ...
    extends AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>
    implements Int2ReferenceSortedMap.FastSortedEntrySet<V> {
        private MapEntrySet() {
        }
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Int2ReferenceLinkedOpenHashMap.this.mask;
            int curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Int2ReferenceLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2ReferenceLinkedOpenHashMap.this.value[pos] != v);
            Int2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.n], Int2ReferenceLinkedOpenHashMap.this.value[Int2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Int2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceLinkedOpenHashMap.this.key[pos], Int2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Int2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Int2ReferenceLinkedOpenHashMap.this.value[Int2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Int2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        final Int2ReferenceLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Int2ReferenceLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Int2ReferenceLinkedOpenHashMap<V> previous() {
    ...
    extends Int2ReferenceLinkedOpenHashMap<V>
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        private Int2ReferenceLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(int from) {
            ...
            if (Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.last] == from) {
                this.prev = Int2ReferenceLinkedOpenHashMap.this.last;
                this.index = Int2ReferenceLinkedOpenHashMap.this.size;
                return;
            }
            int pos = HashCommon.mix(from) & Int2ReferenceLinkedOpenHashMap.this.mask;
            while (Int2ReferenceLinkedOpenHashMap.this.key[pos] != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Int2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Int2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Int2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Int2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Int2ReferenceLinkedOpenHashMap.this.n) {
                ...
                do {
                    int curr;
                    int last = pos;
                    pos = last + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == 0) {
                            key[last] = 0;
    ...
    Map.Entry<Integer, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Int2ReferenceLinkedOpenHashMap.this.value[this.index];
