...
Hash {
    ...
    public Reference2ByteOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2ByteOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2ByteOpenCustomHashMap<K>
    ...
    implements ObjectIterator<Reference2ByteMap.Entry<K>> {
        private final Reference2ByteOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2ByteOpenCustomHashMap<K> next() {
    ...
    extends Reference2ByteOpenCustomHashMap<K>
    implements ObjectIterator<Reference2ByteMap.Entry<K>> {
        private Reference2ByteOpenCustomHashMap<K> entry;
