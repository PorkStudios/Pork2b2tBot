...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2FloatRBTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2FloatRBTreeMap clone() {
        ...
        try {
            c = (Short2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Short2FloatSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2FloatRBTreeMap.this.locateKey(k);
                if (submap.Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
