...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2LongOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2LongOpenHashMap clone() {
        ...
        try {
            c = (Char2LongOpenHashMap)Object.super.clone();
        }
    ...
    implements Char2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2LongOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2LongOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Char2LongOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2LongOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Char2LongOpenHashMap.this.value[pos] != v);
            Char2LongOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.n], Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.n]));
            }
            int pos = Char2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2LongOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongOpenHashMap.this.key[pos], Char2LongOpenHashMap.this.value[pos]));
            }
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Char2LongOpenHashMap.this.n;
                return this.last;
            }
            char[] key = Char2LongOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                char curr;
                int last = pos;
                pos = last + 1 & Char2LongOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == '\u0000') {
                        key[last] = '\u0000';
                        return;
    ...
    Map.Entry<Character, Long> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2LongOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2LongOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
