...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    int pos = Int2ObjectLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Int2ObjectLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Int2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Int2ObjectLinkedOpenHashMap<V>
    ...
    extends AbstractIntSortedSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.n]);
            }
            int pos = Int2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Int2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            if (Int2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.n], Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Int2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectLinkedOpenHashMap.this.key[pos], Int2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            ...
            if (Int2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.n];
                entry.value = Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Int2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ObjectLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Int2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Int2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Int2ObjectMap.Entry<V>> {
        final Int2ObjectLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Int2ObjectLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Int2ObjectLinkedOpenHashMap<V> previous() {
    ...
    extends Int2ObjectLinkedOpenHashMap<V>
    implements ObjectListIterator<Int2ObjectMap.Entry<V>> {
        private Int2ObjectLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Int2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Int2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Int2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Int2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
