...
Hash {
            ...
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n]);
                    }
                    int pos = Short2LongOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2LongOpenCustomHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Short2LongOpenCustomHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Short2LongOpenCustomHashMap clone() {
        ...
        try {
            c = (Short2LongOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n]);
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = Short2LongOpenCustomHashMap.this.key[pos];
                if (k == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Short2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n], Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n]));
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2LongOpenCustomHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenCustomHashMap.this.key[pos], Short2LongOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Short2LongMap.Entry> consumer) {
            ...
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n];
                entry.value = Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2LongOpenCustomHashMap.this.key[pos] == 0) continue;
                entry.key = Short2LongOpenCustomHashMap.this.key[pos];
                entry.value = Short2LongOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    }
