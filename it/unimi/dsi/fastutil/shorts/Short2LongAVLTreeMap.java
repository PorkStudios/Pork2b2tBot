...
Cloneable {
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(){
                final Comparator<? super Short2LongMap.Entry> comparator = (x, y) -> Short2LongAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
    ...
    public Short2LongAVLTreeMap clone() {
        ...
        try {
            c = (Short2LongAVLTreeMap)Object.super.clone();
        }
