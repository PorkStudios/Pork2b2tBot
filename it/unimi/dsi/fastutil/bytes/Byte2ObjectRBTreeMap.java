...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>(){
                final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = (x, y) -> Byte2ObjectRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2ObjectRBTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2ObjectRBTreeMap<V> clone() {
        Byte2ObjectRBTreeMap c;
        try {
            c = (Byte2ObjectRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(byte k) {
            Entry e;
            byte kk = k;
            return (V)(this.in(kk) && (e = Byte2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(byte k, V v) {
            ...
            return (V)(Byte2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(byte k) {
            ...
            Object oldValue = Byte2ObjectRBTreeMap.this.remove(k);
            return (V)(Byte2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        public Byte2ObjectSortedMap<V> headMap(byte to) {
            ...
            return Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2ObjectSortedMap<V> tailMap(byte from) {
            ...
            return Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (e == null || !this.top && Byte2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (e == null || !this.bottom && Byte2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Byte2ObjectRBTreeMap<V>
        ...
        extends Byte2ObjectRBTreeMap<V> {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2ObjectRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2ObjectRBTreeMap.this.locateKey(k);
                if (submap.Byte2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
