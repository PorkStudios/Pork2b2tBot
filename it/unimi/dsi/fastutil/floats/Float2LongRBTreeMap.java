...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(){
                final Comparator<? super Float2LongMap.Entry> comparator = (x, y) -> Float2LongRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
    ...
    public Float2LongRBTreeMap clone() {
        ...
        try {
            c = (Float2LongRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public long get(float k) {
            Entry e;
            float kk = k;
            return this.in(kk) && (e = Float2LongRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Float2LongSortedMap headMap(float to) {
            ...
            return Float2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Float2LongSortedMap tailMap(float from) {
            ...
            return Float2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Float2LongSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Float2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Float2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2LongRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2LongRBTreeMap.this.locateKey(k);
                if (submap.Float2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
