...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>(){
                final Comparator<? super Byte2ByteMap.Entry> comparator = (x, y) -> Byte2ByteRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2ByteRBTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2ByteRBTreeMap clone() {
        ...
        try {
            c = (Byte2ByteRBTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry top = new Entry(s.readByte(), s.readByte());
            top.pred(pred);
            top.succ(succ);
            top.black(true);
            return top;
        ...
        if (n == 2) {
            Entry top = new Entry(s.readByte(), s.readByte());
            top.black(true);
            top.right(new Entry(s.readByte(), s.readByte()));
            top.right.pred(top);
            top.pred(pred);
            top.right.succ(succ);
            return top;
    ...
    implements Serializable {
        ...
        public byte get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2ByteRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Byte2ByteSortedMap headMap(byte to) {
            ...
            return Byte2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Byte2ByteSortedMap tailMap(byte from) {
            ...
            return Byte2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Byte2ByteSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2ByteRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2ByteRBTreeMap.this.locateKey(k);
                if (submap.Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
