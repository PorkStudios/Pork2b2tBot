...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Object2FloatLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Object2FloatLinkedOpenHashMap.this.value[Object2FloatLinkedOpenHashMap.this.n]);
                    }
                    int pos = Object2FloatLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Object2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Object2FloatLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Object2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2FloatLinkedOpenHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2FloatLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2FloatSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2FloatLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (!curr.equals(k) || Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Object2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
            if (Object2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2FloatMap.BasicEntry(Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.n], Object2FloatLinkedOpenHashMap.this.value[Object2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Object2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2FloatMap.BasicEntry(Object2FloatLinkedOpenHashMap.this.key[pos], Object2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
            ...
            if (Object2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.n];
                entry.value = Object2FloatLinkedOpenHashMap.this.value[Object2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Object2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Object2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2FloatMap.Entry<K>> {
        final Object2FloatLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Object2FloatLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2FloatLinkedOpenHashMap<K> previous() {
    ...
    extends Object2FloatLinkedOpenHashMap<K>
    implements ObjectListIterator<Object2FloatMap.Entry<K>> {
        private Object2FloatLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
    ...
    Map.Entry<K, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Objects.equals(Object2FloatLinkedOpenHashMap.this.key[this.index], e.getKey()) && Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
