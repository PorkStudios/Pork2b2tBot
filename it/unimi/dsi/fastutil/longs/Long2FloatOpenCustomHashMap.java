...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]);
                    }
                    int pos = Long2FloatOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2FloatOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2FloatOpenCustomHashMap clone() {
        ...
        try {
            c = (Long2FloatOpenCustomHashMap)Object.super.clone();
        }
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                return Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                if (Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Long2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatOpenCustomHashMap.this.key[Long2FloatOpenCustomHashMap.this.n], Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Long2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2FloatOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    Map.Entry<Long, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], (Long)e.getKey()) && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
