...
Hash {
            ...
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Object2CharLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Object2CharLinkedOpenHashMap.this.value[Object2CharLinkedOpenHashMap.this.n]);
                    }
                    int pos = Object2CharLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Object2CharLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Object2CharLinkedOpenHashMap<K> clone() {
        Object2CharLinkedOpenHashMap c;
        try {
            c = (Object2CharLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2CharLinkedOpenHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2CharLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
        ...
        public boolean remove(Object k) {
            int oldSize = Object2CharLinkedOpenHashMap.this.size;
    ...
    implements Object2CharSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            K[] key = Object2CharLinkedOpenHashMap.this.key;
            int pos = HashCommon.mix(k.hashCode()) & Object2CharLinkedOpenHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (!k.equals(curr));
            return Object2CharLinkedOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (!curr.equals(k) || Object2CharLinkedOpenHashMap.this.value[pos] != v);
            Object2CharLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
            if (Object2CharLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2CharMap.BasicEntry(Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.n], Object2CharLinkedOpenHashMap.this.value[Object2CharLinkedOpenHashMap.this.n]));
            }
            int pos = Object2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2CharMap.BasicEntry(Object2CharLinkedOpenHashMap.this.key[pos], Object2CharLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
            ...
            if (Object2CharLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.n];
                entry.value = Object2CharLinkedOpenHashMap.this.value[Object2CharLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2CharLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Object2CharLinkedOpenHashMap.this.key[pos];
                entry.value = Object2CharLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>> {
        final Object2CharLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Object2CharLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2CharLinkedOpenHashMap<K> previous() {
    ...
    extends Object2CharLinkedOpenHashMap<K>
    implements ObjectListIterator<Object2CharMap.Entry<K>> {
        private Object2CharLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            int pos = HashCommon.mix(from.hashCode()) & Object2CharLinkedOpenHashMap.this.mask;
            while (Object2CharLinkedOpenHashMap.this.key[pos] != null) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2CharLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2CharLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2CharLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2CharLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Object2CharLinkedOpenHashMap.this.n) {
                ...
                do {
                    Object curr;
                    int last = pos;
                    pos = last + 1 & Object2CharLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == null) {
                            key[last] = null;
                            return;
                        }
                        int slot = HashCommon.mix(curr.hashCode()) & Object2CharLinkedOpenHashMap.this.mask;
                        if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                        pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask;
                    } while (true);
                    key[last] = curr;
    ...
    Map.Entry<K, Character> {
        ...
        public char setValue(char v) {
            char oldValue = Object2CharLinkedOpenHashMap.this.value[this.index];
        ...
        public Character getValue() {
            return Character.valueOf(Object2CharLinkedOpenHashMap.this.value[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Objects.equals(Object2CharLinkedOpenHashMap.this.key[this.index], e.getKey()) && Object2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
