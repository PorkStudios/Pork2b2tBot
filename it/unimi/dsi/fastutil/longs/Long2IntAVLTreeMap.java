...
Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Long2IntAVLTreeMap.this.findKey((Long)e.getKey());
                    return e.equals(f);
                }
    ...
    public Long2IntAVLTreeMap clone() {
        ...
        try {
            c = (Long2IntAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Long2IntSortedMap subMap(long from, long to) {
            ...
            if (!this.top) {
                long l = to = Long2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                long l = from = Long2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2IntAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2IntAVLTreeMap.this.locateKey(k);
                if (submap.Long2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
