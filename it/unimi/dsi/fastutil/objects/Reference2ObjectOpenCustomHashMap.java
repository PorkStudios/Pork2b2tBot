...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Reference2ObjectOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Reference2ObjectOpenCustomHashMap<K, V> clone() {
        ...
        try {
            c = (Reference2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2ObjectOpenCustomHashMap<K, V>
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2ObjectOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ObjectOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask]) != null) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) || !Objects.equals(Reference2ObjectOpenCustomHashMap.this.value[pos], v));
            Reference2ObjectOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
        private final Reference2ObjectOpenCustomHashMap<K, V> entry;
        ...
        @Override
        public Reference2ObjectOpenCustomHashMap<K, V> next() {
    ...
    extends Reference2ObjectOpenCustomHashMap<K, V>
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
        private Reference2ObjectOpenCustomHashMap<K, V> entry;
    ...
    private class MapIterator {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                Object curr;
                int last = pos;
                pos = last + 1 & Reference2ObjectOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == null) {
                        key[last] = null;
