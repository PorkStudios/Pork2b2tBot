...
extends BaseHash {
    ...
    public static final long[] G(long hh0, long hh1, long hh2, long hh3, long hh4, long hh5, long hh6, long hh7, byte[] in, int offset) {
        return Sha512.sha(hh0, hh1, hh2, hh3, hh4, hh5, hh6, hh7, in, offset);
    }
    ...
    protected void transform(byte[] in, int offset) {
        long[] result = Sha512.sha(this.h0, this.h1, this.h2, this.h3, this.h4, this.h5, this.h6, this.h7, in, offset);
        this.h0 = result[0];
        this.h1 = result[1];
        this.h2 = result[2];
        this.h3 = result[3];
    ...
    private static final synchronized long[] sha(long hh0, long hh1, long hh2, long hh3, long hh4, long hh5, long hh6, long hh7, byte[] in, int offset) {
        ...
        int r = 0;
        while (r < 16) {
            Sha512.w[r] = (long)in[offset++] << 56 | ((long)in[offset++] & 255L) << 48 | ((long)in[offset++] & 255L) << 40 | ((long)in[offset++] & 255L) << 32 | ((long)in[offset++] & 255L) << 24 | ((long)in[offset++] & 255L) << 16 | ((long)in[offset++] & 255L) << 8 | (long)in[offset++] & 255L;
            ++r;
        }
        r = 16;
        while (r < 80) {
            T = w[r - 2];
            T2 = w[r - 15];
            Sha512.w[r] = ((T >>> 19 | T << 45) ^ (T >>> 61 | T << 3) ^ T >>> 6) + w[r - 7] + ((T2 >>> 1 | T2 << 63) ^ (T2 >>> 8 | T2 << 56) ^ T2 >>> 7) + w[r - 16];
            ++r;
        }
        r = 0;
        while (r < 80) {
