...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Byte2ShortLinkedOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Byte2ShortLinkedOpenHashMap clone() {
        ...
        try {
            c = (Byte2ShortLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Byte2ShortSortedMap.FastSortedEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Byte2ShortLinkedOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ShortLinkedOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Byte2ShortLinkedOpenHashMap.this.value[pos] != v);
            Byte2ShortLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
            if (Byte2ShortLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ShortMap.BasicEntry(Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.n], Byte2ShortLinkedOpenHashMap.this.value[Byte2ShortLinkedOpenHashMap.this.n]));
            }
            int pos = Byte2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ShortLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractByte2ShortMap.BasicEntry(Byte2ShortLinkedOpenHashMap.this.key[pos], Byte2ShortLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
            ...
            if (Byte2ShortLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.n];
                entry.value = Byte2ShortLinkedOpenHashMap.this.value[Byte2ShortLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Byte2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ShortLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Byte2ShortLinkedOpenHashMap.this.key[pos];
                entry.value = Byte2ShortLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Byte2ShortLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Byte2ShortLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Byte2ShortLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Byte2ShortLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
