...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    public Double2ShortOpenHashMap clone() {
        ...
        try {
            c = (Double2ShortOpenHashMap)Object.super.clone();
        }
    ...
    implements Double2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ShortOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(k) != Double.doubleToLongBits(curr));
            return Double2ShortOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ShortOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || Double2ShortOpenHashMap.this.value[pos] != v);
            Double2ShortOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Double2ShortMap.Entry> consumer) {
            if (Double2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ShortMap.BasicEntry(Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.n], Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n]));
            }
            int pos = Double2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) == 0L) continue;
                consumer.accept(new AbstractDouble2ShortMap.BasicEntry(Double2ShortOpenHashMap.this.key[pos], Double2ShortOpenHashMap.this.value[pos]));
            }
        }
    ...
    Map.Entry<Double, Short> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && Double2ShortOpenHashMap.this.value[this.index] == (Short)e.getValue();
        }
