...
Hash {
    ...
    public Char2ObjectOpenCustomHashMap<V> clone() {
        ...
        try {
            c = (Char2ObjectOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Char2ObjectOpenCustomHashMap<V>
    ...
    implements ObjectIterator<Char2ObjectMap.Entry<V>> {
        private final Char2ObjectOpenCustomHashMap<V> entry;
        ...
        @Override
        public Char2ObjectOpenCustomHashMap<V> next() {
    ...
    extends Char2ObjectOpenCustomHashMap<V>
    implements ObjectIterator<Char2ObjectMap.Entry<V>> {
        private Char2ObjectOpenCustomHashMap<V> entry;
