...
extends CipherAdapter {
    ...
    protected void engineInit(int opmode, Key key, SecureRandom random) throws InvalidKeyException {
        ...
        super.engineInit(opmode, this.genkey((PBEKey)key), random);
    }
    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        super.engineInit(opmode, (Key)this.genkey((PBEKey)key), params, random);
    }
    ...
    private final SecretKeySpec genkey(PBEKey key) throws InvalidKeyException {
        ...
        attrib.put("gnu.crypto.pbe.iteration.count", new Integer(key.getIterationCount()));
        attrib.put("gnu.crypto.pbe.password", (Integer)key.getPassword());
        attrib.put("gnu.crypto.pbe.salt", (Integer)key.getSalt());
        try {
            kdf.init(attrib);
        }
        ...
        byte[] dk = new byte[this.mode.defaultKeySize()];
        try {
        ...
        return new SecretKeySpec(dk, this.cipher.name());
    }
