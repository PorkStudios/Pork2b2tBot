...
Hash {
            ...
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Object2ShortLinkedOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Object2ShortLinkedOpenCustomHashMap.this.value[Object2ShortLinkedOpenCustomHashMap.this.n]);
                    }
                    int pos = Object2ShortLinkedOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ShortLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                        consumer.accept(Object2ShortLinkedOpenCustomHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Object2ShortLinkedOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2ShortLinkedOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2ShortLinkedOpenCustomHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2ShortLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2ShortLinkedOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2ShortSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            if (Object2ShortLinkedOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2ShortMap.BasicEntry(Object2ShortLinkedOpenCustomHashMap.this.key[Object2ShortLinkedOpenCustomHashMap.this.n], Object2ShortLinkedOpenCustomHashMap.this.value[Object2ShortLinkedOpenCustomHashMap.this.n]));
            }
            int pos = Object2ShortLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ShortLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2ShortMap.BasicEntry(Object2ShortLinkedOpenCustomHashMap.this.key[pos], Object2ShortLinkedOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            ...
            if (Object2ShortLinkedOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2ShortLinkedOpenCustomHashMap.this.key[Object2ShortLinkedOpenCustomHashMap.this.n];
                entry.value = Object2ShortLinkedOpenCustomHashMap.this.value[Object2ShortLinkedOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2ShortLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ShortLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                entry.key = Object2ShortLinkedOpenCustomHashMap.this.key[pos];
                entry.value = Object2ShortLinkedOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>> {
        final Object2ShortLinkedOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2ShortLinkedOpenCustomHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2ShortLinkedOpenCustomHashMap<K> previous() {
    ...
    extends Object2ShortLinkedOpenCustomHashMap<K>
    implements ObjectListIterator<Object2ShortMap.Entry<K>> {
        private Object2ShortLinkedOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2ShortLinkedOpenCustomHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2ShortLinkedOpenCustomHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2ShortLinkedOpenCustomHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2ShortLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
