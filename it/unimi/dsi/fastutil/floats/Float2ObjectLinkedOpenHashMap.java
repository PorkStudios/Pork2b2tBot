...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2ObjectLinkedOpenHashMap<V> clone() {
        ...
        try {
            c = (Float2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Float2ObjectLinkedOpenHashMap<V>
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.n]);
            }
            int pos = Float2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Float2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            if (Float2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.n], Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Float2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectLinkedOpenHashMap.this.key[pos], Float2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            ...
            if (Float2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.n];
                entry.value = Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Float2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
        final Float2ObjectLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Float2ObjectLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Float2ObjectLinkedOpenHashMap<V> previous() {
    ...
    extends Float2ObjectLinkedOpenHashMap<V>
    implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
        private Float2ObjectLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
