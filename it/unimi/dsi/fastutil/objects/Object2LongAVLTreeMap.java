...
Cloneable {
    ...
    public Object2LongAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2LongAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2LongSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2LongAVLTreeMap<K>
