...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2IntLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2IntLinkedOpenHashMap clone() {
        ...
        try {
            c = (Char2IntLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Char2IntSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
            if (Char2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2IntMap.BasicEntry(Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.n], Char2IntLinkedOpenHashMap.this.value[Char2IntLinkedOpenHashMap.this.n]));
            }
            int pos = Char2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2IntLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2IntMap.BasicEntry(Char2IntLinkedOpenHashMap.this.key[pos], Char2IntLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
            ...
            if (Char2IntLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.n];
                entry.value = Char2IntLinkedOpenHashMap.this.value[Char2IntLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2IntLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2IntLinkedOpenHashMap.this.key[pos];
                entry.value = Char2IntLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2IntLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2IntLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2IntLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
