...
Hash {
    ...
    public Object2DoubleLinkedOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2DoubleLinkedOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2DoubleLinkedOpenCustomHashMap<K>
    ...
    implements Object2DoubleSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            if (Object2DoubleLinkedOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleLinkedOpenCustomHashMap.this.key[Object2DoubleLinkedOpenCustomHashMap.this.n], Object2DoubleLinkedOpenCustomHashMap.this.value[Object2DoubleLinkedOpenCustomHashMap.this.n]));
            }
            int pos = Object2DoubleLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2DoubleLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleLinkedOpenCustomHashMap.this.key[pos], Object2DoubleLinkedOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            ...
            if (Object2DoubleLinkedOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2DoubleLinkedOpenCustomHashMap.this.key[Object2DoubleLinkedOpenCustomHashMap.this.n];
                entry.value = Object2DoubleLinkedOpenCustomHashMap.this.value[Object2DoubleLinkedOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2DoubleLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2DoubleLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                entry.key = Object2DoubleLinkedOpenCustomHashMap.this.key[pos];
                entry.value = Object2DoubleLinkedOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        final Object2DoubleLinkedOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2DoubleLinkedOpenCustomHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2DoubleLinkedOpenCustomHashMap<K> previous() {
    ...
    extends Object2DoubleLinkedOpenCustomHashMap<K>
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        private Object2DoubleLinkedOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2DoubleLinkedOpenCustomHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2DoubleLinkedOpenCustomHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2DoubleLinkedOpenCustomHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2DoubleLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
