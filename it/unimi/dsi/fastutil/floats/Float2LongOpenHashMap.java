...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2LongOpenHashMap.this.key[pos]) == 0) continue;
    ...
    public Float2LongOpenHashMap clone() {
        ...
        try {
            c = (Float2LongOpenHashMap)Object.super.clone();
        }
    ...
    implements Float2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(HashCommon.float2int(k)) & Float2LongOpenHashMap.this.mask;
            float curr = key[pos];
            if (Float.floatToIntBits(curr) == 0) {
                return false;
            }
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2LongOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(k) != Float.floatToIntBits(curr));
            return Float2LongOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2LongOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || Float2LongOpenHashMap.this.value[pos] != v);
            Float2LongOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
            if (Float2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2LongMap.BasicEntry(Float2LongOpenHashMap.this.key[Float2LongOpenHashMap.this.n], Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n]));
            }
            int pos = Float2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2LongOpenHashMap.this.key[pos]) == 0) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Float2LongOpenHashMap.this.n;
                return this.last;
            }
            float[] key = Float2LongOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                float curr;
                int last = pos;
                pos = last + 1 & Float2LongOpenHashMap.this.mask;
                do {
                    if (Float.floatToIntBits(curr = key[pos]) == 0) {
                        key[last] = 0.0f;
                        return;
    ...
    Map.Entry<Float, Long> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2LongOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2LongOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
