...
public class CryptUtil {
    ...
    public static SecretKey decryptSharedKey(PrivateKey publicKey, byte[] sharedKey) {
        return new SecretKeySpec(CryptUtil.decryptData(publicKey, sharedKey), "AES");
    }
    ...
    public static byte[] runEncryption(int mode, Key key, byte[] data) {
        try {
    ...
    public static /* varargs */ byte[] encrypt(String encryption, byte[] ... data) {
        try {
