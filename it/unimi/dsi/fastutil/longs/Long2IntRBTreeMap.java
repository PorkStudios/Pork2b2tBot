...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(){
                final Comparator<? super Long2IntMap.Entry> comparator = (x, y) -> Long2IntRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
    ...
    public Long2IntRBTreeMap clone() {
        Long2IntRBTreeMap c;
        try {
            c = (Long2IntRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public int get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2IntRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(long k) {
                ...
                if (!submap.bottom && submap.Long2IntRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Long2IntRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Long2IntRBTreeMap.this.locateKey(k);
                if (submap.Long2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractLong2IntSortedMap.KeySet {
            private KeySet() {
            }
