...
Cloneable {
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(){
                final Comparator<? super Float2BooleanMap.Entry> comparator = (x, y) -> Float2BooleanAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Float2BooleanAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    return e.equals(f);
                }
    ...
    public Float2BooleanAVLTreeMap clone() {
        ...
        try {
            c = (Float2BooleanAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Float2BooleanSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2BooleanAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2BooleanAVLTreeMap.this.locateKey(k);
                if (submap.Float2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractFloat2BooleanSortedMap.KeySet {
            private KeySet() {
            }
