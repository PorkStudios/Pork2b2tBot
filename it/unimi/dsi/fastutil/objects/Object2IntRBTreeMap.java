...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(){
                final Comparator<? super Object2IntMap.Entry<K>> comparator = (x, y) -> Object2IntRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2IntRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> from, Object2IntMap.Entry<K> to) {
                    return Object2IntRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> to) {
                    return Object2IntRBTreeMap.this.headMap(to.getKey()).object2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> from) {
                    return Object2IntRBTreeMap.this.tailMap(from.getKey()).object2IntEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2IntRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2IntRBTreeMap)Object.super.clone();
        }
    ...
    private Entry<K> readTree(ObjectInputStream s, int n, Entry<K> pred, Entry<K> succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> top = new Entry<Object>(s.readObject(), s.readInt());
            top.pred(pred);
            top.succ(succ);
            top.black(true);
            return top;
        ...
        if (n == 2) {
            Entry<Object> top = new Entry<Object>(s.readObject(), s.readInt());
            top.black(true);
            top.right(new Entry<Object>(s.readObject(), s.readInt()));
            top.right.pred(top);
            top.pred(pred);
            top.right.succ(succ);
            return top;
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(){
                    ...
                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> from, Object2IntMap.Entry<K> to) {
                        return Submap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> to) {
                        return Submap.this.headMap(to.getKey()).object2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> from) {
                        return Submap.this.tailMap(from.getKey()).object2IntEntrySet();
                    }
                };
            }
            return this.entries;
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2IntRBTreeMap.this.containsKey(k);
        }
        ...
        public int getInt(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2IntRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public int put(K k, int v) {
            ...
            int oldValue = Object2IntRBTreeMap.this.put(k, v);
        ...
        public Object2IntSortedMap<K> headMap(K to) {
            ...
            return Object2IntRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2IntSortedMap<K> tailMap(K from) {
            ...
            return Object2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2IntSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2IntRBTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2IntRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2IntRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2IntRBTreeMap.this.locateKey(k);
                if (submap.Object2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
