...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null) continue;
    ...
    public Object2ReferenceLinkedOpenHashMap<K, V> clone() {
        ...
        try {
            c = (Object2ReferenceLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Object2ReferenceLinkedOpenHashMap<K, V>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            if (Object2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2ReferenceMap.BasicEntry(Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.n], Object2ReferenceLinkedOpenHashMap.this.value[Object2ReferenceLinkedOpenHashMap.this.n]));
            }
            int pos = Object2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2ReferenceMap.BasicEntry(Object2ReferenceLinkedOpenHashMap.this.key[pos], Object2ReferenceLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            ...
            if (Object2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.n];
                entry.value = Object2ReferenceLinkedOpenHashMap.this.value[Object2ReferenceLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Object2ReferenceLinkedOpenHashMap.this.key[pos];
                entry.value = Object2ReferenceLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        final Object2ReferenceLinkedOpenHashMap<K, V> entry;
        ...
        @Override
        public Object2ReferenceLinkedOpenHashMap<K, V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2ReferenceLinkedOpenHashMap<K, V> previous() {
    ...
    extends Object2ReferenceLinkedOpenHashMap<K, V>
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        private Object2ReferenceLinkedOpenHashMap<K, V> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            if (Objects.equals(Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last], from)) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2ReferenceLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2ReferenceLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
