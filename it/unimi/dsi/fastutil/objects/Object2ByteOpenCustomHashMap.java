...
Hash {
            ...
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]);
                    }
                    int pos = Object2ByteOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ByteOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2ByteOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2ByteOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2ByteOpenCustomHashMap<K>
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2ByteOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2ByteMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2ByteOpenCustomHashMap.this.strategy.equals(k, curr));
            return Object2ByteOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2ByteOpenCustomHashMap.this.strategy.equals(curr, k) || Object2ByteOpenCustomHashMap.this.value[pos] != v);
            Object2ByteOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n], Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]));
            }
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ByteOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            ...
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n];
                entry.value = Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n];
    ...
    implements ObjectIterator<Object2ByteMap.Entry<K>> {
        private final Object2ByteOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2ByteOpenCustomHashMap<K> next() {
    ...
    extends Object2ByteOpenCustomHashMap<K>
    implements ObjectIterator<Object2ByteMap.Entry<K>> {
        private Object2ByteOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Object2ByteOpenCustomHashMap.this.n;
                return this.last;
            }
            K[] key = Object2ByteOpenCustomHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask;
                while (!Object2ByteOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                    p = p + 1 & Object2ByteOpenCustomHashMap.this.mask;
                }
                return p;
