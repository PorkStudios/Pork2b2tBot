...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(){
                final Comparator<? super Object2BooleanMap.Entry<K>> comparator = (x, y) -> Object2BooleanRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
    ...
    public Object2BooleanRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2BooleanRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2BooleanSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Object2BooleanRBTreeMap<K>
