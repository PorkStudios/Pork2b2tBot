...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2FloatRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2FloatRBTreeMap clone() {
        ...
        try {
            c = (Int2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Int2FloatSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2FloatRBTreeMap.this.locateKey(k);
                if (submap.Int2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
