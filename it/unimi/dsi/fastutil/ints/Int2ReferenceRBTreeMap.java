...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(){
                final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = (x, y) -> Int2ReferenceRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2ReferenceRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2ReferenceRBTreeMap<V> clone() {
        Int2ReferenceRBTreeMap c;
        try {
            c = (Int2ReferenceRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(int k) {
            Entry e;
            int kk = k;
            return (V)(this.in(kk) && (e = Int2ReferenceRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue);
        }
        ...
        public V put(int k, V v) {
            ...
            return (V)(Int2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue);
        }
        ...
        public V remove(int k) {
            ...
            Object oldValue = Int2ReferenceRBTreeMap.this.remove(k);
            return (V)(Int2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue);
        }
        ...
        public Int2ReferenceSortedMap<V> headMap(int to) {
            ...
            return Int2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2ReferenceSortedMap<V> tailMap(int from) {
            ...
            return Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Int2ReferenceSortedMap<V> subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (e == null || !this.top && Int2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (e == null || !this.bottom && Int2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Int2ReferenceRBTreeMap<V>
        ...
        extends Int2ReferenceRBTreeMap<V> {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2ReferenceRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2ReferenceRBTreeMap.this.locateKey(k);
                if (submap.Int2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
