...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2DoubleLinkedOpenHashMap.this.key[pos] == 0L) continue;
    ...
    public Long2DoubleLinkedOpenHashMap clone() {
        ...
        try {
            c = (Long2DoubleLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Long2DoubleSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
            if (Long2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2DoubleMap.BasicEntry(Long2DoubleLinkedOpenHashMap.this.key[Long2DoubleLinkedOpenHashMap.this.n], Long2DoubleLinkedOpenHashMap.this.value[Long2DoubleLinkedOpenHashMap.this.n]));
            }
            int pos = Long2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2DoubleLinkedOpenHashMap.this.key[pos] == 0L) continue;
                consumer.accept(new AbstractLong2DoubleMap.BasicEntry(Long2DoubleLinkedOpenHashMap.this.key[pos], Long2DoubleLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
            ...
            if (Long2DoubleLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Long2DoubleLinkedOpenHashMap.this.key[Long2DoubleLinkedOpenHashMap.this.n];
                entry.value = Long2DoubleLinkedOpenHashMap.this.value[Long2DoubleLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Long2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2DoubleLinkedOpenHashMap.this.key[pos] == 0L) continue;
                entry.key = Long2DoubleLinkedOpenHashMap.this.key[pos];
                entry.value = Long2DoubleLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Long2DoubleLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Long2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Long2DoubleLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Long2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
