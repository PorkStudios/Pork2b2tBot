...
Hash {
            ...
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    if (Float2ByteLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Float2ByteLinkedOpenHashMap.this.value[Float2ByteLinkedOpenHashMap.this.n]);
                    }
                    int pos = Float2ByteLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ByteLinkedOpenHashMap.this.key[pos]) == 0) continue;
                        consumer.accept(Float2ByteLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Float2ByteLinkedOpenHashMap clone() {
        ...
        try {
            c = (Float2ByteLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Float2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.n]);
            }
            int pos = Float2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = Float2ByteLinkedOpenHashMap.this.key[pos];
    ...
    implements Float2ByteSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            if (Float2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ByteMap.BasicEntry(Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.n], Float2ByteLinkedOpenHashMap.this.value[Float2ByteLinkedOpenHashMap.this.n]));
            }
            int pos = Float2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ByteLinkedOpenHashMap.this.key[pos]) == 0) continue;
                consumer.accept(new AbstractFloat2ByteMap.BasicEntry(Float2ByteLinkedOpenHashMap.this.key[pos], Float2ByteLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            ...
            if (Float2ByteLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.n];
                entry.value = Float2ByteLinkedOpenHashMap.this.value[Float2ByteLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Float2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ByteLinkedOpenHashMap.this.key[pos]) == 0) continue;
                entry.key = Float2ByteLinkedOpenHashMap.this.key[pos];
                entry.value = Float2ByteLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Float2ByteLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Float2ByteLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Float2ByteLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Float2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
