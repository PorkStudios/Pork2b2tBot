...
public final class Reference2BooleanSortedMaps {
    ...
    Serializable {
        ...
        public Reference2BooleanSortedMap<K> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Reference2BooleanSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Reference2BooleanSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Reference2BooleanSortedMap<K> subMap(K from, K to) {
            return new SynchronizedSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Reference2BooleanSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Reference2BooleanSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap<K>((Reference2BooleanSortedMap<K>)this.sortedMap.tailMap((Object)from), this.sync);
        }
