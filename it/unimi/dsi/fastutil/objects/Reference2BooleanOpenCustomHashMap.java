...
Hash {
            ...
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n]);
                    }
                    int pos = Reference2BooleanOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2BooleanOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Reference2BooleanOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2BooleanOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Reference2BooleanOpenCustomHashMap<K>
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Reference2BooleanOpenCustomHashMap.this.key[Reference2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2BooleanOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Reference2BooleanOpenCustomHashMap.this.containsNullKey && Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n] == v;
            }
            K[] key = Reference2BooleanOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Reference2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2BooleanOpenCustomHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            if (Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Reference2BooleanOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                if ((curr = key[pos = pos + 1 & Reference2BooleanOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, curr));
            return Reference2BooleanOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            boolean v = (Boolean)e.getValue();
            if (Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Reference2BooleanOpenCustomHashMap.this.containsNullKey && Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n] == v) {
            ...
            if (Reference2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Reference2BooleanOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2BooleanOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2BooleanOpenCustomHashMap.this.strategy.equals(curr, k) || Reference2BooleanOpenCustomHashMap.this.value[pos] != v);
            Reference2BooleanOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanOpenCustomHashMap.this.key[Reference2BooleanOpenCustomHashMap.this.n], Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n]));
            }
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.key = Reference2BooleanOpenCustomHashMap.this.key[Reference2BooleanOpenCustomHashMap.this.n];
                entry.value = Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n];
    ...
    implements ObjectIterator<Reference2BooleanMap.Entry<K>> {
        private final Reference2BooleanOpenCustomHashMap<K> entry;
        ...
        @Override
        public Reference2BooleanOpenCustomHashMap<K> next() {
    ...
    extends Reference2BooleanOpenCustomHashMap<K>
    implements ObjectIterator<Reference2BooleanMap.Entry<K>> {
        private Reference2BooleanOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Reference2BooleanOpenCustomHashMap.this.n;
                return this.last;
            }
            K[] key = Reference2BooleanOpenCustomHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(Reference2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2BooleanOpenCustomHashMap.this.mask;
                while (!Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                    p = p + 1 & Reference2BooleanOpenCustomHashMap.this.mask;
                }
                return p;
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                Object curr;
                int last = pos;
                pos = last + 1 & Reference2BooleanOpenCustomHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == null) {
                        key[last] = null;
                        return;
                    ...
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                    pos = pos + 1 & Reference2BooleanOpenCustomHashMap.this.mask;
                } while (true);
                if (pos < last) {
    ...
    Map.Entry<K, Boolean> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2BooleanOpenCustomHashMap.this.strategy.equals(Reference2BooleanOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
