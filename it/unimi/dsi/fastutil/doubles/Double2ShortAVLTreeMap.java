...
Cloneable {
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(){
                final Comparator<? super Double2ShortMap.Entry> comparator = (x, y) -> Double2ShortAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Double2ShortAVLTreeMap.this.findKey((Double)e.getKey());
                    return e.equals(f);
                }
    ...
    public Double2ShortAVLTreeMap clone() {
        ...
        try {
            c = (Double2ShortAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        final boolean in(double k) {
            return !(!this.bottom && Double2ShortAVLTreeMap.this.compare(k, this.from) < 0 || !this.top && Double2ShortAVLTreeMap.this.compare(k, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(double k) {
            return this.in(k) && Double2ShortAVLTreeMap.this.containsKey(k);
        }
        ...
        public short get(double k) {
            Entry e;
            double kk = k;
            return this.in(kk) && (e = Double2ShortAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public short put(double k, short v) {
            ...
            short oldValue = Double2ShortAVLTreeMap.this.put(k, v);
        ...
        public short remove(double k) {
            ...
            short oldValue = Double2ShortAVLTreeMap.this.remove(k);
        ...
        public Double2ShortSortedMap headMap(double to) {
            ...
            return Double2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Double2ShortSortedMap tailMap(double from) {
            ...
            return Double2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Double2ShortSortedMap subMap(double from, double to) {
            ...
            if (!this.top) {
                double d = to = Double2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                double d = from = Double2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Double2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Double2ShortAVLTreeMap.this.locateKey(this.to);
                if (Double2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null || !this.bottom && Double2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(double k) {
                ...
                if (!submap.bottom && submap.Double2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Double2ShortAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Double2ShortAVLTreeMap.this.locateKey(k);
                if (submap.Double2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
