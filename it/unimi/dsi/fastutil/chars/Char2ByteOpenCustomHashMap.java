...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2ByteOpenCustomHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2ByteOpenCustomHashMap clone() {
        ...
        try {
            c = (Char2ByteOpenCustomHashMap)Object.super.clone();
        }
    ...
    implements Char2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ByteOpenCustomHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                ...
                return false;
            } while (!Char2ByteOpenCustomHashMap.this.strategy.equals(k, curr));
            return Char2ByteOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ByteOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2ByteOpenCustomHashMap.this.strategy.equals(curr, k) || Char2ByteOpenCustomHashMap.this.value[pos] != v);
            Char2ByteOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.n], Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n]));
            }
            int pos = Char2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ByteOpenCustomHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenCustomHashMap.this.key[pos], Char2ByteOpenCustomHashMap.this.value[pos]));
            }
        }
    ...
    Map.Entry<Character, Byte> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Char2ByteOpenCustomHashMap.this.value[this.index] == (Byte)e.getValue();
        }
