...
Hash {
    ...
    public Long2ObjectOpenHashMap<V> clone() {
        ...
        try {
            c = (Long2ObjectOpenHashMap)Object.super.clone();
        }
    ...
    implements ObjectIterator<Long2ObjectMap.Entry<V>> {
        private final Long2ObjectOpenHashMap<V> entry;
        ...
        @Override
        public Long2ObjectOpenHashMap<V> next() {
    ...
    extends Long2ObjectOpenHashMap<V>
    implements ObjectIterator<Long2ObjectMap.Entry<V>> {
        private Long2ObjectOpenHashMap<V> entry;
