...
Hash {
    ...
    public FloatLinkedOpenCustomHashSet clone() {
        ...
        try {
            c = (FloatLinkedOpenCustomHashSet)Object.super.clone();
        }
    ...
    implements FloatListIterator {
        ...
        SetIterator(float from) {
            ...
            int pos = HashCommon.mix(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & FloatLinkedOpenCustomHashSet.this.mask;
            while (Float.floatToIntBits(key[pos]) != 0) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = FloatLinkedOpenCustomHashSet.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (FloatLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = FloatLinkedOpenCustomHashSet.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (FloatLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != FloatLinkedOpenCustomHashSet.this.n) {
                ...
                do {
                    float curr;
                    int last = pos;
                    pos = last + 1 & FloatLinkedOpenCustomHashSet.this.mask;
                    do {
                        if (Float.floatToIntBits(curr = key[pos]) == 0) {
                            key[last] = 0.0f;
                            return;
