        ...
        block16 : do {
            switch (this.state) {
                ...
                case READ_COMMON_HEADER: {
                    ...
                    buffer.skipBytes(8);
                    boolean bl = control = (buffer.getByte(frameOffset) & 128) != 0;
                    if (control) {
                ...
                case READ_DATA_FRAME: {
                    ...
                    last = this.length == 0 && SpdyFrameDecoder.hasFlag(this.flags, (byte)1);
                ...
                case READ_SYN_STREAM_FRAME: {
                    ...
                    last = SpdyFrameDecoder.hasFlag(this.flags, (byte)1);
