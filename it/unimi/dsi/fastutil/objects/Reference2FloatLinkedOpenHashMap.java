...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Reference2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                        consumer.accept(Reference2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Reference2FloatLinkedOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Reference2FloatLinkedOpenHashMap<K>
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Reference2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = Reference2FloatLinkedOpenHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Reference2FloatSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(System.identityHashCode(k)) & Reference2FloatLinkedOpenHashMap.this.mask;
            Object curr = key[pos];
            if (curr == null) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Reference2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Reference2FloatLinkedOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Reference2FloatLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            if (Reference2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2FloatMap.BasicEntry(Reference2FloatLinkedOpenHashMap.this.key[Reference2FloatLinkedOpenHashMap.this.n], Reference2FloatLinkedOpenHashMap.this.value[Reference2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Reference2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractReference2FloatMap.BasicEntry(Reference2FloatLinkedOpenHashMap.this.key[pos], Reference2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            ...
            if (Reference2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Reference2FloatLinkedOpenHashMap.this.key[Reference2FloatLinkedOpenHashMap.this.n];
                entry.value = Reference2FloatLinkedOpenHashMap.this.value[Reference2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Reference2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2FloatLinkedOpenHashMap.this.key[pos] == null) continue;
                entry.key = Reference2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Reference2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Reference2FloatMap.Entry<K>> {
        final Reference2FloatLinkedOpenHashMap<K> entry;
        ...
        @Override
        public Reference2FloatLinkedOpenHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Reference2FloatLinkedOpenHashMap<K> previous() {
    ...
    extends Reference2FloatLinkedOpenHashMap<K>
    implements ObjectListIterator<Reference2FloatMap.Entry<K>> {
        private Reference2FloatLinkedOpenHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(K from) {
            ...
            int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2FloatLinkedOpenHashMap.this.mask;
            while (Reference2FloatLinkedOpenHashMap.this.key[pos] != null) {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Reference2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Reference2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Reference2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Reference2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Reference2FloatLinkedOpenHashMap.this.n) {
                ...
                do {
                    Object curr;
                    int last = pos;
                    pos = last + 1 & Reference2FloatLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == null) {
                            key[last] = null;
                            return;
