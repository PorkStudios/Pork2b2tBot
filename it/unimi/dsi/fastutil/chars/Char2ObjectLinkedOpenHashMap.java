...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Char2ObjectLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2ObjectLinkedOpenHashMap<V> clone() {
        Char2ObjectLinkedOpenHashMap c;
        try {
            c = (Char2ObjectLinkedOpenHashMap)Object.super.clone();
        }
    ...
    extends Char2ObjectLinkedOpenHashMap<V>
    ...
    implements Char2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            int pos = HashCommon.mix(k) & Char2ObjectLinkedOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || !Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v));
            Char2ObjectLinkedOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ObjectMap.BasicEntry(Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.n], Char2ObjectLinkedOpenHashMap.this.value[Char2ObjectLinkedOpenHashMap.this.n]));
            }
            int pos = Char2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                consumer.accept(new AbstractChar2ObjectMap.BasicEntry(Char2ObjectLinkedOpenHashMap.this.key[pos], Char2ObjectLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            ...
            if (Char2ObjectLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.n];
                entry.value = Char2ObjectLinkedOpenHashMap.this.value[Char2ObjectLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Char2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectLinkedOpenHashMap.this.key[pos] == '\u0000') continue;
                entry.key = Char2ObjectLinkedOpenHashMap.this.key[pos];
                entry.value = Char2ObjectLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
        final Char2ObjectLinkedOpenHashMap<V> entry;
        ...
        @Override
        public Char2ObjectLinkedOpenHashMap<V> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Char2ObjectLinkedOpenHashMap<V> previous() {
    ...
    extends Char2ObjectLinkedOpenHashMap<V>
    implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
        private Char2ObjectLinkedOpenHashMap<V> entry;
    ...
    private class MapIterator {
        ...
        private MapIterator(char from) {
            ...
            int pos = HashCommon.mix(from) & Char2ObjectLinkedOpenHashMap.this.mask;
            while (Char2ObjectLinkedOpenHashMap.this.key[pos] != '\u0000') {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Char2ObjectLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Char2ObjectLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Char2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
            if (pos != Char2ObjectLinkedOpenHashMap.this.n) {
                ...
                do {
                    char curr;
                    int last = pos;
                    pos = last + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
                    do {
                        if ((curr = key[pos]) == '\u0000') {
                            key[last] = '\u0000';
    ...
    Map.Entry<Character, V> {
        ...
        public V setValue(V v) {
            Object oldValue = Char2ObjectLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ObjectLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue());
        }
