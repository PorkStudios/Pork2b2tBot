...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Short2DoubleOpenHashMap.this.key[pos] == 0) continue;
    ...
    public Short2DoubleOpenHashMap clone() {
        ...
        try {
            c = (Short2DoubleOpenHashMap)Object.super.clone();
        }
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v);
            }
            short[] key = Short2DoubleOpenHashMap.this.key;
            int pos = HashCommon.mix(k) & Short2DoubleOpenHashMap.this.mask;
            short curr = key[pos];
            if (curr == 0) {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (k != curr);
            return Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0) {
                if (Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[pos]) != Double.doubleToLongBits(v));
            Short2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n], Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]));
            }
            int pos = Short2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleOpenHashMap.this.key[pos] == 0) continue;
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Short2DoubleOpenHashMap.this.n;
                return this.last;
            }
            short[] key = Short2DoubleOpenHashMap.this.key;
            do {
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                short curr;
                int last = pos;
                pos = last + 1 & Short2DoubleOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == 0) {
                        key[last] = 0;
                        return;
                    ...
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                    pos = pos + 1 & Short2DoubleOpenHashMap.this.mask;
                } while (true);
                if (pos < last) {
    ...
    Map.Entry<Short, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2DoubleOpenHashMap.this.key[this.index] == (Short)e.getKey() && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)e.getValue());
        }
