...
public final class Reference2ByteSortedMaps {
    ...
    Serializable {
        ...
        public Reference2ByteSortedMap<K> subMap(K from, K to) {
            return new UnmodifiableSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to));
        }

        @Override
        public Reference2ByteSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.headMap((Object)to));
        }

        @Override
        public Reference2ByteSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.tailMap((Object)from));
        }
    ...
    Serializable {
        ...
        @Override
        public Reference2ByteSortedMap<K> subMap(K from, K to) {
            return new SynchronizedSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.subMap((Object)from, (Object)to), this.sync);
        }

        @Override
        public Reference2ByteSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.headMap((Object)to), this.sync);
        }

        @Override
        public Reference2ByteSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap<K>((Reference2ByteSortedMap<K>)this.sortedMap.tailMap((Object)from), this.sync);
        }
