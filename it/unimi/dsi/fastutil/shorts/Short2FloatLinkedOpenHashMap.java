...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Short2FloatLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept(Short2FloatLinkedOpenHashMap.this.value[Short2FloatLinkedOpenHashMap.this.n]);
                    }
                    int pos = Short2FloatLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                        consumer.accept(Short2FloatLinkedOpenHashMap.this.value[pos]);
                    }
                }
            };
        }
    ...
    public Short2FloatLinkedOpenHashMap clone() {
        ...
        try {
            c = (Short2FloatLinkedOpenHashMap)Object.super.clone();
        }
    ...
    implements Short2FloatSortedMap.FastSortedEntrySet {
        ...
        public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatLinkedOpenHashMap.this.key[Short2FloatLinkedOpenHashMap.this.n], Short2FloatLinkedOpenHashMap.this.value[Short2FloatLinkedOpenHashMap.this.n]));
            }
            int pos = Short2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatLinkedOpenHashMap.this.key[pos], Short2FloatLinkedOpenHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            if (Short2FloatLinkedOpenHashMap.this.containsNullKey) {
                entry.key = Short2FloatLinkedOpenHashMap.this.key[Short2FloatLinkedOpenHashMap.this.n];
                entry.value = Short2FloatLinkedOpenHashMap.this.value[Short2FloatLinkedOpenHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Short2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2FloatLinkedOpenHashMap.this.key[pos] == 0) continue;
                entry.key = Short2FloatLinkedOpenHashMap.this.key[pos];
                entry.value = Short2FloatLinkedOpenHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Short2FloatLinkedOpenHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Short2FloatLinkedOpenHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Short2FloatLinkedOpenHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Short2FloatLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
