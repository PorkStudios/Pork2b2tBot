...
Cloneable {
    ...
    public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>(){
                final Comparator<? super Double2CharMap.Entry> comparator = (x, y) -> Double2CharAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
    ...
    public Double2CharAVLTreeMap clone() {
        ...
        try {
            c = (Double2CharAVLTreeMap)Object.super.clone();
        }
