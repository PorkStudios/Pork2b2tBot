...
extends Message {
    ...
    public Message[] translationParams;

    public /* varargs */ TranslationMessage(String translationKey, Message ... translationParams) {
        this.translationKey = translationKey;
        this.translationParams = translationParams;
        for (Message param : this.translationParams = this.getTranslationParams()) {
