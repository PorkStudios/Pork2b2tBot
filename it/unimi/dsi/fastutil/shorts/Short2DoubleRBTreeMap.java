...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>(){
                final Comparator<? super Short2DoubleMap.Entry> comparator = (x, y) -> Short2DoubleRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
    ...
    public Short2DoubleRBTreeMap clone() {
        ...
        try {
            c = (Short2DoubleRBTreeMap)Object.super.clone();
        }
