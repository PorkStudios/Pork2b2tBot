...
lbl160: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Int2CharRBTreeMap.this.findKey((Integer)e.getKey());
                    return e.equals(f);
                }
    ...
    public Int2CharRBTreeMap clone() {
        Int2CharRBTreeMap c;
        try {
            c = (Int2CharRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public Int2CharSortedMap headMap(int to) {
            ...
            return Int2CharRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Int2CharSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                int n = to = Int2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                int n = from = Int2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(int k) {
                ...
                if (!submap.bottom && submap.Int2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Int2CharRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Int2CharRBTreeMap.this.locateKey(k);
                if (submap.Int2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
