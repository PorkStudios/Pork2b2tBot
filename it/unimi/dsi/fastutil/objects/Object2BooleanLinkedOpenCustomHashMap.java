...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2BooleanLinkedOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    public Object2BooleanLinkedOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Object2BooleanLinkedOpenCustomHashMap)Object.super.clone();
        }
    ...
    extends Object2BooleanLinkedOpenCustomHashMap<K>
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            int pos = Object2BooleanLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = Object2BooleanLinkedOpenCustomHashMap.this.key[pos];
                if (k == null) continue;
                consumer.accept(k);
            }
        }
    ...
    implements Object2BooleanSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
            if (Object2BooleanLinkedOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanLinkedOpenCustomHashMap.this.key[Object2BooleanLinkedOpenCustomHashMap.this.n], Object2BooleanLinkedOpenCustomHashMap.this.value[Object2BooleanLinkedOpenCustomHashMap.this.n]));
            }
            int pos = Object2BooleanLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2BooleanLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                consumer.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanLinkedOpenCustomHashMap.this.key[pos], Object2BooleanLinkedOpenCustomHashMap.this.value[pos]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
            ...
            if (Object2BooleanLinkedOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2BooleanLinkedOpenCustomHashMap.this.key[Object2BooleanLinkedOpenCustomHashMap.this.n];
                entry.value = Object2BooleanLinkedOpenCustomHashMap.this.value[Object2BooleanLinkedOpenCustomHashMap.this.n];
                consumer.accept(entry);
            }
            int pos = Object2BooleanLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2BooleanLinkedOpenCustomHashMap.this.key[pos] == null) continue;
                entry.key = Object2BooleanLinkedOpenCustomHashMap.this.key[pos];
                entry.value = Object2BooleanLinkedOpenCustomHashMap.this.value[pos];
                consumer.accept(entry);
            }
        }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        final Object2BooleanLinkedOpenCustomHashMap<K> entry;
        ...
        @Override
        public Object2BooleanLinkedOpenCustomHashMap<K> next() {
            this.entry.index = this.nextEntry();
            return this.entry;
        }

        @Override
        public Object2BooleanLinkedOpenCustomHashMap<K> previous() {
    ...
    extends Object2BooleanLinkedOpenCustomHashMap<K>
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        private Object2BooleanLinkedOpenCustomHashMap<K> entry;
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                long[] arrl = Object2BooleanLinkedOpenCustomHashMap.this.link;
                int n = this.prev;
                arrl[n] = arrl[n] ^ (Object2BooleanLinkedOpenCustomHashMap.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                ...
                long[] arrl = Object2BooleanLinkedOpenCustomHashMap.this.link;
                int n = this.next;
                arrl[n] = arrl[n] ^ (Object2BooleanLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & -4294967296L;
            }
            int pos = this.curr;
            this.curr = -1;
