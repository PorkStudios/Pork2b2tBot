...
Cloneable {
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(){
                final Comparator<? super Short2IntMap.Entry> comparator = (x, y) -> Short2IntAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2IntAVLTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2IntAVLTreeMap clone() {
        ...
        try {
            c = (Short2IntAVLTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public int put(short k, int v) {
            ...
            int oldValue = Short2IntAVLTreeMap.this.put(k, v);
        ...
        public int remove(short k) {
            ...
            int oldValue = Short2IntAVLTreeMap.this.remove(k);
        ...
        public Short2IntSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2IntAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2IntAVLTreeMap.this.locateKey(k);
                if (submap.Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            this.next = Short2IntAVLTreeMap.this.locateKey(k);
            if (this.next != null) {
