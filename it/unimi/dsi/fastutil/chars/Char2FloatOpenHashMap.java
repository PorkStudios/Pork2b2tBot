...
Hash {
            ...
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Char2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]);
                    }
                    int pos = Char2FloatOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2FloatOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    public Char2FloatOpenHashMap clone() {
        ...
        try {
            c = (Char2FloatOpenHashMap)Object.super.clone();
        }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2FloatOpenHashMap.this.key[Char2FloatOpenHashMap.this.n]);
            }
            int pos = Char2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == '\u0000') {
                return Char2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v);
            }
            char[] key = Char2FloatOpenHashMap.this.key;
            int pos = HashCommon.mix(k) & Char2FloatOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (k != curr);
            return Float.floatToIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == '\u0000') {
                if (Char2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Float.floatToIntBits(Char2FloatOpenHashMap.this.value[pos]) != Float.floatToIntBits(v));
            Char2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
        ...
        public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatOpenHashMap.this.key[Char2FloatOpenHashMap.this.n], Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]));
            }
            int pos = Char2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2FloatOpenHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            ...
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                entry.key = Char2FloatOpenHashMap.this.key[Char2FloatOpenHashMap.this.n];
                entry.value = Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n];
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                this.last = Char2FloatOpenHashMap.this.n;
                return this.last;
            }
            char[] key = Char2FloatOpenHashMap.this.key;
            do {
                ...
                int p = HashCommon.mix(k) & Char2FloatOpenHashMap.this.mask;
                while (k != key[p]) {
                    p = p + 1 & Char2FloatOpenHashMap.this.mask;
                }
                return p;
            } while (key[this.pos] == '\u0000');
            this.last = this.pos;
        ...
        private void shiftKeys(int pos) {
            ...
            do {
                char curr;
                int last = pos;
                pos = last + 1 & Char2FloatOpenHashMap.this.mask;
                do {
                    if ((curr = key[pos]) == '\u0000') {
                        key[last] = '\u0000';
                        return;
                    }
                    int slot = HashCommon.mix(curr) & Char2FloatOpenHashMap.this.mask;
                    if (last <= pos ? last >= slot || slot > pos : last >= slot && slot > pos) break;
                    pos = pos + 1 & Char2FloatOpenHashMap.this.mask;
                } while (true);
                if (pos < last) {
    ...
    Map.Entry<Character, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue());
        }
