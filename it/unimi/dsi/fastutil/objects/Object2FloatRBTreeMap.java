...
lbl161: // 1 sources:
    ...
    public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>(){
                final Comparator<? super Object2FloatMap.Entry<K>> comparator = (x, y) -> Object2FloatRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Object2FloatRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) {
                    return Object2FloatRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
                    return Object2FloatRBTreeMap.this.headMap(to.getKey()).object2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
                    return Object2FloatRBTreeMap.this.tailMap(from.getKey()).object2FloatEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2FloatRBTreeMap<K> clone() {
        Object2FloatRBTreeMap c;
        try {
            c = (Object2FloatRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        @Override
        public boolean containsKey(Object k) {
            return this.in(k) && Object2FloatRBTreeMap.this.containsKey(k);
        }
        ...
        public float getFloat(Object k) {
            Entry<Object> e;
            Object kk = k;
            return this.in(kk) && (e = Object2FloatRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Object2FloatSortedMap<K> headMap(K to) {
            ...
            return Object2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Object2FloatSortedMap<K> tailMap(K from) {
            ...
            return Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Object2FloatSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                K k = to = Object2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                K k = from = Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<K> firstEntry() {
            ...
            if (e == null || !this.top && Object2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry<K> lastEntry() {
            ...
            if (e == null || !this.bottom && Object2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends Object2FloatRBTreeMap<K>
        ...
        extends Object2FloatRBTreeMap<K> {
            ...
            SubmapIterator(K k) {
                ...
                if (!submap.bottom && submap.Object2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Object2FloatRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Object2FloatRBTreeMap.this.locateKey(k);
                if (submap.Object2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
