...
lbl161: // 1 sources:
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>(){
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Float2ReferenceRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    return e.equals(f);
                }
    ...
    public Float2ReferenceRBTreeMap<V> clone() {
        Float2ReferenceRBTreeMap c;
        try {
            c = (Float2ReferenceRBTreeMap)Object.super.clone();
        }
    ...
    implements Serializable {
        ...
        public V put(float k, V v) {
            ...
            V oldValue = Float2ReferenceRBTreeMap.this.put(k, v);
        ...
        public V remove(float k) {
            ...
            Object oldValue = Float2ReferenceRBTreeMap.this.remove(k);
        ...
        public Float2ReferenceSortedMap<V> subMap(float from, float to) {
            ...
            if (!this.top) {
                float f = to = Float2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                float f = from = Float2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends Float2ReferenceRBTreeMap<V>
        ...
        extends Float2ReferenceRBTreeMap<V> {
            ...
            SubmapIterator(float k) {
                ...
                if (!submap.bottom && submap.Float2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Float2ReferenceRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Float2ReferenceRBTreeMap.this.locateKey(k);
                if (submap.Float2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            this.next = Float2ReferenceRBTreeMap.this.locateKey(k);
            if (this.next != null) {
