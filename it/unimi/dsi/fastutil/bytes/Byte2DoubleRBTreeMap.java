...
lbl160: // 1 sources:
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                final Comparator<? super Byte2DoubleMap.Entry> comparator = (x, y) -> Byte2DoubleRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Byte2DoubleRBTreeMap.this.findKey((Byte)e.getKey());
                    return e.equals(f);
                }
    ...
    public Byte2DoubleRBTreeMap clone() {
        ...
        try {
            c = (Byte2DoubleRBTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry top = new Entry(s.readByte(), s.readDouble());
            top.pred(pred);
            top.succ(succ);
            top.black(true);
            return top;
    ...
    implements Serializable {
        ...
        public Byte2DoubleSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                byte by = to = Byte2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                byte by = from = Byte2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k) {
                ...
                if (!submap.bottom && submap.Byte2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2DoubleRBTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2DoubleRBTreeMap.this.locateKey(k);
                if (submap.Byte2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
