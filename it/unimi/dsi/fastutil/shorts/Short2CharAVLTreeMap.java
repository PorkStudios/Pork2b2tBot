...
Cloneable {
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(){
                final Comparator<? super Short2CharMap.Entry> comparator = (x, y) -> Short2CharAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                ...
                public boolean contains(Object o) {
                    ...
                    Entry f = Short2CharAVLTreeMap.this.findKey((Short)e.getKey());
                    return e.equals(f);
                }
    ...
    public Short2CharAVLTreeMap clone() {
        ...
        try {
            c = (Short2CharAVLTreeMap)Object.super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        ...
        if (n == 2) {
            Entry top = new Entry(s.readShort(), s.readChar());
            top.right(new Entry(s.readShort(), s.readChar()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public char get(short k) {
            Entry e;
            short kk = k;
            return this.in(kk) && (e = Short2CharAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public Short2CharSortedMap headMap(short to) {
            ...
            return Short2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(this.from, this.bottom, to, false) : this;
        }
        ...
        public Short2CharSortedMap tailMap(short from) {
            ...
            return Short2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(from, false, this.to, this.top) : this;
        }
        ...
        public Short2CharSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                short s = to = Short2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                short s = from = Short2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (e == null || !this.top && Short2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
                return null;
            }
            return e;
        }
        ...
        public Entry lastEntry() {
            ...
            if (e == null || !this.bottom && Short2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
                return null;
            }
            return e;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(short k) {
                ...
                if (!submap.bottom && submap.Short2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Short2CharAVLTreeMap.this.compare(k, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Short2CharAVLTreeMap.this.locateKey(k);
                if (submap.Short2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
        ...
        extends AbstractShort2CharSortedMap.KeySet {
            private KeySet() {
            }
